...
void umkaLoadDirectoryFilesEx(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    bool scanSubdirs = (bool)params[0].ptrVal;
...
void umkaUploadMesh(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    bool dynamic = (bool)params[0].ptrVal;
...
bool umkaAddRaylib(void *umka) {
    ...
    const char* moduleCode =
        ...
        /* 0211 */ "    projection: ^void\n"
        /* 0212 */ "    viewOffset: ^void\n"
        ...
        /* 0354 */ "fn CompressData*(data: ^void, dataSize: int32, compDataSize: ^int32): ^uint8\n"
        /* 0355 */ "fn DecompressData*(compData: ^void, compDataSize: int32, dataSize: ^int32): ^uint8\n"
        /* 0356 */ "fn EncodeDataBase64*(data: ^void, dataSize: int32, outputSize: ^int32): ^char\n"
        /* 0357 */ "fn DecodeDataBase64*(data: ^void, outputSize: ^int32): ^uint8\n"
        ...
        // Skipping UpdateCamera
        /* 0403 */ "fn SetCameraPanControl*(keyPan: int32)\n"
        /* 0404 */ "fn SetCameraAltControl*(keyAlt: int32)\n"
        /* 0405 */ "fn SetCameraSmoothZoomControl*(keySmoothZoom: int32)\n"
        /* 0406 */ "fn SetCameraMoveControls*(keyFront: int32, keyBack: int32, keyRight: int32, keyLeft: int32, keyUp: int32, keyDown: int32)\n"
        /* 0407 */ "fn SetShapesTexture*(texture: Texture, source: Rectangle)\n"
        /* 0408 */ "fn DrawPixel*(posX: int32, posY: int32, color: Color)\n"
        /* 0409 */ "fn DrawPixelV*(position: Vector2, color: Color)\n"
        /* 0410 */ "fn DrawLine*(startPosX: int32, startPosY: int32, endPosX: int32, endPosY: int32, color: Color)\n"
        /* 0411 */ "fn DrawLineV*(startPos: Vector2, endPos: Vector2, color: Color)\n"
        /* 0412 */ "fn DrawLineEx*(startPos: Vector2, endPos: Vector2, thick: real32, color: Color)\n"
        /* 0413 */ "fn DrawLineBezier*(startPos: Vector2, endPos: Vector2, thick: real32, color: Color)\n"
        /* 0414 */ "fn DrawLineBezierQuad*(startPos: Vector2, endPos: Vector2, controlPos: Vector2, thick: real32, color: Color)\n"
        /* 0415 */ "fn DrawLineBezierCubic*(startPos: Vector2, endPos: Vector2, startControlPos: Vector2, endControlPos: Vector2, thick: real32, color: Color)\n"
        /* 0416 */ "fn DrawLineStrip*(points: ^Vector2, pointCount: int32, color: Color)\n"
        /* 0417 */ "fn DrawCircle*(centerX: int32, centerY: int32, radius: real32, color: Color)\n"
        /* 0418 */ "fn DrawCircleSector*(center: Vector2, radius: real32, startAngle: real32, endAngle: real32, segments: int32, color: Color)\n"
        /* 0419 */ "fn DrawCircleSectorLines*(center: Vector2, radius: real32, startAngle: real32, endAngle: real32, segments: int32, color: Color)\n"
        /* 0420 */ "fn DrawCircleGradient*(centerX: int32, centerY: int32, radius: real32, color1: Color, color2: Color)\n"
        /* 0421 */ "fn DrawCircleV*(center: Vector2, radius: real32, color: Color)\n"
        /* 0422 */ "fn DrawCircleLines*(centerX: int32, centerY: int32, radius: real32, color: Color)\n"
        /* 0423 */ "fn DrawEllipse*(centerX: int32, centerY: int32, radiusH: real32, radiusV: real32, color: Color)\n"
        /* 0424 */ "fn DrawEllipseLines*(centerX: int32, centerY: int32, radiusH: real32, radiusV: real32, color: Color)\n"
        /* 0425 */ "fn DrawRing*(center: Vector2, innerRadius: real32, outerRadius: real32, startAngle: real32, endAngle: real32, segments: int32, color: Color)\n"
        /* 0426 */ "fn DrawRingLines*(center: Vector2, innerRadius: real32, outerRadius: real32, startAngle: real32, endAngle: real32, segments: int32, color: Color)\n"
        /* 0427 */ "fn DrawRectangle*(posX: int32, posY: int32, width: int32, height: int32, color: Color)\n"
        /* 0428 */ "fn DrawRectangleV*(position: Vector2, size: Vector2, color: Color)\n"
        /* 0429 */ "fn DrawRectangleRec*(rec: Rectangle, color: Color)\n"
        /* 0430 */ "fn DrawRectanglePro*(rec: Rectangle, origin: Vector2, rotation: real32, color: Color)\n"
        /* 0431 */ "fn DrawRectangleGradientV*(posX: int32, posY: int32, width: int32, height: int32, color1: Color, color2: Color)\n"
        /* 0432 */ "fn DrawRectangleGradientH*(posX: int32, posY: int32, width: int32, height: int32, color1: Color, color2: Color)\n"
        /* 0433 */ "fn DrawRectangleGradientEx*(rec: Rectangle, col1: Color, col2: Color, col3: Color, col4: Color)\n"
        /* 0434 */ "fn DrawRectangleLines*(posX: int32, posY: int32, width: int32, height: int32, color: Color)\n"
        /* 0435 */ "fn DrawRectangleLinesEx*(rec: Rectangle, lineThick: real32, color: Color)\n"
        /* 0436 */ "fn DrawRectangleRounded*(rec: Rectangle, roundness: real32, segments: int32, color: Color)\n"
        /* 0437 */ "fn DrawRectangleRoundedLines*(rec: Rectangle, roundness: real32, segments: int32, lineThick: real32, color: Color)\n"
        /* 0438 */ "fn DrawTriangle*(v1: Vector2, v2: Vector2, v3: Vector2, color: Color)\n"
        /* 0439 */ "fn DrawTriangleLines*(v1: Vector2, v2: Vector2, v3: Vector2, color: Color)\n"
        /* 0440 */ "fn DrawTriangleFan*(points: ^Vector2, pointCount: int32, color: Color)\n"
        /* 0441 */ "fn DrawTriangleStrip*(points: ^Vector2, pointCount: int32, color: Color)\n"
        /* 0442 */ "fn DrawPoly*(center: Vector2, sides: int32, radius: real32, rotation: real32, color: Color)\n"
        /* 0443 */ "fn DrawPolyLines*(center: Vector2, sides: int32, radius: real32, rotation: real32, color: Color)\n"
        /* 0444 */ "fn DrawPolyLinesEx*(center: Vector2, sides: int32, radius: real32, rotation: real32, lineThick: real32, color: Color)\n"
        /* 0445 */ "fn CheckCollisionRecs*(rec1: Rectangle, rec2: Rectangle): bool\n"
        /* 0446 */ "fn CheckCollisionCircles*(center1: Vector2, radius1: real32, center2: Vector2, radius2: real32): bool\n"
        /* 0447 */ "fn CheckCollisionCircleRec*(center: Vector2, radius: real32, rec: Rectangle): bool\n"
        /* 0448 */ "fn CheckCollisionPointRec*(point: Vector2, rec: Rectangle): bool\n"
        /* 0449 */ "fn CheckCollisionPointCircle*(point: Vector2, center: Vector2, radius: real32): bool\n"
        /* 0450 */ "fn CheckCollisionPointTriangle*(point: Vector2, p1: Vector2, p2: Vector2, p3: Vector2): bool\n"
        /* 0451 */ "fn CheckCollisionLines*(startPos1: Vector2, endPos1: Vector2, startPos2: Vector2, endPos2: Vector2, collisionPoint: ^Vector2): bool\n"
        /* 0452 */ "fn CheckCollisionPointLine*(point: Vector2, p1: Vector2, p2: Vector2, threshold: int32): bool\n"
        /* 0453 */ "fn GetCollisionRec*(rec1: Rectangle, rec2: Rectangle): Rectangle\n"
        /* 0454 */ "fn LoadImage*(fileName: str): Image\n"
        /* 0455 */ "fn LoadImageRaw*(fileName: str, width: int32, height: int32, format: int32, headerSize: int32): Image\n"
        /* 0456 */ "fn LoadImageAnim*(fileName: str, frames: ^int32): Image\n"
        /* 0457 */ "fn LoadImageFromMemory*(fileType: str, fileData: ^void, dataSize: int32): Image\n"
        /* 0458 */ "fn LoadImageFromTexture*(texture: Texture): Image\n"
        /* 0459 */ "fn LoadImageFromScreen*(): Image\n"
        /* 0460 */ "fn UnloadImage*(image: Image)\n"
        /* 0461 */ "fn ExportImage*(image: Image, fileName: str): bool\n"
        /* 0462 */ "fn ExportImageAsCode*(image: Image, fileName: str): bool\n"
        /* 0463 */ "fn GenImageColor*(width: int32, height: int32, color: Color): Image\n"
        /* 0464 */ "fn GenImageGradientV*(width: int32, height: int32, top: Color, bottom: Color): Image\n"
        /* 0465 */ "fn GenImageGradientH*(width: int32, height: int32, left: Color, right: Color): Image\n"
        /* 0466 */ "fn GenImageGradientRadial*(width: int32, height: int32, density: real32, inner: Color, outer: Color): Image\n"
        /* 0467 */ "fn GenImageChecked*(width: int32, height: int32, checksX: int32, checksY: int32, col1: Color, col2: Color): Image\n"
        /* 0468 */ "fn GenImageWhiteNoise*(width: int32, height: int32, factor: real32): Image\n"
        /* 0469 */ "fn GenImageCellular*(width: int32, height: int32, tileSize: int32): Image\n"
        /* 0470 */ "fn ImageCopy*(image: Image): Image\n"
        /* 0471 */ "fn ImageFromImage*(image: Image, rec: Rectangle): Image\n"
        /* 0472 */ "fn ImageText*(text: str, fontSize: int32, color: Color): Image\n"
        /* 0473 */ "fn ImageTextEx*(font: Font, text: str, fontSize: real32, spacing: real32, tint: Color): Image\n"
        /* 0474 */ "fn ImageFormat*(image: ^Image, newFormat: int32)\n"
        /* 0475 */ "fn ImageToPOT*(image: ^Image, fill: Color)\n"
        /* 0476 */ "fn ImageCrop*(image: ^Image, crop: Rectangle)\n"
        /* 0477 */ "fn ImageAlphaCrop*(image: ^Image, threshold: real32)\n"
        /* 0478 */ "fn ImageAlphaClear*(image: ^Image, color: Color, threshold: real32)\n"
        /* 0479 */ "fn ImageAlphaMask*(image: ^Image, alphaMask: Image)\n"
        /* 0480 */ "fn ImageAlphaPremultiply*(image: ^Image)\n"
        /* 0481 */ "fn ImageResize*(image: ^Image, newWidth: int32, newHeight: int32)\n"
        /* 0482 */ "fn ImageResizeNN*(image: ^Image, newWidth: int32, newHeight: int32)\n"
        /* 0483 */ "fn ImageResizeCanvas*(image: ^Image, newWidth: int32, newHeight: int32, offsetX: int32, offsetY: int32, fill: Color)\n"
        /* 0484 */ "fn ImageMipmaps*(image: ^Image)\n"
        /* 0485 */ "fn ImageDither*(image: ^Image, rBpp: int32, gBpp: int32, bBpp: int32, aBpp: int32)\n"
        /* 0486 */ "fn ImageFlipVertical*(image: ^Image)\n"
        /* 0487 */ "fn ImageFlipHorizontal*(image: ^Image)\n"
        /* 0488 */ "fn ImageRotateCW*(image: ^Image)\n"
        /* 0489 */ "fn ImageRotateCCW*(image: ^Image)\n"
        /* 0490 */ "fn ImageColorTint*(image: ^Image, color: Color)\n"
        /* 0491 */ "fn ImageColorInvert*(image: ^Image)\n"
        /* 0492 */ "fn ImageColorGrayscale*(image: ^Image)\n"
        /* 0493 */ "fn ImageColorContrast*(image: ^Image, contrast: real32)\n"
        /* 0494 */ "fn ImageColorBrightness*(image: ^Image, brightness: int32)\n"
        /* 0495 */ "fn ImageColorReplace*(image: ^Image, color: Color, replace: Color)\n"
        /* 0496 */ "fn LoadImageColors*(image: Image): ^Color\n"
        /* 0497 */ "fn LoadImagePalette*(image: Image, maxPaletteSize: int32, colorCount: ^int32): ^Color\n"
        /* 0498 */ "fn UnloadImageColors*(colors: ^Color)\n"
        /* 0499 */ "fn UnloadImagePalette*(colors: ^Color)\n"
        /* 0500 */ "fn GetImageAlphaBorder*(image: Image, threshold: real32): Rectangle\n"
        /* 0501 */ "fn GetImageColor*(image: Image, x: int32, y: int32): Color\n"
        /* 0502 */ "fn ImageClearBackground*(dst: ^Image, color: Color)\n"
        /* 0503 */ "fn ImageDrawPixel*(dst: ^Image, posX: int32, posY: int32, color: Color)\n"
        /* 0504 */ "fn ImageDrawPixelV*(dst: ^Image, position: Vector2, color: Color)\n"
        /* 0505 */ "fn ImageDrawLine*(dst: ^Image, startPosX: int32, startPosY: int32, endPosX: int32, endPosY: int32, color: Color)\n"
        /* 0506 */ "fn ImageDrawLineV*(dst: ^Image, start: Vector2, end: Vector2, color: Color)\n"
        /* 0507 */ "fn ImageDrawCircle*(dst: ^Image, centerX: int32, centerY: int32, radius: int32, color: Color)\n"
        /* 0508 */ "fn ImageDrawCircleV*(dst: ^Image, center: Vector2, radius: int32, color: Color)\n"
        /* 0509 */ "fn ImageDrawRectangle*(dst: ^Image, posX: int32, posY: int32, width: int32, height: int32, color: Color)\n"
        /* 0510 */ "fn ImageDrawRectangleV*(dst: ^Image, position: Vector2, size: Vector2, color: Color)\n"
        /* 0511 */ "fn ImageDrawRectangleRec*(dst: ^Image, rec: Rectangle, color: Color)\n"
        /* 0512 */ "fn ImageDrawRectangleLines*(dst: ^Image, rec: Rectangle, thick: int32, color: Color)\n"
        /* 0513 */ "fn ImageDraw*(dst: ^Image, src: Image, srcRec: Rectangle, dstRec: Rectangle, tint: Color)\n"
        /* 0514 */ "fn ImageDrawText*(dst: ^Image, text: str, posX: int32, posY: int32, fontSize: int32, color: Color)\n"
        /* 0515 */ "fn ImageDrawTextEx*(dst: ^Image, font: Font, text: str, position: Vector2, fontSize: real32, spacing: real32, tint: Color)\n"
        /* 0516 */ "fn LoadTexture*(fileName: str): Texture\n"
        /* 0517 */ "fn LoadTextureFromImage*(image: Image): Texture\n"
        /* 0518 */ "fn LoadTextureCubemap*(image: Image, layout: int32): Texture\n"
        /* 0519 */ "fn LoadRenderTexture*(width: int32, height: int32): RenderTexture\n"
        /* 0520 */ "fn UnloadTexture*(texture: Texture)\n"
        /* 0521 */ "fn UnloadRenderTexture*(target: RenderTexture)\n"
        /* 0522 */ "fn UpdateTexture*(texture: Texture, pixels: ^void)\n"
        /* 0523 */ "fn UpdateTextureRec*(texture: Texture, rec: Rectangle, pixels: ^void)\n"
        /* 0524 */ "fn GenTextureMipmaps*(texture: ^Texture)\n"
        /* 0525 */ "fn SetTextureFilter*(texture: Texture, filter: int32)\n"
        /* 0526 */ "fn SetTextureWrap*(texture: Texture, wrap: int32)\n"
        /* 0527 */ "fn DrawTexture*(texture: Texture, posX: int32, posY: int32, tint: Color)\n"
        /* 0528 */ "fn DrawTextureV*(texture: Texture, position: Vector2, tint: Color)\n"
        /* 0529 */ "fn DrawTextureEx*(texture: Texture, position: Vector2, rotation: real32, scale: real32, tint: Color)\n"
        /* 0530 */ "fn DrawTextureRec*(texture: Texture, source: Rectangle, position: Vector2, tint: Color)\n"
        /* 0531 */ "fn DrawTextureQuad*(texture: Texture, tiling: Vector2, offset: Vector2, quad: Rectangle, tint: Color)\n"
        /* 0532 */ "fn DrawTextureTiled*(texture: Texture, source: Rectangle, dest: Rectangle, origin: Vector2, rotation: real32, scale: real32, tint: Color)\n"
        /* 0533 */ "fn DrawTexturePro*(texture: Texture, source: Rectangle, dest: Rectangle, origin: Vector2, rotation: real32, tint: Color)\n"
        /* 0534 */ "fn DrawTextureNPatch*(texture: Texture, nPatchInfo: NPatchInfo, dest: Rectangle, origin: Vector2, rotation: real32, tint: Color)\n"
        /* 0535 */ "fn DrawTexturePoly*(texture: Texture, center: Vector2, points: ^Vector2, texcoords: ^Vector2, pointCount: int32, tint: Color)\n"
        /* 0536 */ "fn Fade*(color: Color, alpha: real32): Color\n"
        /* 0537 */ "fn ColorToInt*(color: Color): int32\n"
        /* 0538 */ "fn ColorNormalize*(color: Color): Vector4\n"
        /* 0539 */ "fn ColorFromNormalized*(normalized: Vector4): Color\n"
        /* 0540 */ "fn ColorToHSV*(color: Color): Vector3\n"
        /* 0541 */ "fn ColorFromHSV*(hue: real32, saturation: real32, value: real32): Color\n"
        /* 0542 */ "fn ColorAlpha*(color: Color, alpha: real32): Color\n"
        /* 0543 */ "fn ColorAlphaBlend*(dst: Color, src: Color, tint: Color): Color\n"
        /* 0544 */ "fn GetColor*(hexValue: uint32): Color\n"
        /* 0545 */ "fn GetPixelColor*(srcPtr: ^void, format: int32): Color\n"
        /* 0546 */ "fn SetPixelColor*(dstPtr: ^void, color: Color, format: int32)\n"
        /* 0547 */ "fn GetPixelDataSize*(width: int32, height: int32, format: int32): int32\n"
        /* 0548 */ "fn GetFontDefault*(): Font\n"
        /* 0549 */ "fn LoadFont*(fileName: str): Font\n"
        /* 0550 */ "fn LoadFontEx*(fileName: str, fontSize: int32, fontChars: ^int32, glyphCount: int32): Font\n"
        /* 0551 */ "fn LoadFontFromImage*(image: Image, key: Color, firstChar: int32): Font\n"
        /* 0552 */ "fn LoadFontFromMemory*(fileType: str, fileData: ^void, dataSize: int32, fontSize: int32, fontChars: ^int32, glyphCount: int32): Font\n"
        // Skipping LoadFontData
        /* 0553 */ "fn GenImageFontAtlas*(chars: ^void, recs: ^void, glyphCount: int32, fontSize: int32, padding: int32, packMethod: int32): Image\n"
        /* 0554 */ "fn UnloadFontData*(chars: ^GlyphInfo, glyphCount: int32)\n"
        /* 0555 */ "fn UnloadFont*(font: Font)\n"
        /* 0556 */ "fn ExportFontAsCode*(font: Font, fileName: str): bool\n"
        /* 0557 */ "fn DrawFPS*(posX: int32, posY: int32)\n"
        /* 0558 */ "fn DrawText*(text: str, posX: int32, posY: int32, fontSize: int32, color: Color)\n"
        /* 0559 */ "fn DrawTextEx*(font: Font, text: str, position: Vector2, fontSize: real32, spacing: real32, tint: Color)\n"
        /* 0560 */ "fn DrawTextPro*(font: Font, text: str, position: Vector2, origin: Vector2, rotation: real32, fontSize: real32, spacing: real32, tint: Color)\n"
        /* 0561 */ "fn DrawTextCodepoint*(font: Font, codepoint: int32, position: Vector2, fontSize: real32, tint: Color)\n"
        /* 0562 */ "fn DrawTextCodepoints*(font: Font, codepoints: ^int32, count: int32, position: Vector2, fontSize: real32, spacing: real32, tint: Color)\n"
        /* 0563 */ "fn MeasureText*(text: str, fontSize: int32): int32\n"
        /* 0564 */ "fn MeasureTextEx*(font: Font, text: str, fontSize: real32, spacing: real32): Vector2\n"
        /* 0565 */ "fn GetGlyphIndex*(font: Font, codepoint: int32): int32\n"
        /* 0566 */ "fn GetGlyphInfo*(font: Font, codepoint: int32): GlyphInfo\n"
        /* 0567 */ "fn GetGlyphAtlasRec*(font: Font, codepoint: int32): Rectangle\n"
        /* 0568 */ "fn LoadCodepoints*(text: str, count: ^int32): ^int32\n"
        /* 0569 */ "fn UnloadCodepoints*(codepoints: ^int32)\n"
        /* 0570 */ "fn GetCodepointCount*(text: str): int32\n"
        /* 0571 */ "fn GetCodepoint*(text: str, bytesProcessed: ^int32): int32\n"
        /* 0572 */ "fn CodepointToUTF8*(codepoint: int32, byteSize: ^int32): str\n"
        /* 0573 */ "fn TextCodepointsToUTF8*(codepoints: ^int32, length: int32): ^char\n"
        /* 0574 */ "fn TextCopy*(dst: ^char, src: str): int32\n"
        /* 0575 */ "fn TextIsEqual*(text1: str, text2: str): bool\n"
        /* 0576 */ "fn TextLength*(text: str): uint32\n"
        // Skipping TextFormat
        /* 0577 */ "fn TextSubtext*(text: str, position: int32, length: int32): str\n"
        /* 0578 */ "fn TextReplace*(text: ^char, replace: str, by: str): ^char\n"
        /* 0579 */ "fn TextInsert*(text: str, insert: str, position: int32): ^char\n"
        /* 0580 */ "fn TextJoin*(textList: ^str, count: int32, delimiter: str): str\n"
        /* 0581 */ "fn TextSplit*(text: str, delimiter: char, count: ^int32): ^str\n"
        /* 0582 */ "fn TextAppend*(text: ^char, append: str, position: ^int32)\n"
        /* 0583 */ "fn TextFindIndex*(text: str, find: str): int32\n"
        /* 0584 */ "fn TextToUpper*(text: str): str\n"
        /* 0585 */ "fn TextToLower*(text: str): str\n"
        /* 0586 */ "fn TextToPascal*(text: str): str\n"
        /* 0587 */ "fn TextToInteger*(text: str): int32\n"
        /* 0588 */ "fn DrawLine3D*(startPos: Vector3, endPos: Vector3, color: Color)\n"
        /* 0589 */ "fn DrawPoint3D*(position: Vector3, color: Color)\n"
        /* 0590 */ "fn DrawCircle3D*(center: Vector3, radius: real32, rotationAxis: Vector3, rotationAngle: real32, color: Color)\n"
        /* 0591 */ "fn DrawTriangle3D*(v1: Vector3, v2: Vector3, v3: Vector3, color: Color)\n"
        /* 0592 */ "fn DrawTriangleStrip3D*(points: ^Vector3, pointCount: int32, color: Color)\n"
        /* 0593 */ "fn DrawCube*(position: Vector3, width: real32, height: real32, length: real32, color: Color)\n"
        /* 0594 */ "fn DrawCubeV*(position: Vector3, size: Vector3, color: Color)\n"
        /* 0595 */ "fn DrawCubeWires*(position: Vector3, width: real32, height: real32, length: real32, color: Color)\n"
        /* 0596 */ "fn DrawCubeWiresV*(position: Vector3, size: Vector3, color: Color)\n"
        /* 0597 */ "fn DrawCubeTexture*(texture: Texture, position: Vector3, width: real32, height: real32, length: real32, color: Color)\n"
        /* 0598 */ "fn DrawCubeTextureRec*(texture: Texture, source: Rectangle, position: Vector3, width: real32, height: real32, length: real32, color: Color)\n"
        /* 0599 */ "fn DrawSphere*(centerPos: Vector3, radius: real32, color: Color)\n"
        /* 0600 */ "fn DrawSphereEx*(centerPos: Vector3, radius: real32, rings: int32, slices: int32, color: Color)\n"
        /* 0601 */ "fn DrawSphereWires*(centerPos: Vector3, radius: real32, rings: int32, slices: int32, color: Color)\n"
        /* 0602 */ "fn DrawCylinder*(position: Vector3, radiusTop: real32, radiusBottom: real32, height: real32, slices: int32, color: Color)\n"
        /* 0603 */ "fn DrawCylinderEx*(startPos: Vector3, endPos: Vector3, startRadius: real32, endRadius: real32, sides: int32, color: Color)\n"
        /* 0604 */ "fn DrawCylinderWires*(position: Vector3, radiusTop: real32, radiusBottom: real32, height: real32, slices: int32, color: Color)\n"
        /* 0605 */ "fn DrawCylinderWiresEx*(startPos: Vector3, endPos: Vector3, startRadius: real32, endRadius: real32, sides: int32, color: Color)\n"
        /* 0606 */ "fn DrawPlane*(centerPos: Vector3, size: Vector2, color: Color)\n"
        /* 0607 */ "fn DrawRay*(ray: Ray, color: Color)\n"
        /* 0608 */ "fn DrawGrid*(slices: int32, spacing: real32)\n"
        /* 0609 */ "fn LoadModel*(fileName: str): Model\n"
        /* 0610 */ "fn LoadModelFromMesh*(mesh: Mesh): Model\n"
        /* 0611 */ "fn UnloadModel*(model: Model)\n"
        /* 0612 */ "fn UnloadModelKeepMeshes*(model: Model)\n"
        /* 0613 */ "fn GetModelBoundingBox*(model: Model): BoundingBox\n"
        /* 0614 */ "fn DrawModel*(model: Model, position: Vector3, scale: real32, tint: Color)\n"
        /* 0615 */ "fn DrawModelEx*(model: Model, position: Vector3, rotationAxis: Vector3, rotationAngle: real32, scale: Vector3, tint: Color)\n"
        /* 0616 */ "fn DrawModelWires*(model: Model, position: Vector3, scale: real32, tint: Color)\n"
        /* 0617 */ "fn DrawModelWiresEx*(model: Model, position: Vector3, rotationAxis: Vector3, rotationAngle: real32, scale: Vector3, tint: Color)\n"
        /* 0618 */ "fn DrawBoundingBox*(box: BoundingBox, color: Color)\n"
        /* 0619 */ "fn DrawBillboard*(camera: Camera3D, texture: Texture, position: Vector3, size: real32, tint: Color)\n"
        /* 0620 */ "fn DrawBillboardRec*(camera: Camera3D, texture: Texture, source: Rectangle, position: Vector3, size: Vector2, tint: Color)\n"
        /* 0621 */ "fn DrawBillboardPro*(camera: Camera3D, texture: Texture, source: Rectangle, position: Vector3, up: Vector3, size: Vector2, origin: Vector2, rotation: real32, tint: Color)\n"
        /* 0622 */ "fn UploadMesh*(mesh: ^Mesh, dynamic: bool)\n"
        /* 0623 */ "fn UpdateMeshBuffer*(mesh: Mesh, index: int32, data: ^void, dataSize: int32, offset: int32)\n"
        /* 0624 */ "fn UnloadMesh*(mesh: Mesh)\n"
        /* 0625 */ "fn DrawMesh*(mesh: Mesh, material: Material, transform: Matrix)\n"
        /* 0626 */ "fn DrawMeshInstanced*(mesh: Mesh, material: Material, transforms: ^Matrix, instances: int32)\n"
        /* 0627 */ "fn ExportMesh*(mesh: Mesh, fileName: str): bool\n"
        /* 0628 */ "fn GetMeshBoundingBox*(mesh: Mesh): BoundingBox\n"
        /* 0629 */ "fn GenMeshTangents*(mesh: ^Mesh)\n"
        /* 0630 */ "fn GenMeshPoly*(sides: int32, radius: real32): Mesh\n"
        /* 0631 */ "fn GenMeshPlane*(width: real32, length: real32, resX: int32, resZ: int32): Mesh\n"
        /* 0632 */ "fn GenMeshCube*(width: real32, height: real32, length: real32): Mesh\n"
        /* 0633 */ "fn GenMeshSphere*(radius: real32, rings: int32, slices: int32): Mesh\n"
        /* 0634 */ "fn GenMeshHemiSphere*(radius: real32, rings: int32, slices: int32): Mesh\n"
        /* 0635 */ "fn GenMeshCylinder*(radius: real32, height: real32, slices: int32): Mesh\n"
        /* 0636 */ "fn GenMeshCone*(radius: real32, height: real32, slices: int32): Mesh\n"
        /* 0637 */ "fn GenMeshTorus*(radius: real32, size: real32, radSeg: int32, sides: int32): Mesh\n"
        /* 0638 */ "fn GenMeshKnot*(radius: real32, size: real32, radSeg: int32, sides: int32): Mesh\n"
        /* 0639 */ "fn GenMeshHeightmap*(heightmap: Image, size: Vector3): Mesh\n"
        /* 0640 */ "fn GenMeshCubicmap*(cubicmap: Image, cubeSize: Vector3): Mesh\n"
        /* 0641 */ "fn LoadMaterials*(fileName: str, materialCount: ^int32): ^Material\n"
        /* 0642 */ "fn LoadMaterialDefault*(): Material\n"
        /* 0643 */ "fn UnloadMaterial*(material: Material)\n"
        /* 0644 */ "fn SetMaterialTexture*(material: ^Material, mapType: int32, texture: Texture)\n"
        /* 0645 */ "fn SetModelMeshMaterial*(model: ^Model, meshId: int32, materialId: int32)\n"
        /* 0646 */ "fn LoadModelAnimations*(fileName: str, animCount: ^uint32): ^ModelAnimation\n"
        /* 0647 */ "fn UpdateModelAnimation*(model: Model, anim: ModelAnimation, frame: int32)\n"
        /* 0648 */ "fn UnloadModelAnimation*(anim: ModelAnimation)\n"
        /* 0649 */ "fn UnloadModelAnimations*(animations: ^ModelAnimation, count: uint32)\n"
        /* 0650 */ "fn IsModelAnimationValid*(model: Model, anim: ModelAnimation): bool\n"
        /* 0651 */ "fn CheckCollisionSpheres*(center1: Vector3, radius1: real32, center2: Vector3, radius2: real32): bool\n"
        /* 0652 */ "fn CheckCollisionBoxes*(box1: BoundingBox, box2: BoundingBox): bool\n"
        /* 0653 */ "fn CheckCollisionBoxSphere*(box: BoundingBox, center: Vector3, radius: real32): bool\n"
        /* 0654 */ "fn GetRayCollisionSphere*(ray: Ray, center: Vector3, radius: real32): RayCollision\n"
        /* 0655 */ "fn GetRayCollisionBox*(ray: Ray, box: BoundingBox): RayCollision\n"
        /* 0656 */ "fn GetRayCollisionMesh*(ray: Ray, mesh: Mesh, transform: Matrix): RayCollision\n"
        /* 0657 */ "fn GetRayCollisionTriangle*(ray: Ray, p1: Vector3, p2: Vector3, p3: Vector3): RayCollision\n"
        /* 0658 */ "fn GetRayCollisionQuad*(ray: Ray, p1: Vector3, p2: Vector3, p3: Vector3, p4: Vector3): RayCollision\n"
        /* 0659 */ "fn InitAudioDevice*()\n"
        /* 0660 */ "fn CloseAudioDevice*()\n"
        /* 0661 */ "fn IsAudioDeviceReady*(): bool\n"
        /* 0662 */ "fn SetMasterVolume*(volume: real32)\n"
        /* 0663 */ "fn LoadWave*(fileName: str): Wave\n"
        /* 0664 */ "fn LoadWaveFromMemory*(fileType: str, fileData: ^void, dataSize: int32): Wave\n"
        /* 0665 */ "fn LoadSound*(fileName: str): Sound\n"
        /* 0666 */ "fn LoadSoundFromWave*(wave: Wave): Sound\n"
        /* 0667 */ "fn UpdateSound*(sound: Sound, data: ^void, sampleCount: int32)\n"
        /* 0668 */ "fn UnloadWave*(wave: Wave)\n"
        /* 0669 */ "fn UnloadSound*(sound: Sound)\n"
        /* 0670 */ "fn ExportWave*(wave: Wave, fileName: str): bool\n"
        /* 0671 */ "fn ExportWaveAsCode*(wave: Wave, fileName: str): bool\n"
        /* 0672 */ "fn PlaySound*(sound: Sound)\n"
        /* 0673 */ "fn StopSound*(sound: Sound)\n"
        /* 0674 */ "fn PauseSound*(sound: Sound)\n"
        /* 0675 */ "fn ResumeSound*(sound: Sound)\n"
        /* 0676 */ "fn PlaySoundMulti*(sound: Sound)\n"
        /* 0677 */ "fn StopSoundMulti*()\n"
        /* 0678 */ "fn GetSoundsPlaying*(): int32\n"
        /* 0679 */ "fn IsSoundPlaying*(sound: Sound): bool\n"
        /* 0680 */ "fn SetSoundVolume*(sound: Sound, volume: real32)\n"
        /* 0681 */ "fn SetSoundPitch*(sound: Sound, pitch: real32)\n"
        /* 0682 */ "fn SetSoundPan*(sound: Sound, pan: real32)\n"
        /* 0683 */ "fn WaveCopy*(wave: Wave): Wave\n"
        /* 0684 */ "fn WaveCrop*(wave: ^Wave, initSample: int32, finalSample: int32)\n"
        /* 0685 */ "fn WaveFormat*(wave: ^Wave, sampleRate: int32, sampleSize: int32, channels: int32)\n"
        /* 0686 */ "fn LoadWaveSamples*(wave: Wave): ^real32\n"
        /* 0687 */ "fn UnloadWaveSamples*(samples: ^real32)\n"
        /* 0688 */ "fn LoadMusicStream*(fileName: str): Music\n"
        /* 0689 */ "fn LoadMusicStreamFromMemory*(fileType: str, data: ^void, dataSize: int32): Music\n"
        /* 0690 */ "fn UnloadMusicStream*(music: Music)\n"
        /* 0691 */ "fn PlayMusicStream*(music: Music)\n"
        /* 0692 */ "fn IsMusicStreamPlaying*(music: Music): bool\n"
        /* 0693 */ "fn UpdateMusicStream*(music: Music)\n"
        /* 0694 */ "fn StopMusicStream*(music: Music)\n"
        /* 0695 */ "fn PauseMusicStream*(music: Music)\n"
        /* 0696 */ "fn ResumeMusicStream*(music: Music)\n"
        /* 0697 */ "fn SeekMusicStream*(music: Music, position: real32)\n"
        /* 0698 */ "fn SetMusicVolume*(music: Music, volume: real32)\n"
        /* 0699 */ "fn SetMusicPitch*(music: Music, pitch: real32)\n"
        /* 0700 */ "fn SetMusicPan*(music: Music, pan: real32)\n"
        /* 0701 */ "fn GetMusicTimeLength*(music: Music): real32\n"
        /* 0702 */ "fn GetMusicTimePlayed*(music: Music): real32\n"
        /* 0703 */ "fn LoadAudioStream*(sampleRate: uint32, sampleSize: uint32, channels: uint32): AudioStream\n"
        /* 0704 */ "fn UnloadAudioStream*(stream: AudioStream)\n"
        /* 0705 */ "fn UpdateAudioStream*(stream: AudioStream, data: ^void, frameCount: int32)\n"
        /* 0706 */ "fn IsAudioStreamProcessed*(stream: AudioStream): bool\n"
        /* 0707 */ "fn PlayAudioStream*(stream: AudioStream)\n"
        /* 0708 */ "fn PauseAudioStream*(stream: AudioStream)\n"
        /* 0709 */ "fn ResumeAudioStream*(stream: AudioStream)\n"
        /* 0710 */ "fn IsAudioStreamPlaying*(stream: AudioStream): bool\n"
        /* 0711 */ "fn StopAudioStream*(stream: AudioStream)\n"
        /* 0712 */ "fn SetAudioStreamVolume*(stream: AudioStream, volume: real32)\n"
        /* 0713 */ "fn SetAudioStreamPitch*(stream: AudioStream, pitch: real32)\n"
        /* 0714 */ "fn SetAudioStreamPan*(stream: AudioStream, pan: real32)\n"
        /* 0715 */ "fn SetAudioStreamBufferSizeDefault*(size: int32)\n"
        // Skipping SetAudioStreamCallback
        // Skipping AttachAudioStreamProcessor
        // Skipping DetachAudioStreamProcessor

        // Enums
        /* 0716 */ "const FLAG_VSYNC_HINT* = 64\n"
        /* 0717 */ "const FLAG_FULLSCREEN_MODE* = 2\n"
        /* 0718 */ "const FLAG_WINDOW_RESIZABLE* = 4\n"
        /* 0719 */ "const FLAG_WINDOW_UNDECORATED* = 8\n"
        /* 0720 */ "const FLAG_WINDOW_HIDDEN* = 128\n"
        /* 0721 */ "const FLAG_WINDOW_MINIMIZED* = 512\n"
        /* 0722 */ "const FLAG_WINDOW_MAXIMIZED* = 1024\n"
        /* 0723 */ "const FLAG_WINDOW_UNFOCUSED* = 2048\n"
        /* 0724 */ "const FLAG_WINDOW_TOPMOST* = 4096\n"
        /* 0725 */ "const FLAG_WINDOW_ALWAYS_RUN* = 256\n"
        /* 0726 */ "const FLAG_WINDOW_TRANSPARENT* = 16\n"
        /* 0727 */ "const FLAG_WINDOW_HIGHDPI* = 8192\n"
        /* 0728 */ "const FLAG_WINDOW_MOUSE_PASSTHROUGH* = 16384\n"
        /* 0729 */ "const FLAG_MSAA_4X_HINT* = 32\n"
        /* 0730 */ "const FLAG_INTERLACED_HINT* = 65536\n"
        /* 0731 */ "const LOG_ALL* = 0\n"
        /* 0732 */ "const LOG_TRACE* = 1\n"
        /* 0733 */ "const LOG_DEBUG* = 2\n"
        /* 0734 */ "const LOG_INFO* = 3\n"
        /* 0735 */ "const LOG_WARNING* = 4\n"
        /* 0736 */ "const LOG_ERROR* = 5\n"
        /* 0737 */ "const LOG_FATAL* = 6\n"
        /* 0738 */ "const LOG_NONE* = 7\n"
        /* 0739 */ "const KEY_NULL* = 0\n"
        /* 0740 */ "const KEY_APOSTROPHE* = 39\n"
        /* 0741 */ "const KEY_COMMA* = 44\n"
        /* 0742 */ "const KEY_MINUS* = 45\n"
        /* 0743 */ "const KEY_PERIOD* = 46\n"
        /* 0744 */ "const KEY_SLASH* = 47\n"
        /* 0745 */ "const KEY_ZERO* = 48\n"
        /* 0746 */ "const KEY_ONE* = 49\n"
        /* 0747 */ "const KEY_TWO* = 50\n"
        /* 0748 */ "const KEY_THREE* = 51\n"
        /* 0749 */ "const KEY_FOUR* = 52\n"
        /* 0750 */ "const KEY_FIVE* = 53\n"
        /* 0751 */ "const KEY_SIX* = 54\n"
        /* 0752 */ "const KEY_SEVEN* = 55\n"
        /* 0753 */ "const KEY_EIGHT* = 56\n"
        /* 0754 */ "const KEY_NINE* = 57\n"
        /* 0755 */ "const KEY_SEMICOLON* = 59\n"
        /* 0756 */ "const KEY_EQUAL* = 61\n"
        /* 0757 */ "const KEY_A* = 65\n"
        /* 0758 */ "const KEY_B* = 66\n"
        /* 0759 */ "const KEY_C* = 67\n"
        /* 0760 */ "const KEY_D* = 68\n"
        ...
        /* 0781 */ "const KEY_Y* = 89\n"
        /* 0782 */ "const KEY_Z* = 90\n"
        /* 0783 */ "const KEY_LEFT_BRACKET* = 91\n"
        /* 0784 */ "const KEY_BACKSLASH* = 92\n"
        /* 0785 */ "const KEY_RIGHT_BRACKET* = 93\n"
        /* 0786 */ "const KEY_GRAVE* = 96\n"
        /* 0787 */ "const KEY_SPACE* = 32\n"
        /* 0788 */ "const KEY_ESCAPE* = 256\n"
        /* 0789 */ "const KEY_ENTER* = 257\n"
        /* 0790 */ "const KEY_TAB* = 258\n"
        /* 0791 */ "const KEY_BACKSPACE* = 259\n"
        /* 0792 */ "const KEY_INSERT* = 260\n"
        /* 0793 */ "const KEY_DELETE* = 261\n"
        /* 0794 */ "const KEY_RIGHT* = 262\n"
        /* 0795 */ "const KEY_LEFT* = 263\n"
        /* 0796 */ "const KEY_DOWN* = 264\n"
        /* 0797 */ "const KEY_UP* = 265\n"
        /* 0798 */ "const KEY_PAGE_UP* = 266\n"
        /* 0799 */ "const KEY_PAGE_DOWN* = 267\n"
        /* 0800 */ "const KEY_HOME* = 268\n"
        /* 0801 */ "const KEY_END* = 269\n"
        /* 0802 */ "const KEY_CAPS_LOCK* = 280\n"
        /* 0803 */ "const KEY_SCROLL_LOCK* = 281\n"
        /* 0804 */ "const KEY_NUM_LOCK* = 282\n"
        /* 0805 */ "const KEY_PRINT_SCREEN* = 283\n"
        /* 0806 */ "const KEY_PAUSE* = 284\n"
        /* 0807 */ "const KEY_F1* = 290\n"
        /* 0808 */ "const KEY_F2* = 291\n"
        /* 0809 */ "const KEY_F3* = 292\n"
        /* 0810 */ "const KEY_F4* = 293\n"
        /* 0811 */ "const KEY_F5* = 294\n"
        /* 0812 */ "const KEY_F6* = 295\n"
        /* 0813 */ "const KEY_F7* = 296\n"
        /* 0814 */ "const KEY_F8* = 297\n"
        /* 0815 */ "const KEY_F9* = 298\n"
        /* 0816 */ "const KEY_F10* = 299\n"
        /* 0817 */ "const KEY_F11* = 300\n"
        /* 0818 */ "const KEY_F12* = 301\n"
        /* 0819 */ "const KEY_LEFT_SHIFT* = 340\n"
        /* 0820 */ "const KEY_LEFT_CONTROL* = 341\n"
        /* 0821 */ "const KEY_LEFT_ALT* = 342\n"
        /* 0822 */ "const KEY_LEFT_SUPER* = 343\n"
        /* 0823 */ "const KEY_RIGHT_SHIFT* = 344\n"
        /* 0824 */ "const KEY_RIGHT_CONTROL* = 345\n"
        /* 0825 */ "const KEY_RIGHT_ALT* = 346\n"
        /* 0826 */ "const KEY_RIGHT_SUPER* = 347\n"
        /* 0827 */ "const KEY_KB_MENU* = 348\n"
        /* 0828 */ "const KEY_KP_0* = 320\n"
        /* 0829 */ "const KEY_KP_1* = 321\n"
        /* 0830 */ "const KEY_KP_2* = 322\n"
        /* 0831 */ "const KEY_KP_3* = 323\n"
        /* 0832 */ "const KEY_KP_4* = 324\n"
        /* 0833 */ "const KEY_KP_5* = 325\n"
        /* 0834 */ "const KEY_KP_6* = 326\n"
        /* 0835 */ "const KEY_KP_7* = 327\n"
        /* 0836 */ "const KEY_KP_8* = 328\n"
        /* 0837 */ "const KEY_KP_9* = 329\n"
        /* 0838 */ "const KEY_KP_DECIMAL* = 330\n"
        /* 0839 */ "const KEY_KP_DIVIDE* = 331\n"
        /* 0840 */ "const KEY_KP_MULTIPLY* = 332\n"
        /* 0841 */ "const KEY_KP_SUBTRACT* = 333\n"
        /* 0842 */ "const KEY_KP_ADD* = 334\n"
        /* 0843 */ "const KEY_KP_ENTER* = 335\n"
        /* 0844 */ "const KEY_KP_EQUAL* = 336\n"
        /* 0845 */ "const KEY_BACK* = 4\n"
        /* 0846 */ "const KEY_MENU* = 82\n"
        /* 0847 */ "const KEY_VOLUME_UP* = 24\n"
        /* 0848 */ "const KEY_VOLUME_DOWN* = 25\n"
        /* 0849 */ "const MOUSE_BUTTON_LEFT* = 0\n"
        /* 0850 */ "const MOUSE_BUTTON_RIGHT* = 1\n"
        /* 0851 */ "const MOUSE_BUTTON_MIDDLE* = 2\n"
        /* 0852 */ "const MOUSE_BUTTON_SIDE* = 3\n"
        /* 0853 */ "const MOUSE_BUTTON_EXTRA* = 4\n"
        /* 0854 */ "const MOUSE_BUTTON_FORWARD* = 5\n"
        /* 0855 */ "const MOUSE_BUTTON_BACK* = 6\n"
        /* 0856 */ "const MOUSE_CURSOR_DEFAULT* = 0\n"
        /* 0857 */ "const MOUSE_CURSOR_ARROW* = 1\n"
        /* 0858 */ "const MOUSE_CURSOR_IBEAM* = 2\n"
        /* 0859 */ "const MOUSE_CURSOR_CROSSHAIR* = 3\n"
        /* 0860 */ "const MOUSE_CURSOR_POINTING_HAND* = 4\n"
        /* 0861 */ "const MOUSE_CURSOR_RESIZE_EW* = 5\n"
        /* 0862 */ "const MOUSE_CURSOR_RESIZE_NS* = 6\n"
        /* 0863 */ "const MOUSE_CURSOR_RESIZE_NWSE* = 7\n"
        /* 0864 */ "const MOUSE_CURSOR_RESIZE_NESW* = 8\n"
        /* 0865 */ "const MOUSE_CURSOR_RESIZE_ALL* = 9\n"
        /* 0866 */ "const MOUSE_CURSOR_NOT_ALLOWED* = 10\n"
        /* 0867 */ "const GAMEPAD_BUTTON_UNKNOWN* = 0\n"
        /* 0868 */ "const GAMEPAD_BUTTON_LEFT_FACE_UP* = 1\n"
        /* 0869 */ "const GAMEPAD_BUTTON_LEFT_FACE_RIGHT* = 2\n"
        /* 0870 */ "const GAMEPAD_BUTTON_LEFT_FACE_DOWN* = 3\n"
        /* 0871 */ "const GAMEPAD_BUTTON_LEFT_FACE_LEFT* = 4\n"
        /* 0872 */ "const GAMEPAD_BUTTON_RIGHT_FACE_UP* = 5\n"
        /* 0873 */ "const GAMEPAD_BUTTON_RIGHT_FACE_RIGHT* = 6\n"
        /* 0874 */ "const GAMEPAD_BUTTON_RIGHT_FACE_DOWN* = 7\n"
        /* 0875 */ "const GAMEPAD_BUTTON_RIGHT_FACE_LEFT* = 8\n"
        /* 0876 */ "const GAMEPAD_BUTTON_LEFT_TRIGGER_1* = 9\n"
        /* 0877 */ "const GAMEPAD_BUTTON_LEFT_TRIGGER_2* = 10\n"
        /* 0878 */ "const GAMEPAD_BUTTON_RIGHT_TRIGGER_1* = 11\n"
        /* 0879 */ "const GAMEPAD_BUTTON_RIGHT_TRIGGER_2* = 12\n"
        /* 0880 */ "const GAMEPAD_BUTTON_MIDDLE_LEFT* = 13\n"
        /* 0881 */ "const GAMEPAD_BUTTON_MIDDLE* = 14\n"
        /* 0882 */ "const GAMEPAD_BUTTON_MIDDLE_RIGHT* = 15\n"
        /* 0883 */ "const GAMEPAD_BUTTON_LEFT_THUMB* = 16\n"
        /* 0884 */ "const GAMEPAD_BUTTON_RIGHT_THUMB* = 17\n"
        /* 0885 */ "const GAMEPAD_AXIS_LEFT_X* = 0\n"
        /* 0886 */ "const GAMEPAD_AXIS_LEFT_Y* = 1\n"
        /* 0887 */ "const GAMEPAD_AXIS_RIGHT_X* = 2\n"
        /* 0888 */ "const GAMEPAD_AXIS_RIGHT_Y* = 3\n"
        /* 0889 */ "const GAMEPAD_AXIS_LEFT_TRIGGER* = 4\n"
        /* 0890 */ "const GAMEPAD_AXIS_RIGHT_TRIGGER* = 5\n"
        /* 0891 */ "const MATERIAL_MAP_ALBEDO* = 0\n"
        /* 0892 */ "const MATERIAL_MAP_METALNESS* = 1\n"
        /* 0893 */ "const MATERIAL_MAP_NORMAL* = 2\n"
        /* 0894 */ "const MATERIAL_MAP_ROUGHNESS* = 3\n"
        /* 0895 */ "const MATERIAL_MAP_OCCLUSION* = 4\n"
        /* 0896 */ "const MATERIAL_MAP_EMISSION* = 5\n"
        /* 0897 */ "const MATERIAL_MAP_HEIGHT* = 6\n"
        /* 0898 */ "const MATERIAL_MAP_CUBEMAP* = 7\n"
        /* 0899 */ "const MATERIAL_MAP_IRRADIANCE* = 8\n"
        /* 0900 */ "const MATERIAL_MAP_PREFILTER* = 9\n"
        /* 0901 */ "const MATERIAL_MAP_BRDF* = 10\n"
        /* 0902 */ "const SHADER_LOC_VERTEX_POSITION* = 0\n"
        /* 0903 */ "const SHADER_LOC_VERTEX_TEXCOORD01* = 1\n"
        /* 0904 */ "const SHADER_LOC_VERTEX_TEXCOORD02* = 2\n"
        /* 0905 */ "const SHADER_LOC_VERTEX_NORMAL* = 3\n"
        /* 0906 */ "const SHADER_LOC_VERTEX_TANGENT* = 4\n"
        /* 0907 */ "const SHADER_LOC_VERTEX_COLOR* = 5\n"
        /* 0908 */ "const SHADER_LOC_MATRIX_MVP* = 6\n"
        /* 0909 */ "const SHADER_LOC_MATRIX_VIEW* = 7\n"
        /* 0910 */ "const SHADER_LOC_MATRIX_PROJECTION* = 8\n"
        /* 0911 */ "const SHADER_LOC_MATRIX_MODEL* = 9\n"
        /* 0912 */ "const SHADER_LOC_MATRIX_NORMAL* = 10\n"
        /* 0913 */ "const SHADER_LOC_VECTOR_VIEW* = 11\n"
        /* 0914 */ "const SHADER_LOC_COLOR_DIFFUSE* = 12\n"
        /* 0915 */ "const SHADER_LOC_COLOR_SPECULAR* = 13\n"
        /* 0916 */ "const SHADER_LOC_COLOR_AMBIENT* = 14\n"
        /* 0917 */ "const SHADER_LOC_MAP_ALBEDO* = 15\n"
        /* 0918 */ "const SHADER_LOC_MAP_METALNESS* = 16\n"
        /* 0919 */ "const SHADER_LOC_MAP_NORMAL* = 17\n"
        /* 0920 */ "const SHADER_LOC_MAP_ROUGHNESS* = 18\n"
        /* 0921 */ "const SHADER_LOC_MAP_OCCLUSION* = 19\n"
        /* 0922 */ "const SHADER_LOC_MAP_EMISSION* = 20\n"
        /* 0923 */ "const SHADER_LOC_MAP_HEIGHT* = 21\n"
        /* 0924 */ "const SHADER_LOC_MAP_CUBEMAP* = 22\n"
        /* 0925 */ "const SHADER_LOC_MAP_IRRADIANCE* = 23\n"
        /* 0926 */ "const SHADER_LOC_MAP_PREFILTER* = 24\n"
        /* 0927 */ "const SHADER_LOC_MAP_BRDF* = 25\n"
        /* 0928 */ "const SHADER_UNIFORM_FLOAT* = 0\n"
        /* 0929 */ "const SHADER_UNIFORM_VEC2* = 1\n"
        /* 0930 */ "const SHADER_UNIFORM_VEC3* = 2\n"
        /* 0931 */ "const SHADER_UNIFORM_VEC4* = 3\n"
        /* 0932 */ "const SHADER_UNIFORM_INT* = 4\n"
        /* 0933 */ "const SHADER_UNIFORM_IVEC2* = 5\n"
        /* 0934 */ "const SHADER_UNIFORM_IVEC3* = 6\n"
        /* 0935 */ "const SHADER_UNIFORM_IVEC4* = 7\n"
        /* 0936 */ "const SHADER_UNIFORM_SAMPLER2D* = 8\n"
        /* 0937 */ "const SHADER_ATTRIB_FLOAT* = 0\n"
        /* 0938 */ "const SHADER_ATTRIB_VEC2* = 1\n"
        /* 0939 */ "const SHADER_ATTRIB_VEC3* = 2\n"
        /* 0940 */ "const SHADER_ATTRIB_VEC4* = 3\n"
        /* 0941 */ "const PIXELFORMAT_UNCOMPRESSED_GRAYSCALE* = 1\n"
        /* 0942 */ "const PIXELFORMAT_UNCOMPRESSED_GRAY_ALPHA* = 2\n"
        /* 0943 */ "const PIXELFORMAT_UNCOMPRESSED_R5G6B5* = 3\n"
        /* 0944 */ "const PIXELFORMAT_UNCOMPRESSED_R8G8B8* = 4\n"
        /* 0945 */ "const PIXELFORMAT_UNCOMPRESSED_R5G5B5A1* = 5\n"
        /* 0946 */ "const PIXELFORMAT_UNCOMPRESSED_R4G4B4A4* = 6\n"
        /* 0947 */ "const PIXELFORMAT_UNCOMPRESSED_R8G8B8A8* = 7\n"
        /* 0948 */ "const PIXELFORMAT_UNCOMPRESSED_R32* = 8\n"
        /* 0949 */ "const PIXELFORMAT_UNCOMPRESSED_R32G32B32* = 9\n"
        /* 0950 */ "const PIXELFORMAT_UNCOMPRESSED_R32G32B32A32* = 10\n"
        /* 0951 */ "const PIXELFORMAT_COMPRESSED_DXT1_RGB* = 11\n"
        /* 0952 */ "const PIXELFORMAT_COMPRESSED_DXT1_RGBA* = 12\n"
        /* 0953 */ "const PIXELFORMAT_COMPRESSED_DXT3_RGBA* = 13\n"
        /* 0954 */ "const PIXELFORMAT_COMPRESSED_DXT5_RGBA* = 14\n"
        /* 0955 */ "const PIXELFORMAT_COMPRESSED_ETC1_RGB* = 15\n"
        /* 0956 */ "const PIXELFORMAT_COMPRESSED_ETC2_RGB* = 16\n"
        /* 0957 */ "const PIXELFORMAT_COMPRESSED_ETC2_EAC_RGBA* = 17\n"
        /* 0958 */ "const PIXELFORMAT_COMPRESSED_PVRT_RGB* = 18\n"
        /* 0959 */ "const PIXELFORMAT_COMPRESSED_PVRT_RGBA* = 19\n"
        /* 0960 */ "const PIXELFORMAT_COMPRESSED_ASTC_4x4_RGBA* = 20\n"
        /* 0961 */ "const PIXELFORMAT_COMPRESSED_ASTC_8x8_RGBA* = 21\n"
        /* 0962 */ "const TEXTURE_FILTER_POINT* = 0\n"
        /* 0963 */ "const TEXTURE_FILTER_BILINEAR* = 1\n"
        /* 0964 */ "const TEXTURE_FILTER_TRILINEAR* = 2\n"
        /* 0965 */ "const TEXTURE_FILTER_ANISOTROPIC_4X* = 3\n"
        /* 0966 */ "const TEXTURE_FILTER_ANISOTROPIC_8X* = 4\n"
        /* 0967 */ "const TEXTURE_FILTER_ANISOTROPIC_16X* = 5\n"
        /* 0968 */ "const TEXTURE_WRAP_REPEAT* = 0\n"
        /* 0969 */ "const TEXTURE_WRAP_CLAMP* = 1\n"
        /* 0970 */ "const TEXTURE_WRAP_MIRROR_REPEAT* = 2\n"
        /* 0971 */ "const TEXTURE_WRAP_MIRROR_CLAMP* = 3\n"
        /* 0972 */ "const CUBEMAP_LAYOUT_AUTO_DETECT* = 0\n"
        /* 0973 */ "const CUBEMAP_LAYOUT_LINE_VERTICAL* = 1\n"
        /* 0974 */ "const CUBEMAP_LAYOUT_LINE_HORIZONTAL* = 2\n"
        /* 0975 */ "const CUBEMAP_LAYOUT_CROSS_THREE_BY_FOUR* = 3\n"
        /* 0976 */ "const CUBEMAP_LAYOUT_CROSS_FOUR_BY_THREE* = 4\n"
        /* 0977 */ "const CUBEMAP_LAYOUT_PANORAMA* = 5\n"
        /* 0978 */ "const FONT_DEFAULT* = 0\n"
        /* 0979 */ "const FONT_BITMAP* = 1\n"
        /* 0980 */ "const FONT_SDF* = 2\n"
        /* 0981 */ "const BLEND_ALPHA* = 0\n"
        /* 0982 */ "const BLEND_ADDITIVE* = 1\n"
        /* 0983 */ "const BLEND_MULTIPLIED* = 2\n"
        /* 0984 */ "const BLEND_ADD_COLORS* = 3\n"
        /* 0985 */ "const BLEND_SUBTRACT_COLORS* = 4\n"
        /* 0986 */ "const BLEND_ALPHA_PREMULTIPLY* = 5\n"
        /* 0987 */ "const BLEND_CUSTOM* = 6\n"
        /* 0988 */ "const GESTURE_NONE* = 0\n"
        /* 0989 */ "const GESTURE_TAP* = 1\n"
        /* 0990 */ "const GESTURE_DOUBLETAP* = 2\n"
        /* 0991 */ "const GESTURE_HOLD* = 4\n"
        /* 0992 */ "const GESTURE_DRAG* = 8\n"
        /* 0993 */ "const GESTURE_SWIPE_RIGHT* = 16\n"
        /* 0994 */ "const GESTURE_SWIPE_LEFT* = 32\n"
        /* 0995 */ "const GESTURE_SWIPE_UP* = 64\n"
        /* 0996 */ "const GESTURE_SWIPE_DOWN* = 128\n"
        /* 0997 */ "const GESTURE_PINCH_IN* = 256\n"
        /* 0998 */ "const GESTURE_PINCH_OUT* = 512\n"
        /* 0999 */ "const CAMERA_CUSTOM* = 0\n"
        /* 1000 */ "const CAMERA_FREE* = 1\n"
        /* 1001 */ "const CAMERA_ORBITAL* = 2\n"
        /* 1002 */ "const CAMERA_FIRST_PERSON* = 3\n"
        /* 1003 */ "const CAMERA_THIRD_PERSON* = 4\n"
        /* 1004 */ "const CAMERA_PERSPECTIVE* = 0\n"
        /* 1005 */ "const CAMERA_ORTHOGRAPHIC* = 1\n"
        /* 1006 */ "const NPATCH_NINE_PATCH* = 0\n"
        /* 1007 */ "const NPATCH_THREE_PATCH_VERTICAL* = 1\n"
        /* 1008 */ "const NPATCH_THREE_PATCH_HORIZONTAL* = 2\n"

        // Defines
        /* 1009 */ "const RAYLIB_VERSION* = \"4.2\"\n"
        // Skipped define: __declspec(x)
        // Skipped define: RLAPI
        /* 1010 */ "const PI* = 3.141592653589793\n"
        ...
        /* 1011 */ "const LIGHTGRAY* = Color{ 200, 200, 200, 255 }\n"
        /* 1012 */ "const GRAY* = Color{ 130, 130, 130, 255 }\n"
        /* 1013 */ "const DARKGRAY* = Color{ 80, 80, 80, 255 }\n"
        /* 1014 */ "const YELLOW* = Color{ 253, 249, 0, 255 }\n"
        /* 1015 */ "const GOLD* = Color{ 255, 203, 0, 255 }\n"
        /* 1016 */ "const ORANGE* = Color{ 255, 161, 0, 255 }\n"
        /* 1017 */ "const PINK* = Color{ 255, 109, 194, 255 }\n"
        /* 1018 */ "const RED* = Color{ 230, 41, 55, 255 }\n"
        /* 1019 */ "const MAROON* = Color{ 190, 33, 55, 255 }\n"
        /* 1020 */ "const GREEN* = Color{ 0, 228, 48, 255 }\n"
        /* 1021 */ "const LIME* = Color{ 0, 158, 47, 255 }\n"
        /* 1022 */ "const DARKGREEN* = Color{ 0, 117, 44, 255 }\n"
        /* 1023 */ "const SKYBLUE* = Color{ 102, 191, 255, 255 }\n"
        /* 1024 */ "const BLUE* = Color{ 0, 121, 241, 255 }\n"
        /* 1025 */ "const DARKBLUE* = Color{ 0, 82, 172, 255 }\n"
        /* 1026 */ "const PURPLE* = Color{ 200, 122, 255, 255 }\n"
        /* 1027 */ "const VIOLET* = Color{ 135, 60, 190, 255 }\n"
        /* 1028 */ "const DARKPURPLE* = Color{ 112, 31, 126, 255 }\n"
        /* 1029 */ "const BEIGE* = Color{ 211, 176, 131, 255 }\n"
        /* 1030 */ "const BROWN* = Color{ 127, 106, 79, 255 }\n"
        /* 1031 */ "const DARKBROWN* = Color{ 76, 63, 47, 255 }\n"
        /* 1032 */ "const WHITE* = Color{ 255, 255, 255, 255 }\n"
        /* 1033 */ "const BLACK* = Color{ 0, 0, 0, 255 }\n"
        /* 1034 */ "const BLANK* = Color{ 0, 0, 0, 0 }\n"
        /* 1035 */ "const MAGENTA* = Color{ 255, 0, 255, 255 }\n"
        /* 1036 */ "const RAYWHITE* = Color{ 245, 245, 245, 255 }\n"
