...
bool umkaAddRaylib(void *umka) {
    ...
    const char* moduleCode =
        ...
        /* 0479 */ "fn DrawLineStrip*(points: ^Vector2, pointCount: int32, color: Color)\n"
        ...
        /* 0509 */ "fn DrawTriangleFan*(points: ^Vector2, pointCount: int32, color: Color)\n"
        /* 0510 */ "fn DrawTriangleStrip*(points: ^Vector2, pointCount: int32, color: Color)\n"
        ...
        /* 0514 */ "fn DrawSplineLinear*(points: ^Vector2, pointCount: int32, thick: real32, color: Color)\n"
        /* 0515 */ "fn DrawSplineBasis*(points: ^Vector2, pointCount: int32, thick: real32, color: Color)\n"
        /* 0516 */ "fn DrawSplineCatmullRom*(points: ^Vector2, pointCount: int32, thick: real32, color: Color)\n"
        /* 0517 */ "fn DrawSplineBezierQuadratic*(points: ^Vector2, pointCount: int32, thick: real32, color: Color)\n"
        /* 0518 */ "fn DrawSplineBezierCubic*(points: ^Vector2, pointCount: int32, thick: real32, color: Color)\n"
        ...
        /* 0537 */ "fn CheckCollisionPointPoly*(point: Vector2, points: ^Vector2, pointCount: int32): bool\n"
        ...
        /* 0614 */ "fn ImageDrawTriangleFan*(dst: ^Image, points: ^Vector2, pointCount: int32, color: Color)\n"
        /* 0615 */ "fn ImageDrawTriangleStrip*(dst: ^Image, points: ^Vector2, pointCount: int32, color: Color)\n"
        ...
        /* 0713 */ "fn DrawTriangleStrip3D*(points: ^Vector3, pointCount: int32, color: Color)\n"
        ...
        /* 0894 */ "fn Vector3Length*(v: Vector3): real32\n"
        /* 0895 */ "fn Vector3LengthSqr*(v: Vector3): real32\n"
        ...
        /* 1573 */ "LIGHTGRAY* := Color{ 200, 200, 200, 255 }\n"
        /* 1574 */ "GRAY* := Color{ 130, 130, 130, 255 }\n"
        /* 1575 */ "DARKGRAY* := Color{ 80, 80, 80, 255 }\n"
        /* 1576 */ "YELLOW* := Color{ 253, 249, 0, 255 }\n"
        /* 1577 */ "GOLD* := Color{ 255, 203, 0, 255 }\n"
        /* 1578 */ "ORANGE* := Color{ 255, 161, 0, 255 }\n"
        /* 1579 */ "PINK* := Color{ 255, 109, 194, 255 }\n"
        /* 1580 */ "RED* := Color{ 230, 41, 55, 255 }\n"
        /* 1581 */ "MAROON* := Color{ 190, 33, 55, 255 }\n"
        /* 1582 */ "GREEN* := Color{ 0, 228, 48, 255 }\n"
        /* 1583 */ "LIME* := Color{ 0, 158, 47, 255 }\n"
        /* 1584 */ "DARKGREEN* := Color{ 0, 117, 44, 255 }\n"
        /* 1585 */ "SKYBLUE* := Color{ 102, 191, 255, 255 }\n"
        /* 1586 */ "BLUE* := Color{ 0, 121, 241, 255 }\n"
        /* 1587 */ "DARKBLUE* := Color{ 0, 82, 172, 255 }\n"
        /* 1588 */ "PURPLE* := Color{ 200, 122, 255, 255 }\n"
        /* 1589 */ "VIOLET* := Color{ 135, 60, 190, 255 }\n"
        /* 1590 */ "DARKPURPLE* := Color{ 112, 31, 126, 255 }\n"
        /* 1591 */ "BEIGE* := Color{ 211, 176, 131, 255 }\n"
        /* 1592 */ "BROWN* := Color{ 127, 106, 79, 255 }\n"
        /* 1593 */ "DARKBROWN* := Color{ 76, 63, 47, 255 }\n"
        /* 1594 */ "WHITE* := Color{ 255, 255, 255, 255 }\n"
        /* 1595 */ "BLACK* := Color{ 0, 0, 0, 255 }\n"
        /* 1596 */ "BLANK* := Color{ 0, 0, 0, 0 }\n"
        /* 1597 */ "MAGENTA* := Color{ 255, 0, 255, 255 }\n"
        /* 1598 */ "RAYWHITE* := Color{ 245, 245, 245, 255 }\n"
