/**********************************************************************************************
*
*   raylib-umka v0.6.0 - Umka bindings for raylib.
*
...
/**
 * Umka bindings for ToggleBorderlessWindowed().
 *
 * @see ToggleBorderlessWindowed()
 */
void umkaToggleBorderlessWindowed(UmkaStackSlot *params, UmkaStackSlot *result) {
...
/**
 * Umka bindings for SetWindowMaxSize().
 *
 * @see SetWindowMaxSize()
 */
void umkaSetWindowMaxSize(UmkaStackSlot *params, UmkaStackSlot *result) {
    int width = params[1].intVal;
    int height = params[0].intVal;
...
/**
 * Umka bindings for SetWindowFocused().
 *
 * @see SetWindowFocused()
 */
void umkaSetWindowFocused(UmkaStackSlot *params, UmkaStackSlot *result) {
    SetWindowFocused();
}
...
/**
 * Umka bindings for GetClipboardImage().
 *
 * @see GetClipboardImage()
 */
void umkaGetClipboardImage(UmkaStackSlot *params, UmkaStackSlot *result) {
...
/**
 * Umka bindings for IsShaderValid().
 *
 * @see IsShaderValid()
 */
void umkaIsShaderValid(UmkaStackSlot *params, UmkaStackSlot *result) {
    Shader* shader = (Shader*)&params[0];
    result->intVal = (int)IsShaderValid(*shader);
}
...
/**
 * Umka bindings for GetScreenToWorldRay().
 *
 * @see GetScreenToWorldRay()
 */
void umkaGetScreenToWorldRay(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
...
/**
 * Umka bindings for GetScreenToWorldRayEx().
 *
 * @see GetScreenToWorldRayEx()
 */
void umkaGetScreenToWorldRayEx(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector2* position = (Vector2*)&params[4];
    Camera* camera = (Camera*)&params[3];
    int width = params[2].intVal;
    int height = params[1].intVal;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Ray), NULL);
    Ray out = GetScreenToWorldRayEx(*position, *camera, width, height);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Ray));
}
...
/**
 * Umka bindings for LoadRandomSequence().
 *
 * @see LoadRandomSequence()
 */
void umkaLoadRandomSequence(UmkaStackSlot *params, UmkaStackSlot *result) {
    unsigned int count = params[2].uintVal;
    int min = params[1].intVal;
    int max = params[0].intVal;
    result->ptrVal = (void*)LoadRandomSequence(count, min, max);
}

/**
 * Umka bindings for UnloadRandomSequence().
 *
 * @see UnloadRandomSequence()
 */
void umkaUnloadRandomSequence(UmkaStackSlot *params, UmkaStackSlot *result) {
    int * sequence = (int *)params[0].ptrVal;
...
void umkaLoadFileData(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    result->ptrVal = (void*)LoadFileData(fileName, dataSize);
}
...
void umkaSaveFileData(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    result->intVal = (int)SaveFileData(fileName, data, dataSize);
}
...
void umkaExportDataAsCode(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    const char * fileName = (const char *)params[0].ptrVal;
    result->intVal = (int)ExportDataAsCode(data, dataSize, fileName);
}
...
/**
 * Umka bindings for FileRename().
 *
 * @see FileRename()
 */
void umkaFileRename(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * fileName = (const char *)params[1].ptrVal;
    const char * fileRename = (const char *)params[0].ptrVal;
    result->intVal = FileRename(fileName, fileRename);
}

/**
 * Umka bindings for FileRemove().
 *
 * @see FileRemove()
 */
void umkaFileRemove(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * fileName = (const char *)params[0].ptrVal;
    result->intVal = FileRemove(fileName);
}

/**
 * Umka bindings for FileCopy().
 *
 * @see FileCopy()
 */
void umkaFileCopy(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * srcPath = (const char *)params[1].ptrVal;
    const char * dstPath = (const char *)params[0].ptrVal;
    result->intVal = FileCopy(srcPath, dstPath);
}

/**
 * Umka bindings for FileMove().
 *
 * @see FileMove()
 */
void umkaFileMove(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * srcPath = (const char *)params[1].ptrVal;
    const char * dstPath = (const char *)params[0].ptrVal;
    result->intVal = FileMove(srcPath, dstPath);
}

/**
 * Umka bindings for FileTextReplace().
 *
 * @see FileTextReplace()
 */
void umkaFileTextReplace(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * fileName = (const char *)params[2].ptrVal;
    const char * search = (const char *)params[1].ptrVal;
    const char * replacement = (const char *)params[0].ptrVal;
    result->intVal = FileTextReplace(fileName, search, replacement);
}

/**
 * Umka bindings for FileTextFindIndex().
 *
 * @see FileTextFindIndex()
 */
void umkaFileTextFindIndex(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * fileName = (const char *)params[1].ptrVal;
    const char * search = (const char *)params[0].ptrVal;
    result->intVal = FileTextFindIndex(fileName, search);
}
...
/**
 * Umka bindings for MakeDirectory().
 *
 * @see MakeDirectory()
 */
void umkaMakeDirectory(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * dirPath = (const char *)params[0].ptrVal;
    result->intVal = MakeDirectory(dirPath);
}
...
void umkaChangeDirectory(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * dirPath = (const char *)params[0].ptrVal;
    result->intVal = (int)ChangeDirectory(dirPath);
}
...
/**
 * Umka bindings for IsFileNameValid().
 *
 * @see IsFileNameValid()
 */
void umkaIsFileNameValid(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * fileName = (const char *)params[0].ptrVal;
    result->intVal = (int)IsFileNameValid(fileName);
}
...
/**
 * Umka bindings for GetDirectoryFileCount().
 *
 * @see GetDirectoryFileCount()
 */
void umkaGetDirectoryFileCount(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * dirPath = (const char *)params[0].ptrVal;
    result->uintVal = GetDirectoryFileCount(dirPath);
}

/**
 * Umka bindings for GetDirectoryFileCountEx().
 *
 * @see GetDirectoryFileCountEx()
 */
void umkaGetDirectoryFileCountEx(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    result->uintVal = GetDirectoryFileCountEx(basePath, filter, scanSubdirs);
}
...
void umkaDecodeDataBase64(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    int * outputSize = (int *)params[0].ptrVal;
    result->ptrVal = (void*)DecodeDataBase64(text, outputSize);
}

/**
 * Umka bindings for ComputeCRC32().
 *
 * @see ComputeCRC32()
 */
void umkaComputeCRC32(UmkaStackSlot *params, UmkaStackSlot *result) {
    unsigned char * data = (unsigned char *)params[1].ptrVal;
    int dataSize = params[0].intVal;
    result->uintVal = ComputeCRC32(data, dataSize);
}

/**
 * Umka bindings for ComputeMD5().
 *
 * @see ComputeMD5()
 */
void umkaComputeMD5(UmkaStackSlot *params, UmkaStackSlot *result) {
    unsigned char * data = (unsigned char *)params[1].ptrVal;
    int dataSize = params[0].intVal;
    result->ptrVal = (void*)ComputeMD5(data, dataSize);
}

/**
 * Umka bindings for ComputeSHA1().
 *
 * @see ComputeSHA1()
 */
void umkaComputeSHA1(UmkaStackSlot *params, UmkaStackSlot *result) {
    unsigned char * data = (unsigned char *)params[1].ptrVal;
    int dataSize = params[0].intVal;
    result->ptrVal = (void*)ComputeSHA1(data, dataSize);
}

/**
 * Umka bindings for ComputeSHA256().
 *
 * @see ComputeSHA256()
 */
void umkaComputeSHA256(UmkaStackSlot *params, UmkaStackSlot *result) {
    unsigned char * data = (unsigned char *)params[1].ptrVal;
    int dataSize = params[0].intVal;
    result->ptrVal = (void*)ComputeSHA256(data, dataSize);
}

/**
 * Umka bindings for LoadAutomationEventList().
 *
 * @see LoadAutomationEventList()
 */
void umkaLoadAutomationEventList(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    const char * fileName = (const char *)params[1].ptrVal;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(AutomationEventList), NULL);
    AutomationEventList out = LoadAutomationEventList(fileName);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(AutomationEventList));
}

/**
 * Umka bindings for UnloadAutomationEventList().
 *
 * @see UnloadAutomationEventList()
 */
void umkaUnloadAutomationEventList(UmkaStackSlot *params, UmkaStackSlot *result) {
    AutomationEventList* list = (AutomationEventList*)&params[0];
    UnloadAutomationEventList(*list);
}

/**
 * Umka bindings for ExportAutomationEventList().
 *
 * @see ExportAutomationEventList()
 */
void umkaExportAutomationEventList(UmkaStackSlot *params, UmkaStackSlot *result) {
    AutomationEventList* list = (AutomationEventList*)&params[1];
    const char * fileName = (const char *)params[0].ptrVal;
    result->intVal = (int)ExportAutomationEventList(*list, fileName);
}

/**
 * Umka bindings for SetAutomationEventList().
 *
 * @see SetAutomationEventList()
 */
void umkaSetAutomationEventList(UmkaStackSlot *params, UmkaStackSlot *result) {
    AutomationEventList * list = (AutomationEventList *)params[0].ptrVal;
    SetAutomationEventList(list);
}

/**
 * Umka bindings for SetAutomationEventBaseFrame().
 *
 * @see SetAutomationEventBaseFrame()
 */
void umkaSetAutomationEventBaseFrame(UmkaStackSlot *params, UmkaStackSlot *result) {
    int frame = params[0].intVal;
    SetAutomationEventBaseFrame(frame);
}

/**
 * Umka bindings for StartAutomationEventRecording().
 *
 * @see StartAutomationEventRecording()
 */
void umkaStartAutomationEventRecording(UmkaStackSlot *params, UmkaStackSlot *result) {
    StartAutomationEventRecording();
}

/**
 * Umka bindings for StopAutomationEventRecording().
 *
 * @see StopAutomationEventRecording()
 */
void umkaStopAutomationEventRecording(UmkaStackSlot *params, UmkaStackSlot *result) {
    StopAutomationEventRecording();
}

/**
 * Umka bindings for PlayAutomationEvent().
 *
 * @see PlayAutomationEvent()
 */
void umkaPlayAutomationEvent(UmkaStackSlot *params, UmkaStackSlot *result) {
    AutomationEvent* event = (AutomationEvent*)&params[0];
...
/**
 * Umka bindings for IsKeyPressedRepeat().
 *
 * @see IsKeyPressedRepeat()
 */
void umkaIsKeyPressedRepeat(UmkaStackSlot *params, UmkaStackSlot *result) {
    int key = params[0].intVal;
    result->intVal = (int)IsKeyPressedRepeat(key);
}
...
/**
 * Umka bindings for GetKeyName().
 *
 * @see GetKeyName()
 */
void umkaGetKeyName(UmkaStackSlot *params, UmkaStackSlot *result) {
    int key = params[0].intVal;
    result->ptrVal = (void*)GetKeyName(key);
}
...
/**
 * Umka bindings for SetGamepadVibration().
 *
 * @see SetGamepadVibration()
 */
void umkaSetGamepadVibration(UmkaStackSlot *params, UmkaStackSlot *result) {
    int gamepad = params[3].intVal;
    float leftMotor = params[2].real32Val;
    float rightMotor = params[1].real32Val;
    float duration = params[0].real32Val;
...
void umkaIsGestureDetected(UmkaStackSlot *params, UmkaStackSlot *result) {
    unsigned int gesture = params[0].uintVal;
...
/**
 * Umka bindings for GetShapesTexture().
 *
 * @see GetShapesTexture()
 */
void umkaGetShapesTexture(UmkaStackSlot *params, UmkaStackSlot *result) {
...
/**
 * Umka bindings for GetShapesTextureRectangle().
 *
 * @see GetShapesTextureRectangle()
 */
void umkaGetShapesTextureRectangle(UmkaStackSlot *params, UmkaStackSlot *result) {
...
void umkaDrawLineStrip(UmkaStackSlot *params, UmkaStackSlot *result) {
    const Vector2 * points = (const Vector2 *)params[2].ptrVal;
...
/**
 * Umka bindings for DrawLineDashed().
 *
 * @see DrawLineDashed()
 */
void umkaDrawLineDashed(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector2* startPos = (Vector2*)&params[4];
    Vector2* endPos = (Vector2*)&params[3];
    int dashSize = params[2].intVal;
    int spaceSize = params[1].intVal;
    Color* color = (Color*)&params[0];
...
/**
 * Umka bindings for DrawCircleLinesV().
 *
 * @see DrawCircleLinesV()
 */
void umkaDrawCircleLinesV(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector2* center = (Vector2*)&params[2];
    float radius = params[1].real32Val;
    Color* color = (Color*)&params[0];
...
/**
 * Umka bindings for DrawEllipseV().
 *
 * @see DrawEllipseV()
 */
void umkaDrawEllipseV(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector2* center = (Vector2*)&params[3];
    float radiusH = params[2].real32Val;
    float radiusV = params[1].real32Val;
    Color* color = (Color*)&params[0];
...
/**
 * Umka bindings for DrawEllipseLinesV().
 *
 * @see DrawEllipseLinesV()
 */
void umkaDrawEllipseLinesV(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector2* center = (Vector2*)&params[3];
    float radiusH = params[2].real32Val;
    float radiusV = params[1].real32Val;
    Color* color = (Color*)&params[0];
...
void umkaDrawRectangleGradientEx(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    Color* topLeft = (Color*)&params[3];
    Color* bottomLeft = (Color*)&params[2];
    Color* bottomRight = (Color*)&params[1];
    Color* topRight = (Color*)&params[0];
...
/**
 * Umka bindings for DrawRectangleRoundedLinesEx().
 *
 * @see DrawRectangleRoundedLinesEx()
 */
void umkaDrawRectangleRoundedLinesEx(UmkaStackSlot *params, UmkaStackSlot *result) {
    Rectangle* rec = (Rectangle*)&params[4];
...
/**
 * Umka bindings for DrawSplineLinear().
 *
 * @see DrawSplineLinear()
 */
void umkaDrawSplineLinear(UmkaStackSlot *params, UmkaStackSlot *result) {
    const Vector2 * points = (const Vector2 *)params[3].ptrVal;
    int pointCount = params[2].intVal;
    float thick = params[1].real32Val;
    Color* color = (Color*)&params[0];
...
/**
 * Umka bindings for DrawSplineBasis().
 *
 * @see DrawSplineBasis()
 */
void umkaDrawSplineBasis(UmkaStackSlot *params, UmkaStackSlot *result) {
    const Vector2 * points = (const Vector2 *)params[3].ptrVal;
    int pointCount = params[2].intVal;
    float thick = params[1].real32Val;
    Color* color = (Color*)&params[0];
...
/**
 * Umka bindings for DrawSplineCatmullRom().
 *
 * @see DrawSplineCatmullRom()
 */
void umkaDrawSplineCatmullRom(UmkaStackSlot *params, UmkaStackSlot *result) {
    const Vector2 * points = (const Vector2 *)params[3].ptrVal;
    int pointCount = params[2].intVal;
    float thick = params[1].real32Val;
    Color* color = (Color*)&params[0];
...
/**
 * Umka bindings for DrawSplineBezierQuadratic().
 *
 * @see DrawSplineBezierQuadratic()
 */
void umkaDrawSplineBezierQuadratic(UmkaStackSlot *params, UmkaStackSlot *result) {
    const Vector2 * points = (const Vector2 *)params[3].ptrVal;
    int pointCount = params[2].intVal;
    float thick = params[1].real32Val;
    Color* color = (Color*)&params[0];
...
/**
 * Umka bindings for DrawSplineBezierCubic().
 *
 * @see DrawSplineBezierCubic()
 */
void umkaDrawSplineBezierCubic(UmkaStackSlot *params, UmkaStackSlot *result) {
    const Vector2 * points = (const Vector2 *)params[3].ptrVal;
    int pointCount = params[2].intVal;
    float thick = params[1].real32Val;
    Color* color = (Color*)&params[0];
...
/**
 * Umka bindings for DrawSplineSegmentLinear().
 *
 * @see DrawSplineSegmentLinear()
 */
void umkaDrawSplineSegmentLinear(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector2* p1 = (Vector2*)&params[3];
    Vector2* p2 = (Vector2*)&params[2];
    float thick = params[1].real32Val;
    Color* color = (Color*)&params[0];
...
/**
 * Umka bindings for DrawSplineSegmentBasis().
 *
 * @see DrawSplineSegmentBasis()
 */
void umkaDrawSplineSegmentBasis(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector2* p1 = (Vector2*)&params[5];
    Vector2* p2 = (Vector2*)&params[4];
    Vector2* p3 = (Vector2*)&params[3];
    Vector2* p4 = (Vector2*)&params[2];
    float thick = params[1].real32Val;
    Color* color = (Color*)&params[0];
...
/**
 * Umka bindings for DrawSplineSegmentCatmullRom().
 *
 * @see DrawSplineSegmentCatmullRom()
 */
void umkaDrawSplineSegmentCatmullRom(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector2* p1 = (Vector2*)&params[5];
    Vector2* p2 = (Vector2*)&params[4];
    Vector2* p3 = (Vector2*)&params[3];
    Vector2* p4 = (Vector2*)&params[2];
...
/**
 * Umka bindings for DrawSplineSegmentBezierQuadratic().
 *
 * @see DrawSplineSegmentBezierQuadratic()
 */
void umkaDrawSplineSegmentBezierQuadratic(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector2* p1 = (Vector2*)&params[4];
    Vector2* c2 = (Vector2*)&params[3];
    Vector2* p3 = (Vector2*)&params[2];
    float thick = params[1].real32Val;
    Color* color = (Color*)&params[0];
...
/**
 * Umka bindings for DrawSplineSegmentBezierCubic().
 *
 * @see DrawSplineSegmentBezierCubic()
 */
void umkaDrawSplineSegmentBezierCubic(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector2* p1 = (Vector2*)&params[5];
    Vector2* c2 = (Vector2*)&params[4];
    Vector2* c3 = (Vector2*)&params[3];
    Vector2* p4 = (Vector2*)&params[2];
    float thick = params[1].real32Val;
    Color* color = (Color*)&params[0];
...
/**
 * Umka bindings for GetSplinePointLinear().
 *
 * @see GetSplinePointLinear()
 */
void umkaGetSplinePointLinear(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector2* startPos = (Vector2*)&params[3];
    Vector2* endPos = (Vector2*)&params[2];
    float t = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector2), NULL);
    Vector2 out = GetSplinePointLinear(*startPos, *endPos, t);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector2));
}

/**
 * Umka bindings for GetSplinePointBasis().
 *
 * @see GetSplinePointBasis()
 */
void umkaGetSplinePointBasis(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector2* p1 = (Vector2*)&params[5];
    Vector2* p2 = (Vector2*)&params[4];
    Vector2* p3 = (Vector2*)&params[3];
    ...
    float t = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector2), NULL);
    Vector2 out = GetSplinePointBasis(*p1, *p2, *p3, *p4, t);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector2));
}

/**
 * Umka bindings for GetSplinePointCatmullRom().
 *
 * @see GetSplinePointCatmullRom()
 */
void umkaGetSplinePointCatmullRom(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector2* p1 = (Vector2*)&params[5];
    Vector2* p2 = (Vector2*)&params[4];
    Vector2* p3 = (Vector2*)&params[3];
    ...
    float t = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector2), NULL);
    Vector2 out = GetSplinePointCatmullRom(*p1, *p2, *p3, *p4, t);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector2));
}

/**
 * Umka bindings for GetSplinePointBezierQuad().
 *
 * @see GetSplinePointBezierQuad()
 */
void umkaGetSplinePointBezierQuad(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector2* p1 = (Vector2*)&params[4];
    Vector2* c2 = (Vector2*)&params[3];
    Vector2* p3 = (Vector2*)&params[2];
    float t = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector2), NULL);
    Vector2 out = GetSplinePointBezierQuad(*p1, *c2, *p3, t);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector2));
}

/**
 * Umka bindings for GetSplinePointBezierCubic().
 *
 * @see GetSplinePointBezierCubic()
 */
void umkaGetSplinePointBezierCubic(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector2* p1 = (Vector2*)&params[5];
    Vector2* c2 = (Vector2*)&params[4];
    Vector2* c3 = (Vector2*)&params[3];
    ...
    float t = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector2), NULL);
    Vector2 out = GetSplinePointBezierCubic(*p1, *c2, *c3, *p4, t);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector2));
}
...
/**
 * Umka bindings for CheckCollisionCircleLine().
 *
 * @see CheckCollisionCircleLine()
 */
void umkaCheckCollisionCircleLine(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector2* center = (Vector2*)&params[3];
    float radius = params[2].real32Val;
    Vector2* p1 = (Vector2*)&params[1];
    Vector2* p2 = (Vector2*)&params[0];
    result->intVal = (int)CheckCollisionCircleLine(*center, radius, *p1, *p2);
}
...
void umkaCheckCollisionPointPoly(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector2* point = (Vector2*)&params[2];
    const Vector2 * points = (const Vector2 *)params[1].ptrVal;
...
/**
 * Umka bindings for LoadImageAnimFromMemory().
 *
 * @see LoadImageAnimFromMemory()
 */
void umkaLoadImageAnimFromMemory(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    const char * fileType = (const char *)params[4].ptrVal;
    const unsigned char * fileData = (const unsigned char *)params[3].ptrVal;
    int dataSize = params[2].intVal;
    int * frames = (int *)params[1].ptrVal;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Image), NULL);
    Image out = LoadImageAnimFromMemory(fileType, fileData, dataSize, frames);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Image));
}
...
/**
 * Umka bindings for IsImageValid().
 *
 * @see IsImageValid()
 */
void umkaIsImageValid(UmkaStackSlot *params, UmkaStackSlot *result) {
    Image* image = (Image*)&params[0];
    result->intVal = (int)IsImageValid(*image);
}
...
/**
 * Umka bindings for ExportImageToMemory().
 *
 * @see ExportImageToMemory()
 */
void umkaExportImageToMemory(UmkaStackSlot *params, UmkaStackSlot *result) {
    Image* image = (Image*)&params[2];
    const char * fileType = (const char *)params[1].ptrVal;
    int * fileSize = (int *)params[0].ptrVal;
    result->ptrVal = (void*)ExportImageToMemory(*image, fileType, fileSize);
}
...
/**
 * Umka bindings for GenImageGradientLinear().
 *
 * @see GenImageGradientLinear()
 */
void umkaGenImageGradientLinear(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    int width = params[5].intVal;
    int height = params[4].intVal;
    int direction = params[3].intVal;
    Color* start = (Color*)&params[2];
    Color* end = (Color*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Image), NULL);
...
/**
 * Umka bindings for GenImageGradientSquare().
 *
 * @see GenImageGradientSquare()
 */
void umkaGenImageGradientSquare(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    int width = params[5].intVal;
    int height = params[4].intVal;
    float density = params[3].real32Val;
...
/**
 * Umka bindings for ImageFromChannel().
 *
 * @see ImageFromChannel()
 */
void umkaImageFromChannel(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Image* image = (Image*)&params[2];
    int selectedChannel = params[1].intVal;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Image), NULL);
    Image out = ImageFromChannel(*image, selectedChannel);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Image));
}
...
/**
 * Umka bindings for ImageKernelConvolution().
 *
 * @see ImageKernelConvolution()
 */
void umkaImageKernelConvolution(UmkaStackSlot *params, UmkaStackSlot *result) {
    Image * image = (Image *)params[2].ptrVal;
    const float * kernel = (const float *)params[1].ptrVal;
    int kernelSize = params[0].intVal;
...
/**
 * Umka bindings for ImageRotate().
 *
 * @see ImageRotate()
 */
void umkaImageRotate(UmkaStackSlot *params, UmkaStackSlot *result) {
    Image * image = (Image *)params[1].ptrVal;
    int degrees = params[0].intVal;
...
/**
 * Umka bindings for ImageDrawLineEx().
 *
 * @see ImageDrawLineEx()
 */
void umkaImageDrawLineEx(UmkaStackSlot *params, UmkaStackSlot *result) {
    Image * dst = (Image *)params[4].ptrVal;
    Vector2* start = (Vector2*)&params[3];
    Vector2* end = (Vector2*)&params[2];
...
/**
 * Umka bindings for ImageDrawTriangle().
 *
 * @see ImageDrawTriangle()
 */
void umkaImageDrawTriangle(UmkaStackSlot *params, UmkaStackSlot *result) {
    Image * dst = (Image *)params[4].ptrVal;
    Vector2* v1 = (Vector2*)&params[3];
    Vector2* v2 = (Vector2*)&params[2];
    Vector2* v3 = (Vector2*)&params[1];
...
/**
 * Umka bindings for ImageDrawTriangleEx().
 *
 * @see ImageDrawTriangleEx()
 */
void umkaImageDrawTriangleEx(UmkaStackSlot *params, UmkaStackSlot *result) {
    Image * dst = (Image *)params[6].ptrVal;
    Vector2* v1 = (Vector2*)&params[5];
    Vector2* v2 = (Vector2*)&params[4];
    Vector2* v3 = (Vector2*)&params[3];
    Color* c1 = (Color*)&params[2];
    Color* c2 = (Color*)&params[1];
    Color* c3 = (Color*)&params[0];
    ImageDrawTriangleEx(dst, *v1, *v2, *v3, *c1, *c2, *c3);
}

/**
 * Umka bindings for ImageDrawTriangleLines().
 *
 * @see ImageDrawTriangleLines()
 */
void umkaImageDrawTriangleLines(UmkaStackSlot *params, UmkaStackSlot *result) {
    Image * dst = (Image *)params[4].ptrVal;
    Vector2* v1 = (Vector2*)&params[3];
    Vector2* v2 = (Vector2*)&params[2];
    Vector2* v3 = (Vector2*)&params[1];
...
/**
 * Umka bindings for ImageDrawTriangleFan().
 *
 * @see ImageDrawTriangleFan()
 */
void umkaImageDrawTriangleFan(UmkaStackSlot *params, UmkaStackSlot *result) {
    Image * dst = (Image *)params[3].ptrVal;
    const Vector2 * points = (const Vector2 *)params[2].ptrVal;
    int pointCount = params[1].intVal;
    Color* color = (Color*)&params[0];
...
/**
 * Umka bindings for ImageDrawTriangleStrip().
 *
 * @see ImageDrawTriangleStrip()
 */
void umkaImageDrawTriangleStrip(UmkaStackSlot *params, UmkaStackSlot *result) {
    Image * dst = (Image *)params[3].ptrVal;
    const Vector2 * points = (const Vector2 *)params[2].ptrVal;
    int pointCount = params[1].intVal;
    Color* color = (Color*)&params[0];
...
/**
 * Umka bindings for IsTextureValid().
 *
 * @see IsTextureValid()
 */
void umkaIsTextureValid(UmkaStackSlot *params, UmkaStackSlot *result) {
    Texture2D* texture = (Texture2D*)&params[0];
    result->intVal = (int)IsTextureValid(*texture);
}
...
/**
 * Umka bindings for IsRenderTextureValid().
 *
 * @see IsRenderTextureValid()
 */
void umkaIsRenderTextureValid(UmkaStackSlot *params, UmkaStackSlot *result) {
    RenderTexture2D* target = (RenderTexture2D*)&params[0];
    result->intVal = (int)IsRenderTextureValid(*target);
}
...
/**
 * Umka bindings for ColorIsEqual().
 *
 * @see ColorIsEqual()
 */
void umkaColorIsEqual(UmkaStackSlot *params, UmkaStackSlot *result) {
    Color* col1 = (Color*)&params[1];
    Color* col2 = (Color*)&params[0];
    result->intVal = (int)ColorIsEqual(*col1, *col2);
}
...
/**
 * Umka bindings for ColorLerp().
 *
 * @see ColorLerp()
 */
void umkaColorLerp(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Color* color1 = (Color*)&params[3];
    Color* color2 = (Color*)&params[2];
    float factor = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Color), NULL);
    Color out = ColorLerp(*color1, *color2, factor);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Color));
}
...
void umkaLoadFontEx(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    const int * codepoints = (const int *)params[2].ptrVal;
    int codepointCount = params[1].intVal;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Font), NULL);
    Font out = LoadFontEx(fileName, fontSize, codepoints, codepointCount);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Font));
}
...
void umkaLoadFontFromMemory(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    int codepointCount = params[1].intVal;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Font), NULL);
    Font out = LoadFontFromMemory(fileType, fileData, dataSize, fontSize, codepoints, codepointCount);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Font));
}

/**
 * Umka bindings for IsFontValid().
 *
 * @see IsFontValid()
 */
void umkaIsFontValid(UmkaStackSlot *params, UmkaStackSlot *result) {
    Font* font = (Font*)&params[0];
    result->intVal = (int)IsFontValid(*font);
}
...
void umkaGenImageFontAtlas(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    const GlyphInfo * glyphs = (const GlyphInfo *)params[6].ptrVal;
    Rectangle ** glyphRecs = (Rectangle **)params[5].ptrVal;
    int glyphCount = params[4].intVal;
    int fontSize = params[3].intVal;
    int padding = params[2].intVal;
    int packMethod = params[1].intVal;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Image), NULL);
    Image out = GenImageFontAtlas(glyphs, glyphRecs, glyphCount, fontSize, padding, packMethod);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Image));
}
...
void umkaUnloadFontData(UmkaStackSlot *params, UmkaStackSlot *result) {
    GlyphInfo * glyphs = (GlyphInfo *)params[1].ptrVal;
...
void umkaDrawTextCodepoints(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    int codepointCount = params[4].intVal;
    Vector2* position = (Vector2*)&params[3];
    float fontSize = params[2].real32Val;
    float spacing = params[1].real32Val;
    Color* tint = (Color*)&params[0];
...
/**
 * Umka bindings for SetTextLineSpacing().
 *
 * @see SetTextLineSpacing()
 */
void umkaSetTextLineSpacing(UmkaStackSlot *params, UmkaStackSlot *result) {
    int spacing = params[0].intVal;
...
/**
 * Umka bindings for MeasureTextCodepoints().
 *
 * @see MeasureTextCodepoints()
 */
void umkaMeasureTextCodepoints(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Font* font = (Font*)&params[5];
    const int * codepoints = (const int *)params[4].ptrVal;
    int length = params[3].intVal;
    float fontSize = params[2].real32Val;
    float spacing = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector2), NULL);
    Vector2 out = MeasureTextCodepoints(*font, codepoints, length, fontSize, spacing);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector2));
}
...
/**
 * Umka bindings for LoadTextLines().
 *
 * @see LoadTextLines()
 */
void umkaLoadTextLines(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * text = (const char *)params[1].ptrVal;
    int * count = (int *)params[0].ptrVal;
    result->ptrVal = (void*)LoadTextLines(text, count);
}

/**
 * Umka bindings for UnloadTextLines().
 *
 * @see UnloadTextLines()
 */
void umkaUnloadTextLines(UmkaStackSlot *params, UmkaStackSlot *result) {
    char ** text = (char **)params[1].ptrVal;
    int lineCount = params[0].intVal;
...
/**
 * Umka bindings for TextRemoveSpaces().
 *
 * @see TextRemoveSpaces()
 */
void umkaTextRemoveSpaces(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * text = (const char *)params[0].ptrVal;
    result->ptrVal = (void*)TextRemoveSpaces(text);
}

/**
 * Umka bindings for GetTextBetween().
 *
 * @see GetTextBetween()
 */
void umkaGetTextBetween(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * text = (const char *)params[2].ptrVal;
    const char * begin = (const char *)params[1].ptrVal;
    const char * end = (const char *)params[0].ptrVal;
    result->ptrVal = (void*)GetTextBetween(text, begin, end);
}
...
void umkaTextReplace(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    const char * search = (const char *)params[1].ptrVal;
    const char * replacement = (const char *)params[0].ptrVal;
    result->ptrVal = (void*)TextReplace(text, search, replacement);
}

/**
 * Umka bindings for TextReplaceBetween().
 *
 * @see TextReplaceBetween()
 */
void umkaTextReplaceBetween(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * text = (const char *)params[3].ptrVal;
    const char * begin = (const char *)params[2].ptrVal;
    const char * end = (const char *)params[1].ptrVal;
    const char * replacement = (const char *)params[0].ptrVal;
    result->ptrVal = (void*)TextReplaceBetween(text, begin, end, replacement);
}
...
void umkaTextJoin(UmkaStackSlot *params, UmkaStackSlot *result) {
    char ** textList = (char **)params[2].ptrVal;
...
void umkaTextFindIndex(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * text = (const char *)params[1].ptrVal;
    const char * search = (const char *)params[0].ptrVal;
    result->intVal = TextFindIndex(text, search);
}
...
/**
 * Umka bindings for TextToSnake().
 *
 * @see TextToSnake()
 */
void umkaTextToSnake(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * text = (const char *)params[0].ptrVal;
    result->ptrVal = (void*)TextToSnake(text);
}

/**
 * Umka bindings for TextToCamel().
 *
 * @see TextToCamel()
 */
void umkaTextToCamel(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * text = (const char *)params[0].ptrVal;
    result->ptrVal = (void*)TextToCamel(text);
}
...
/**
 * Umka bindings for TextToFloat().
 *
 * @see TextToFloat()
 */
void umkaTextToFloat(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * text = (const char *)params[0].ptrVal;
    result->realVal = TextToFloat(text);
}
...
void umkaDrawTriangleStrip3D(UmkaStackSlot *params, UmkaStackSlot *result) {
    const Vector3 * points = (const Vector3 *)params[2].ptrVal;
    int pointCount = params[1].intVal;
    Color* color = (Color*)&params[0];
...
/**
 * Umka bindings for IsModelValid().
 *
 * @see IsModelValid()
 */
void umkaIsModelValid(UmkaStackSlot *params, UmkaStackSlot *result) {
    Model* model = (Model*)&params[0];
    result->intVal = (int)IsModelValid(*model);
}
...
/**
 * Umka bindings for DrawModelPoints().
 *
 * @see DrawModelPoints()
 */
void umkaDrawModelPoints(UmkaStackSlot *params, UmkaStackSlot *result) {
    Model* model = (Model*)&params[3];
    Vector3* position = (Vector3*)&params[2];
    float scale = params[1].real32Val;
    Color* tint = (Color*)&params[0];
...
/**
 * Umka bindings for DrawModelPointsEx().
 *
 * @see DrawModelPointsEx()
 */
void umkaDrawModelPointsEx(UmkaStackSlot *params, UmkaStackSlot *result) {
    Model* model = (Model*)&params[5];
    Vector3* position = (Vector3*)&params[4];
    Vector3* rotationAxis = (Vector3*)&params[3];
    float rotationAngle = params[2].real32Val;
...
/**
 * Umka bindings for ExportMeshAsCode().
 *
 * @see ExportMeshAsCode()
 */
void umkaExportMeshAsCode(UmkaStackSlot *params, UmkaStackSlot *result) {
    Mesh* mesh = (Mesh*)&params[1];
    const char * fileName = (const char *)params[0].ptrVal;
    result->intVal = (int)ExportMeshAsCode(*mesh, fileName);
}
...
/**
 * Umka bindings for IsMaterialValid().
 *
 * @see IsMaterialValid()
 */
void umkaIsMaterialValid(UmkaStackSlot *params, UmkaStackSlot *result) {
    Material* material = (Material*)&params[0];
    result->intVal = (int)IsMaterialValid(*material);
}
...
void umkaLoadModelAnimations(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * fileName = (const char *)params[1].ptrVal;
    int * animCount = (int *)params[0].ptrVal;
...
void umkaUpdateModelAnimation(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    float frame = params[0].real32Val;
    UpdateModelAnimation(*model, *anim, frame);
}

/**
 * Umka bindings for UpdateModelAnimationEx().
 *
 * @see UpdateModelAnimationEx()
 */
void umkaUpdateModelAnimationEx(UmkaStackSlot *params, UmkaStackSlot *result) {
    Model* model = (Model*)&params[5];
    ModelAnimation* animA = (ModelAnimation*)&params[4];
    float frameA = params[3].real32Val;
    ModelAnimation* animB = (ModelAnimation*)&params[2];
    float frameB = params[1].real32Val;
    float blend = params[0].real32Val;
...
/**
 * Umka bindings for GetMasterVolume().
 *
 * @see GetMasterVolume()
 */
void umkaGetMasterVolume(UmkaStackSlot *params, UmkaStackSlot *result) {
    result->realVal = GetMasterVolume();
}
...
/**
 * Umka bindings for IsWaveValid().
 *
 * @see IsWaveValid()
 */
void umkaIsWaveValid(UmkaStackSlot *params, UmkaStackSlot *result) {
    Wave* wave = (Wave*)&params[0];
    result->intVal = (int)IsWaveValid(*wave);
}
...
/**
 * Umka bindings for LoadSoundAlias().
 *
 * @see LoadSoundAlias()
 */
void umkaLoadSoundAlias(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Sound* source = (Sound*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Sound), NULL);
...
/**
 * Umka bindings for IsSoundValid().
 *
 * @see IsSoundValid()
 */
void umkaIsSoundValid(UmkaStackSlot *params, UmkaStackSlot *result) {
    Sound* sound = (Sound*)&params[0];
    result->intVal = (int)IsSoundValid(*sound);
}
...
/**
 * Umka bindings for UnloadSoundAlias().
 *
 * @see UnloadSoundAlias()
 */
void umkaUnloadSoundAlias(UmkaStackSlot *params, UmkaStackSlot *result) {
    Sound* alias = (Sound*)&params[0];
...
void umkaWaveCrop(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    int initFrame = params[1].intVal;
    int finalFrame = params[0].intVal;
...
/**
 * Umka bindings for IsMusicValid().
 *
 * @see IsMusicValid()
 */
void umkaIsMusicValid(UmkaStackSlot *params, UmkaStackSlot *result) {
    Music* music = (Music*)&params[0];
    result->intVal = (int)IsMusicValid(*music);
}
...
/**
 * Umka bindings for IsAudioStreamValid().
 *
 * @see IsAudioStreamValid()
 */
void umkaIsAudioStreamValid(UmkaStackSlot *params, UmkaStackSlot *result) {
    AudioStream* stream = (AudioStream*)&params[0];
    result->intVal = (int)IsAudioStreamValid(*stream);
}
...
/**
 * Umka bindings for Vector2CrossProduct().
 *
 * @see Vector2CrossProduct()
 */
void umkaVector2CrossProduct(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector2* v1 = (Vector2*)&params[1];
    Vector2* v2 = (Vector2*)&params[0];
    result->realVal = Vector2CrossProduct(*v1, *v2);
}
...
/**
 * Umka bindings for Vector2Min().
 *
 * @see Vector2Min()
 */
void umkaVector2Min(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector2* v1 = (Vector2*)&params[2];
    Vector2* v2 = (Vector2*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector2), NULL);
    Vector2 out = Vector2Min(*v1, *v2);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector2));
}

/**
 * Umka bindings for Vector2Max().
 *
 * @see Vector2Max()
 */
void umkaVector2Max(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector2* v1 = (Vector2*)&params[2];
    Vector2* v2 = (Vector2*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector2), NULL);
    Vector2 out = Vector2Max(*v1, *v2);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector2));
}
...
/**
 * Umka bindings for Vector2Refract().
 *
 * @see Vector2Refract()
 */
void umkaVector2Refract(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector2* v = (Vector2*)&params[3];
    Vector2* n = (Vector2*)&params[2];
    float r = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector2), NULL);
    Vector2 out = Vector2Refract(*v, *n, r);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector2));
}
...
/**
 * Umka bindings for Vector3Project().
 *
 * @see Vector3Project()
 */
void umkaVector3Project(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector3* v1 = (Vector3*)&params[2];
    Vector3* v2 = (Vector3*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector3), NULL);
    Vector3 out = Vector3Project(*v1, *v2);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector3));
}

/**
 * Umka bindings for Vector3Reject().
 *
 * @see Vector3Reject()
 */
void umkaVector3Reject(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector3* v1 = (Vector3*)&params[2];
    Vector3* v2 = (Vector3*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector3), NULL);
    Vector3 out = Vector3Reject(*v1, *v2);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector3));
}
...
/**
 * Umka bindings for Vector3MoveTowards().
 *
 * @see Vector3MoveTowards()
 */
void umkaVector3MoveTowards(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector3* v = (Vector3*)&params[3];
    Vector3* target = (Vector3*)&params[2];
    float maxDistance = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector3), NULL);
    Vector3 out = Vector3MoveTowards(*v, *target, maxDistance);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector3));
}
...
/**
 * Umka bindings for Vector3CubicHermite().
 *
 * @see Vector3CubicHermite()
 */
void umkaVector3CubicHermite(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector3* v1 = (Vector3*)&params[5];
    Vector3* tangent1 = (Vector3*)&params[4];
    Vector3* v2 = (Vector3*)&params[3];
    Vector3* tangent2 = (Vector3*)&params[2];
    float amount = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector3), NULL);
    Vector3 out = Vector3CubicHermite(*v1, *tangent1, *v2, *tangent2, amount);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector3));
}
...
/**
 * Umka bindings for Vector4Zero().
 *
 * @see Vector4Zero()
 */
void umkaVector4Zero(UmkaStackSlot *params, UmkaStackSlot *result) {
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4Zero();
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4One().
 *
 * @see Vector4One()
 */
void umkaVector4One(UmkaStackSlot *params, UmkaStackSlot *result) {
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4One();
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4Add().
 *
 * @see Vector4Add()
 */
void umkaVector4Add(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector4* v1 = (Vector4*)&params[2];
    Vector4* v2 = (Vector4*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4Add(*v1, *v2);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4AddValue().
 *
 * @see Vector4AddValue()
 */
void umkaVector4AddValue(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector4* v = (Vector4*)&params[2];
    float add = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4AddValue(*v, add);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4Subtract().
 *
 * @see Vector4Subtract()
 */
void umkaVector4Subtract(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector4* v1 = (Vector4*)&params[2];
    Vector4* v2 = (Vector4*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4Subtract(*v1, *v2);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4SubtractValue().
 *
 * @see Vector4SubtractValue()
 */
void umkaVector4SubtractValue(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector4* v = (Vector4*)&params[2];
    float add = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4SubtractValue(*v, add);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4Length().
 *
 * @see Vector4Length()
 */
void umkaVector4Length(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector4* v = (Vector4*)&params[0];
    result->realVal = Vector4Length(*v);
}

/**
 * Umka bindings for Vector4LengthSqr().
 *
 * @see Vector4LengthSqr()
 */
void umkaVector4LengthSqr(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector4* v = (Vector4*)&params[0];
    result->realVal = Vector4LengthSqr(*v);
}

/**
 * Umka bindings for Vector4DotProduct().
 *
 * @see Vector4DotProduct()
 */
void umkaVector4DotProduct(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector4* v1 = (Vector4*)&params[1];
    Vector4* v2 = (Vector4*)&params[0];
    result->realVal = Vector4DotProduct(*v1, *v2);
}

/**
 * Umka bindings for Vector4Distance().
 *
 * @see Vector4Distance()
 */
void umkaVector4Distance(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector4* v1 = (Vector4*)&params[1];
    Vector4* v2 = (Vector4*)&params[0];
    result->realVal = Vector4Distance(*v1, *v2);
}

/**
 * Umka bindings for Vector4DistanceSqr().
 *
 * @see Vector4DistanceSqr()
 */
void umkaVector4DistanceSqr(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector4* v1 = (Vector4*)&params[1];
    Vector4* v2 = (Vector4*)&params[0];
    result->realVal = Vector4DistanceSqr(*v1, *v2);
}

/**
 * Umka bindings for Vector4Scale().
 *
 * @see Vector4Scale()
 */
void umkaVector4Scale(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector4* v = (Vector4*)&params[2];
    float scale = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4Scale(*v, scale);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4Multiply().
 *
 * @see Vector4Multiply()
 */
void umkaVector4Multiply(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector4* v1 = (Vector4*)&params[2];
    Vector4* v2 = (Vector4*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4Multiply(*v1, *v2);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4Negate().
 *
 * @see Vector4Negate()
 */
void umkaVector4Negate(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector4* v = (Vector4*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4Negate(*v);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4Divide().
 *
 * @see Vector4Divide()
 */
void umkaVector4Divide(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector4* v1 = (Vector4*)&params[2];
    Vector4* v2 = (Vector4*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4Divide(*v1, *v2);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4Normalize().
 *
 * @see Vector4Normalize()
 */
void umkaVector4Normalize(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector4* v = (Vector4*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4Normalize(*v);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4Min().
 *
 * @see Vector4Min()
 */
void umkaVector4Min(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector4* v1 = (Vector4*)&params[2];
    Vector4* v2 = (Vector4*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4Min(*v1, *v2);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4Max().
 *
 * @see Vector4Max()
 */
void umkaVector4Max(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector4* v1 = (Vector4*)&params[2];
    Vector4* v2 = (Vector4*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4Max(*v1, *v2);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4Lerp().
 *
 * @see Vector4Lerp()
 */
void umkaVector4Lerp(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector4* v1 = (Vector4*)&params[3];
    Vector4* v2 = (Vector4*)&params[2];
    float amount = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4Lerp(*v1, *v2, amount);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4MoveTowards().
 *
 * @see Vector4MoveTowards()
 */
void umkaVector4MoveTowards(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector4* v = (Vector4*)&params[3];
    Vector4* target = (Vector4*)&params[2];
    float maxDistance = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4MoveTowards(*v, *target, maxDistance);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4Invert().
 *
 * @see Vector4Invert()
 */
void umkaVector4Invert(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector4* v = (Vector4*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Vector4), NULL);
    Vector4 out = Vector4Invert(*v);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Vector4));
}

/**
 * Umka bindings for Vector4Equals().
 *
 * @see Vector4Equals()
 */
void umkaVector4Equals(UmkaStackSlot *params, UmkaStackSlot *result) {
    Vector4* p = (Vector4*)&params[1];
    Vector4* q = (Vector4*)&params[0];
    result->intVal = Vector4Equals(*p, *q);
}
...
/**
 * Umka bindings for MatrixMultiplyValue().
 *
 * @see MatrixMultiplyValue()
 */
void umkaMatrixMultiplyValue(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Matrix* left = (Matrix*)&params[2];
    float value = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Matrix), NULL);
    Matrix out = MatrixMultiplyValue(*left, value);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Matrix));
}
...
void umkaMatrixFrustum(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    double nearPlane = params[2].realVal;
    double farPlane = params[1].realVal;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Matrix), NULL);
    Matrix out = MatrixFrustum(left, right, bottom, top, nearPlane, farPlane);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Matrix));
}
...
void umkaMatrixPerspective(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    double farPlane = params[1].realVal;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Matrix), NULL);
    Matrix out = MatrixPerspective(fovY, aspect, nearPlane, farPlane);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Matrix));
}
...
void umkaMatrixOrtho(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    double farPlane = params[1].realVal;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Matrix), NULL);
    Matrix out = MatrixOrtho(left, right, bottom, top, nearPlane, farPlane);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Matrix));
}
...
/**
 * Umka bindings for QuaternionCubicHermiteSpline().
 *
 * @see QuaternionCubicHermiteSpline()
 */
void umkaQuaternionCubicHermiteSpline(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Quaternion* q1 = (Quaternion*)&params[5];
    Quaternion* outTangent1 = (Quaternion*)&params[4];
    Quaternion* q2 = (Quaternion*)&params[3];
    Quaternion* inTangent2 = (Quaternion*)&params[2];
    float t = params[1].real32Val;
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Quaternion), NULL);
    Quaternion out = QuaternionCubicHermiteSpline(*q1, *outTangent1, *q2, *inTangent2, t);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Quaternion));
}
...
/**
 * Umka bindings for MatrixCompose().
 *
 * @see MatrixCompose()
 */
void umkaMatrixCompose(UmkaStackSlot *params, UmkaStackSlot *result) {
    // Skipping params[0], as it's a reference to Umka's internal filename
    Vector3* translation = (Vector3*)&params[3];
    Quaternion* rotation = (Quaternion*)&params[2];
    Vector3* scale = (Vector3*)&params[1];
    result->ptrVal = umkaAllocData(result->ptrVal, sizeof(Matrix), NULL);
    Matrix out = MatrixCompose(*translation, *rotation, *scale);
    RAYLIB_UMKA_MEMCPY(result->ptrVal, &out, sizeof(Matrix));
}

/**
 * Umka bindings for MatrixDecompose().
 *
 * @see MatrixDecompose()
 */
void umkaMatrixDecompose(UmkaStackSlot *params, UmkaStackSlot *result) {
    Matrix* mat = (Matrix*)&params[3];
    Vector3 * translation = (Vector3 *)params[2].ptrVal;
    Quaternion * rotation = (Quaternion *)params[1].ptrVal;
    Vector3 * scale = (Vector3 *)params[0].ptrVal;
...
/**
 * Umka bindings for rlSetClipPlanes().
 *
 * @see rlSetClipPlanes()
 */
void umkarlSetClipPlanes(UmkaStackSlot *params, UmkaStackSlot *result) {
    double nearPlane = params[1].realVal;
    double farPlane = params[0].realVal;
    rlSetClipPlanes(nearPlane, farPlane);
}

/**
 * Umka bindings for rlGetCullDistanceNear().
 *
 * @see rlGetCullDistanceNear()
 */
void umkarlGetCullDistanceNear(UmkaStackSlot *params, UmkaStackSlot *result) {
    result->realVal = rlGetCullDistanceNear();
}

/**
 * Umka bindings for rlGetCullDistanceFar().
 *
 * @see rlGetCullDistanceFar()
 */
void umkarlGetCullDistanceFar(UmkaStackSlot *params, UmkaStackSlot *result) {
    result->realVal = rlGetCullDistanceFar();
}
...
/**
 * Umka bindings for rlGetActiveFramebuffer().
 *
 * @see rlGetActiveFramebuffer()
 */
void umkarlGetActiveFramebuffer(UmkaStackSlot *params, UmkaStackSlot *result) {
    result->uintVal = rlGetActiveFramebuffer();
}
...
/**
 * Umka bindings for rlBlitFramebuffer().
 *
 * @see rlBlitFramebuffer()
 */
void umkarlBlitFramebuffer(UmkaStackSlot *params, UmkaStackSlot *result) {
    int srcX = params[8].intVal;
    int srcY = params[7].intVal;
    int srcWidth = params[6].intVal;
    int srcHeight = params[5].intVal;
    int dstX = params[4].intVal;
    int dstY = params[3].intVal;
    int dstWidth = params[2].intVal;
    int dstHeight = params[1].intVal;
    int bufferMask = params[0].intVal;
    rlBlitFramebuffer(srcX, srcY, srcWidth, srcHeight, dstX, dstY, dstWidth, dstHeight, bufferMask);
}

/**
 * Umka bindings for rlBindFramebuffer().
 *
 * @see rlBindFramebuffer()
 */
void umkarlBindFramebuffer(UmkaStackSlot *params, UmkaStackSlot *result) {
    unsigned int target = params[1].uintVal;
    unsigned int framebuffer = params[0].uintVal;
...
/**
 * Umka bindings for rlColorMask().
 *
 * @see rlColorMask()
 */
void umkarlColorMask(UmkaStackSlot *params, UmkaStackSlot *result) {
    bool r = (bool)params[3].intVal;
    bool g = (bool)params[2].intVal;
    bool b = (bool)params[1].intVal;
    bool a = (bool)params[0].intVal;
    rlColorMask(r, g, b, a);
}
...
/**
 * Umka bindings for rlEnablePointMode().
 *
 * @see rlEnablePointMode()
 */
void umkarlEnablePointMode(UmkaStackSlot *params, UmkaStackSlot *result) {
    rlEnablePointMode();
}

/**
 * Umka bindings for rlDisablePointMode().
 *
 * @see rlDisablePointMode()
 */
void umkarlDisablePointMode(UmkaStackSlot *params, UmkaStackSlot *result) {
    rlDisablePointMode();
}

/**
 * Umka bindings for rlSetPointSize().
 *
 * @see rlSetPointSize()
 */
void umkarlSetPointSize(UmkaStackSlot *params, UmkaStackSlot *result) {
    float size = params[0].real32Val;
    rlSetPointSize(size);
}

/**
 * Umka bindings for rlGetPointSize().
 *
 * @see rlGetPointSize()
 */
void umkarlGetPointSize(UmkaStackSlot *params, UmkaStackSlot *result) {
    result->realVal = rlGetPointSize();
}
...
/**
 * Umka bindings for rlGetProcAddress().
 *
 * @see rlGetProcAddress()
 */
void umkarlGetProcAddress(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * procName = (const char *)params[0].ptrVal;
    result->ptrVal = (void*)rlGetProcAddress(procName);
}
...
void umkarlLoadTextureCubemap(UmkaStackSlot *params, UmkaStackSlot *result) {
    const void * data = (const void *)params[3].ptrVal;
    int size = params[2].intVal;
    int format = params[1].intVal;
    int mipmapCount = params[0].intVal;
    result->uintVal = rlLoadTextureCubemap(data, size, format, mipmapCount);
}
...
void umkarlLoadFramebuffer(UmkaStackSlot *params, UmkaStackSlot *result) {
    result->uintVal = rlLoadFramebuffer();
}
...
/**
 * Umka bindings for rlCopyFramebuffer().
 *
 * @see rlCopyFramebuffer()
 */
void umkarlCopyFramebuffer(UmkaStackSlot *params, UmkaStackSlot *result) {
    int x = params[5].intVal;
    int y = params[4].intVal;
    int width = params[3].intVal;
    int height = params[2].intVal;
    int format = params[1].intVal;
    void * pixels = (void *)params[0].ptrVal;
    rlCopyFramebuffer(x, y, width, height, format, pixels);
}

/**
 * Umka bindings for rlResizeFramebuffer().
 *
 * @see rlResizeFramebuffer()
 */
void umkarlResizeFramebuffer(UmkaStackSlot *params, UmkaStackSlot *result) {
    int width = params[1].intVal;
    int height = params[0].intVal;
...
/**
 * Umka bindings for rlLoadShader().
 *
 * @see rlLoadShader()
 */
void umkarlLoadShader(UmkaStackSlot *params, UmkaStackSlot *result) {
    const char * code = (const char *)params[1].ptrVal;
    int type = params[0].intVal;
    result->uintVal = rlLoadShader(code, type);
}
...
void umkarlLoadShaderProgram(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    result->uintVal = rlLoadShaderProgram(vsCode, fsCode);
}

/**
 * Umka bindings for rlLoadShaderProgramEx().
 *
 * @see rlLoadShaderProgramEx()
 */
void umkarlLoadShaderProgramEx(UmkaStackSlot *params, UmkaStackSlot *result) {
    unsigned int vsId = params[1].uintVal;
    unsigned int fsId = params[0].uintVal;
    result->uintVal = rlLoadShaderProgramEx(vsId, fsId);
}

/**
 * Umka bindings for rlLoadShaderProgramCompute().
 *
 * @see rlLoadShaderProgramCompute()
 */
void umkarlLoadShaderProgramCompute(UmkaStackSlot *params, UmkaStackSlot *result) {
    unsigned int csId = params[0].uintVal;
    result->uintVal = rlLoadShaderProgramCompute(csId);
}

/**
 * Umka bindings for rlUnloadShader().
 *
 * @see rlUnloadShader()
 */
void umkarlUnloadShader(UmkaStackSlot *params, UmkaStackSlot *result) {
    unsigned int id = params[0].uintVal;
    rlUnloadShader(id);
}
...
void umkarlGetLocationUniform(UmkaStackSlot *params, UmkaStackSlot *result) {
    ...
    const char * uniformName = (const char *)params[0].ptrVal;
    result->intVal = rlGetLocationUniform(id, uniformName);
}
...
void umkarlGetLocationAttrib(UmkaStackSlot *params, UmkaStackSlot *result) {
    unsigned int id = params[1].uintVal;
    const char * attribName = (const char *)params[0].ptrVal;
    result->intVal = rlGetLocationAttrib(id, attribName);
}
...
/**
 * Umka bindings for rlSetUniformMatrices().
 *
 * @see rlSetUniformMatrices()
 */
void umkarlSetUniformMatrices(UmkaStackSlot *params, UmkaStackSlot *result) {
    int locIndex = params[2].intVal;
    const Matrix * mat = (const Matrix *)params[1].ptrVal;
    int count = params[0].intVal;
...
bool umkaAddRaylib(void *umka) {
    ...
    // ToggleBorderlessWindowed()
    if (!umkaAddFunc(umka, "ToggleBorderlessWindowed", &umkaToggleBorderlessWindowed)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ToggleBorderlessWindowed()");
        return false;
    }
    // MaximizeWindow()
    ...
    // SetWindowMaxSize()
    if (!umkaAddFunc(umka, "SetWindowMaxSize", &umkaSetWindowMaxSize)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function SetWindowMaxSize()");
        return false;
    }
    // SetWindowSize()
    ...
    // SetWindowFocused()
    if (!umkaAddFunc(umka, "SetWindowFocused", &umkaSetWindowFocused)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function SetWindowFocused()");
        return false;
    }
    // GetWindowHandle()
    ...
    // GetClipboardImage()
    if (!umkaAddFunc(umka, "GetClipboardImage", &umkaGetClipboardImage)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GetClipboardImage()");
        return false;
    }
    // EnableEventWaiting()
    ...
    // IsShaderValid()
    if (!umkaAddFunc(umka, "IsShaderValid", &umkaIsShaderValid)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function IsShaderValid()");
        return false;
    }
    // GetShaderLocation()
    ...
    // GetScreenToWorldRay()
    if (!umkaAddFunc(umka, "GetScreenToWorldRay", &umkaGetScreenToWorldRay)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GetScreenToWorldRay()");
        return false;
    }
    // GetScreenToWorldRayEx()
    if (!umkaAddFunc(umka, "GetScreenToWorldRayEx", &umkaGetScreenToWorldRayEx)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GetScreenToWorldRayEx()");
        return false;
    }
    // GetWorldToScreen()
    ...
    // LoadRandomSequence()
    if (!umkaAddFunc(umka, "LoadRandomSequence", &umkaLoadRandomSequence)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function LoadRandomSequence()");
        return false;
    }
    // UnloadRandomSequence()
    if (!umkaAddFunc(umka, "UnloadRandomSequence", &umkaUnloadRandomSequence)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function UnloadRandomSequence()");
        return false;
    }
    // TakeScreenshot()
    ...
    // FileRename()
    if (!umkaAddFunc(umka, "FileRename", &umkaFileRename)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function FileRename()");
        return false;
    }
    // FileRemove()
    if (!umkaAddFunc(umka, "FileRemove", &umkaFileRemove)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function FileRemove()");
        return false;
    }
    // FileCopy()
    if (!umkaAddFunc(umka, "FileCopy", &umkaFileCopy)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function FileCopy()");
        return false;
    }
    // FileMove()
    if (!umkaAddFunc(umka, "FileMove", &umkaFileMove)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function FileMove()");
        return false;
    }
    // FileTextReplace()
    if (!umkaAddFunc(umka, "FileTextReplace", &umkaFileTextReplace)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function FileTextReplace()");
        return false;
    }
    // FileTextFindIndex()
    if (!umkaAddFunc(umka, "FileTextFindIndex", &umkaFileTextFindIndex)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function FileTextFindIndex()");
        return false;
    }
    // FileExists()
    ...
    // MakeDirectory()
    if (!umkaAddFunc(umka, "MakeDirectory", &umkaMakeDirectory)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function MakeDirectory()");
        return false;
    }
    // ChangeDirectory()
    ...
    // IsFileNameValid()
    if (!umkaAddFunc(umka, "IsFileNameValid", &umkaIsFileNameValid)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function IsFileNameValid()");
        return false;
    }
    // LoadDirectoryFiles()
    ...
    if (!umkaAddFunc(umka, "GetDirectoryFileCount", &umkaGetDirectoryFileCount)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GetDirectoryFileCount()");
        return false;
    }
    // GetDirectoryFileCountEx()
    if (!umkaAddFunc(umka, "GetDirectoryFileCountEx", &umkaGetDirectoryFileCountEx)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GetDirectoryFileCountEx()");
        return false;
    }
    // CompressData()
    ...
    // ComputeCRC32()
    if (!umkaAddFunc(umka, "ComputeCRC32", &umkaComputeCRC32)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ComputeCRC32()");
        return false;
    }
    // ComputeMD5()
    if (!umkaAddFunc(umka, "ComputeMD5", &umkaComputeMD5)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ComputeMD5()");
        return false;
    }
    // ComputeSHA1()
    if (!umkaAddFunc(umka, "ComputeSHA1", &umkaComputeSHA1)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ComputeSHA1()");
        return false;
    }
    // ComputeSHA256()
    if (!umkaAddFunc(umka, "ComputeSHA256", &umkaComputeSHA256)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ComputeSHA256()");
        return false;
    }
    // LoadAutomationEventList()
    if (!umkaAddFunc(umka, "LoadAutomationEventList", &umkaLoadAutomationEventList)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function LoadAutomationEventList()");
        return false;
    }
    // UnloadAutomationEventList()
    if (!umkaAddFunc(umka, "UnloadAutomationEventList", &umkaUnloadAutomationEventList)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function UnloadAutomationEventList()");
        return false;
    }
    // ExportAutomationEventList()
    if (!umkaAddFunc(umka, "ExportAutomationEventList", &umkaExportAutomationEventList)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ExportAutomationEventList()");
        return false;
    }
    // SetAutomationEventList()
    if (!umkaAddFunc(umka, "SetAutomationEventList", &umkaSetAutomationEventList)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function SetAutomationEventList()");
        return false;
    }
    // SetAutomationEventBaseFrame()
    if (!umkaAddFunc(umka, "SetAutomationEventBaseFrame", &umkaSetAutomationEventBaseFrame)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function SetAutomationEventBaseFrame()");
        return false;
    }
    // StartAutomationEventRecording()
    if (!umkaAddFunc(umka, "StartAutomationEventRecording", &umkaStartAutomationEventRecording)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function StartAutomationEventRecording()");
        return false;
    }
    // StopAutomationEventRecording()
    if (!umkaAddFunc(umka, "StopAutomationEventRecording", &umkaStopAutomationEventRecording)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function StopAutomationEventRecording()");
        return false;
    }
    // PlayAutomationEvent()
    if (!umkaAddFunc(umka, "PlayAutomationEvent", &umkaPlayAutomationEvent)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function PlayAutomationEvent()");
        return false;
    }
    // IsKeyPressed()
    ...
    // IsKeyPressedRepeat()
    if (!umkaAddFunc(umka, "IsKeyPressedRepeat", &umkaIsKeyPressedRepeat)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function IsKeyPressedRepeat()");
        return false;
    }
    // IsKeyDown()
    ...
    // GetKeyName()
    if (!umkaAddFunc(umka, "GetKeyName", &umkaGetKeyName)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GetKeyName()");
        return false;
    }
    // SetExitKey()
    ...
    // SetGamepadVibration()
    if (!umkaAddFunc(umka, "SetGamepadVibration", &umkaSetGamepadVibration)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function SetGamepadVibration()");
        return false;
    }
    ...
    // GetShapesTexture()
    if (!umkaAddFunc(umka, "GetShapesTexture", &umkaGetShapesTexture)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GetShapesTexture()");
        return false;
    }
    // GetShapesTextureRectangle()
    if (!umkaAddFunc(umka, "GetShapesTextureRectangle", &umkaGetShapesTextureRectangle)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GetShapesTextureRectangle()");
        return false;
    }
    // DrawPixel()
    ...
    // DrawLineDashed()
    if (!umkaAddFunc(umka, "DrawLineDashed", &umkaDrawLineDashed)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawLineDashed()");
        return false;
    }
    // DrawCircle()
    ...
    // DrawCircleLinesV()
    if (!umkaAddFunc(umka, "DrawCircleLinesV", &umkaDrawCircleLinesV)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawCircleLinesV()");
        return false;
    }
    // DrawEllipse()
    ...
    // DrawEllipseV()
    if (!umkaAddFunc(umka, "DrawEllipseV", &umkaDrawEllipseV)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawEllipseV()");
        return false;
    }
    // DrawEllipseLines()
    ...
    if (!umkaAddFunc(umka, "DrawEllipseLinesV", &umkaDrawEllipseLinesV)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawEllipseLinesV()");
        return false;
    }
    // DrawRing()
    ...
    if (!umkaAddFunc(umka, "DrawRectangleRoundedLinesEx", &umkaDrawRectangleRoundedLinesEx)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawRectangleRoundedLinesEx()");
        return false;
    }
    // DrawTriangle()
    ...
    // DrawSplineLinear()
    if (!umkaAddFunc(umka, "DrawSplineLinear", &umkaDrawSplineLinear)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawSplineLinear()");
        return false;
    }
    // DrawSplineBasis()
    if (!umkaAddFunc(umka, "DrawSplineBasis", &umkaDrawSplineBasis)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawSplineBasis()");
        return false;
    }
    // DrawSplineCatmullRom()
    if (!umkaAddFunc(umka, "DrawSplineCatmullRom", &umkaDrawSplineCatmullRom)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawSplineCatmullRom()");
        return false;
    }
    // DrawSplineBezierQuadratic()
    if (!umkaAddFunc(umka, "DrawSplineBezierQuadratic", &umkaDrawSplineBezierQuadratic)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawSplineBezierQuadratic()");
        return false;
    }
    // DrawSplineBezierCubic()
    if (!umkaAddFunc(umka, "DrawSplineBezierCubic", &umkaDrawSplineBezierCubic)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawSplineBezierCubic()");
        return false;
    }
    // DrawSplineSegmentLinear()
    if (!umkaAddFunc(umka, "DrawSplineSegmentLinear", &umkaDrawSplineSegmentLinear)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawSplineSegmentLinear()");
        return false;
    }
    // DrawSplineSegmentBasis()
    if (!umkaAddFunc(umka, "DrawSplineSegmentBasis", &umkaDrawSplineSegmentBasis)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawSplineSegmentBasis()");
        return false;
    }
    // DrawSplineSegmentCatmullRom()
    if (!umkaAddFunc(umka, "DrawSplineSegmentCatmullRom", &umkaDrawSplineSegmentCatmullRom)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawSplineSegmentCatmullRom()");
        return false;
    }
    // DrawSplineSegmentBezierQuadratic()
    if (!umkaAddFunc(umka, "DrawSplineSegmentBezierQuadratic", &umkaDrawSplineSegmentBezierQuadratic)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawSplineSegmentBezierQuadratic()");
        return false;
    }
    // DrawSplineSegmentBezierCubic()
    if (!umkaAddFunc(umka, "DrawSplineSegmentBezierCubic", &umkaDrawSplineSegmentBezierCubic)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawSplineSegmentBezierCubic()");
        return false;
    }
    // GetSplinePointLinear()
    if (!umkaAddFunc(umka, "GetSplinePointLinear", &umkaGetSplinePointLinear)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GetSplinePointLinear()");
        return false;
    }
    // GetSplinePointBasis()
    if (!umkaAddFunc(umka, "GetSplinePointBasis", &umkaGetSplinePointBasis)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GetSplinePointBasis()");
        return false;
    }
    // GetSplinePointCatmullRom()
    if (!umkaAddFunc(umka, "GetSplinePointCatmullRom", &umkaGetSplinePointCatmullRom)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GetSplinePointCatmullRom()");
        return false;
    }
    // GetSplinePointBezierQuad()
    if (!umkaAddFunc(umka, "GetSplinePointBezierQuad", &umkaGetSplinePointBezierQuad)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GetSplinePointBezierQuad()");
        return false;
    }
    // GetSplinePointBezierCubic()
    if (!umkaAddFunc(umka, "GetSplinePointBezierCubic", &umkaGetSplinePointBezierCubic)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GetSplinePointBezierCubic()");
        return false;
    }
    // CheckCollisionRecs()
    ...
    if (!umkaAddFunc(umka, "CheckCollisionCircleLine", &umkaCheckCollisionCircleLine)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function CheckCollisionCircleLine()");
        return false;
    }
    ...
    if (!umkaAddFunc(umka, "LoadImageAnimFromMemory", &umkaLoadImageAnimFromMemory)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function LoadImageAnimFromMemory()");
        return false;
    }
    // LoadImageFromMemory()
    ...
    // IsImageValid()
    if (!umkaAddFunc(umka, "IsImageValid", &umkaIsImageValid)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function IsImageValid()");
        return false;
    }
    // UnloadImage()
    ...
    // ExportImageToMemory()
    if (!umkaAddFunc(umka, "ExportImageToMemory", &umkaExportImageToMemory)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ExportImageToMemory()");
        return false;
    }
    // ExportImageAsCode()
    ...
    if (!umkaAddFunc(umka, "GenImageGradientLinear", &umkaGenImageGradientLinear)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GenImageGradientLinear()");
        return false;
    }
    ...
    if (!umkaAddFunc(umka, "GenImageGradientSquare", &umkaGenImageGradientSquare)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GenImageGradientSquare()");
        return false;
    }
    // GenImageChecked()
    ...
    // ImageFromChannel()
    if (!umkaAddFunc(umka, "ImageFromChannel", &umkaImageFromChannel)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ImageFromChannel()");
        return false;
    }
    // ImageText()
    ...
    if (!umkaAddFunc(umka, "ImageKernelConvolution", &umkaImageKernelConvolution)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ImageKernelConvolution()");
        return false;
    }
    // ImageResize()
    ...
    // ImageRotate()
    if (!umkaAddFunc(umka, "ImageRotate", &umkaImageRotate)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ImageRotate()");
        return false;
    }
    // ImageRotateCW()
    ...
    // ImageDrawLineEx()
    if (!umkaAddFunc(umka, "ImageDrawLineEx", &umkaImageDrawLineEx)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ImageDrawLineEx()");
        return false;
    }
    // ImageDrawCircle()
    ...
    // ImageDrawTriangle()
    if (!umkaAddFunc(umka, "ImageDrawTriangle", &umkaImageDrawTriangle)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ImageDrawTriangle()");
        return false;
    }
    // ImageDrawTriangleEx()
    if (!umkaAddFunc(umka, "ImageDrawTriangleEx", &umkaImageDrawTriangleEx)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ImageDrawTriangleEx()");
        return false;
    }
    // ImageDrawTriangleLines()
    if (!umkaAddFunc(umka, "ImageDrawTriangleLines", &umkaImageDrawTriangleLines)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ImageDrawTriangleLines()");
        return false;
    }
    // ImageDrawTriangleFan()
    if (!umkaAddFunc(umka, "ImageDrawTriangleFan", &umkaImageDrawTriangleFan)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ImageDrawTriangleFan()");
        return false;
    }
    // ImageDrawTriangleStrip()
    if (!umkaAddFunc(umka, "ImageDrawTriangleStrip", &umkaImageDrawTriangleStrip)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ImageDrawTriangleStrip()");
        return false;
    }
    // ImageDraw()
    ...
    // IsTextureValid()
    if (!umkaAddFunc(umka, "IsTextureValid", &umkaIsTextureValid)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function IsTextureValid()");
        return false;
    }
    // UnloadTexture()
    ...
    if (!umkaAddFunc(umka, "IsRenderTextureValid", &umkaIsRenderTextureValid)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function IsRenderTextureValid()");
        return false;
    }
    // UnloadRenderTexture()
    ...
    // ColorIsEqual()
    if (!umkaAddFunc(umka, "ColorIsEqual", &umkaColorIsEqual)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ColorIsEqual()");
        return false;
    }
    // Fade()
    ...
    // ColorLerp()
    if (!umkaAddFunc(umka, "ColorLerp", &umkaColorLerp)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ColorLerp()");
        return false;
    }
    // GetColor()
    ...
    // IsFontValid()
    if (!umkaAddFunc(umka, "IsFontValid", &umkaIsFontValid)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function IsFontValid()");
        return false;
    }
    ...
    // SetTextLineSpacing()
    if (!umkaAddFunc(umka, "SetTextLineSpacing", &umkaSetTextLineSpacing)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function SetTextLineSpacing()");
        return false;
    }
    // MeasureText()
    ...
    if (!umkaAddFunc(umka, "MeasureTextCodepoints", &umkaMeasureTextCodepoints)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function MeasureTextCodepoints()");
        return false;
    }
    // GetGlyphIndex()
    ...
    // LoadTextLines()
    if (!umkaAddFunc(umka, "LoadTextLines", &umkaLoadTextLines)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function LoadTextLines()");
        return false;
    }
    // UnloadTextLines()
    if (!umkaAddFunc(umka, "UnloadTextLines", &umkaUnloadTextLines)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function UnloadTextLines()");
        return false;
    }
    // TextCopy()
    ...
    // TextRemoveSpaces()
    if (!umkaAddFunc(umka, "TextRemoveSpaces", &umkaTextRemoveSpaces)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function TextRemoveSpaces()");
        return false;
    }
    // GetTextBetween()
    if (!umkaAddFunc(umka, "GetTextBetween", &umkaGetTextBetween)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GetTextBetween()");
        return false;
    }
    // TextReplace()
    ...
    // TextReplaceBetween()
    if (!umkaAddFunc(umka, "TextReplaceBetween", &umkaTextReplaceBetween)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function TextReplaceBetween()");
        return false;
    }
    // TextInsert()
    ...
    // TextToSnake()
    if (!umkaAddFunc(umka, "TextToSnake", &umkaTextToSnake)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function TextToSnake()");
        return false;
    }
    // TextToCamel()
    if (!umkaAddFunc(umka, "TextToCamel", &umkaTextToCamel)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function TextToCamel()");
        return false;
    }
    // TextToInteger()
    ...
    // TextToFloat()
    if (!umkaAddFunc(umka, "TextToFloat", &umkaTextToFloat)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function TextToFloat()");
        return false;
    }
    // DrawLine3D()
    ...
    // IsModelValid()
    if (!umkaAddFunc(umka, "IsModelValid", &umkaIsModelValid)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function IsModelValid()");
        return false;
    }
    // UnloadModel()
    ...
    // DrawModelPoints()
    if (!umkaAddFunc(umka, "DrawModelPoints", &umkaDrawModelPoints)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawModelPoints()");
        return false;
    }
    // DrawModelPointsEx()
    if (!umkaAddFunc(umka, "DrawModelPointsEx", &umkaDrawModelPointsEx)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function DrawModelPointsEx()");
        return false;
    }
    // DrawBoundingBox()
    ...
    // ExportMeshAsCode()
    if (!umkaAddFunc(umka, "ExportMeshAsCode", &umkaExportMeshAsCode)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function ExportMeshAsCode()");
        return false;
    }
    // GenMeshPoly()
    ...
    // IsMaterialValid()
    if (!umkaAddFunc(umka, "IsMaterialValid", &umkaIsMaterialValid)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function IsMaterialValid()");
        return false;
    }
    // UnloadMaterial()
    ...
    if (!umkaAddFunc(umka, "UpdateModelAnimationEx", &umkaUpdateModelAnimationEx)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function UpdateModelAnimationEx()");
        return false;
    }
    ...
    // GetMasterVolume()
    if (!umkaAddFunc(umka, "GetMasterVolume", &umkaGetMasterVolume)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function GetMasterVolume()");
        return false;
    }
    // LoadWave()
    ...
    // IsWaveValid()
    if (!umkaAddFunc(umka, "IsWaveValid", &umkaIsWaveValid)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function IsWaveValid()");
        return false;
    }
    // LoadSound()
    ...
    // LoadSoundAlias()
    if (!umkaAddFunc(umka, "LoadSoundAlias", &umkaLoadSoundAlias)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function LoadSoundAlias()");
        return false;
    }
    // IsSoundValid()
    if (!umkaAddFunc(umka, "IsSoundValid", &umkaIsSoundValid)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function IsSoundValid()");
        return false;
    }
    // UpdateSound()
    ...
    // UnloadSoundAlias()
    if (!umkaAddFunc(umka, "UnloadSoundAlias", &umkaUnloadSoundAlias)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function UnloadSoundAlias()");
        return false;
    }
    // ExportWave()
    ...
    // IsMusicValid()
    if (!umkaAddFunc(umka, "IsMusicValid", &umkaIsMusicValid)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function IsMusicValid()");
        return false;
    }
    // UnloadMusicStream()
    ...
    // IsAudioStreamValid()
    if (!umkaAddFunc(umka, "IsAudioStreamValid", &umkaIsAudioStreamValid)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function IsAudioStreamValid()");
        return false;
    }
    // UnloadAudioStream()
    ...
    // Vector2CrossProduct()
    if (!umkaAddFunc(umka, "Vector2CrossProduct", &umkaVector2CrossProduct)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector2CrossProduct()");
        return false;
    }
    // Vector2Distance()
    ...
    // Vector2Min()
    if (!umkaAddFunc(umka, "Vector2Min", &umkaVector2Min)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector2Min()");
        return false;
    }
    // Vector2Max()
    if (!umkaAddFunc(umka, "Vector2Max", &umkaVector2Max)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector2Max()");
        return false;
    }
    // Vector2Rotate()
    ...
    // Vector2Refract()
    if (!umkaAddFunc(umka, "Vector2Refract", &umkaVector2Refract)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector2Refract()");
        return false;
    }
    // Vector3Zero()
    ...
    // Vector3Project()
    if (!umkaAddFunc(umka, "Vector3Project", &umkaVector3Project)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector3Project()");
        return false;
    }
    // Vector3Reject()
    if (!umkaAddFunc(umka, "Vector3Reject", &umkaVector3Reject)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector3Reject()");
        return false;
    }
    ...
    // Vector3MoveTowards()
    if (!umkaAddFunc(umka, "Vector3MoveTowards", &umkaVector3MoveTowards)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector3MoveTowards()");
        return false;
    }
    // Vector3Lerp()
    ...
    // Vector3CubicHermite()
    if (!umkaAddFunc(umka, "Vector3CubicHermite", &umkaVector3CubicHermite)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector3CubicHermite()");
        return false;
    }
    // Vector3Reflect()
    ...
    // Vector4Zero()
    if (!umkaAddFunc(umka, "Vector4Zero", &umkaVector4Zero)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4Zero()");
        return false;
    }
    // Vector4One()
    if (!umkaAddFunc(umka, "Vector4One", &umkaVector4One)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4One()");
        return false;
    }
    // Vector4Add()
    if (!umkaAddFunc(umka, "Vector4Add", &umkaVector4Add)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4Add()");
        return false;
    }
    // Vector4AddValue()
    if (!umkaAddFunc(umka, "Vector4AddValue", &umkaVector4AddValue)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4AddValue()");
        return false;
    }
    // Vector4Subtract()
    if (!umkaAddFunc(umka, "Vector4Subtract", &umkaVector4Subtract)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4Subtract()");
        return false;
    }
    // Vector4SubtractValue()
    if (!umkaAddFunc(umka, "Vector4SubtractValue", &umkaVector4SubtractValue)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4SubtractValue()");
        return false;
    }
    // Vector4Length()
    if (!umkaAddFunc(umka, "Vector4Length", &umkaVector4Length)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4Length()");
        return false;
    }
    // Vector4LengthSqr()
    if (!umkaAddFunc(umka, "Vector4LengthSqr", &umkaVector4LengthSqr)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4LengthSqr()");
        return false;
    }
    // Vector4DotProduct()
    if (!umkaAddFunc(umka, "Vector4DotProduct", &umkaVector4DotProduct)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4DotProduct()");
        return false;
    }
    // Vector4Distance()
    if (!umkaAddFunc(umka, "Vector4Distance", &umkaVector4Distance)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4Distance()");
        return false;
    }
    // Vector4DistanceSqr()
    if (!umkaAddFunc(umka, "Vector4DistanceSqr", &umkaVector4DistanceSqr)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4DistanceSqr()");
        return false;
    }
    // Vector4Scale()
    if (!umkaAddFunc(umka, "Vector4Scale", &umkaVector4Scale)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4Scale()");
        return false;
    }
    // Vector4Multiply()
    if (!umkaAddFunc(umka, "Vector4Multiply", &umkaVector4Multiply)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4Multiply()");
        return false;
    }
    // Vector4Negate()
    if (!umkaAddFunc(umka, "Vector4Negate", &umkaVector4Negate)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4Negate()");
        return false;
    }
    // Vector4Divide()
    if (!umkaAddFunc(umka, "Vector4Divide", &umkaVector4Divide)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4Divide()");
        return false;
    }
    // Vector4Normalize()
    if (!umkaAddFunc(umka, "Vector4Normalize", &umkaVector4Normalize)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4Normalize()");
        return false;
    }
    // Vector4Min()
    if (!umkaAddFunc(umka, "Vector4Min", &umkaVector4Min)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4Min()");
        return false;
    }
    // Vector4Max()
    if (!umkaAddFunc(umka, "Vector4Max", &umkaVector4Max)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4Max()");
        return false;
    }
    // Vector4Lerp()
    if (!umkaAddFunc(umka, "Vector4Lerp", &umkaVector4Lerp)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4Lerp()");
        return false;
    }
    // Vector4MoveTowards()
    if (!umkaAddFunc(umka, "Vector4MoveTowards", &umkaVector4MoveTowards)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4MoveTowards()");
        return false;
    }
    // Vector4Invert()
    if (!umkaAddFunc(umka, "Vector4Invert", &umkaVector4Invert)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4Invert()");
        return false;
    }
    // Vector4Equals()
    if (!umkaAddFunc(umka, "Vector4Equals", &umkaVector4Equals)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function Vector4Equals()");
        return false;
    }
    // MatrixDeterminant()
    ...
    // MatrixMultiplyValue()
    if (!umkaAddFunc(umka, "MatrixMultiplyValue", &umkaMatrixMultiplyValue)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function MatrixMultiplyValue()");
        return false;
    }
    // MatrixTranslate()
    ...
    if (!umkaAddFunc(umka, "QuaternionCubicHermiteSpline", &umkaQuaternionCubicHermiteSpline)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function QuaternionCubicHermiteSpline()");
        return false;
    }
    ...
    // MatrixCompose()
    if (!umkaAddFunc(umka, "MatrixCompose", &umkaMatrixCompose)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function MatrixCompose()");
        return false;
    }
    // MatrixDecompose()
    if (!umkaAddFunc(umka, "MatrixDecompose", &umkaMatrixDecompose)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function MatrixDecompose()");
        return false;
    }
    // rlMatrixMode()
    ...
    // rlSetClipPlanes()
    if (!umkaAddFunc(umka, "rlSetClipPlanes", &umkarlSetClipPlanes)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlSetClipPlanes()");
        return false;
    }
    // rlGetCullDistanceNear()
    if (!umkaAddFunc(umka, "rlGetCullDistanceNear", &umkarlGetCullDistanceNear)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlGetCullDistanceNear()");
        return false;
    }
    // rlGetCullDistanceFar()
    if (!umkaAddFunc(umka, "rlGetCullDistanceFar", &umkarlGetCullDistanceFar)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlGetCullDistanceFar()");
        return false;
    }
    // rlBegin()
    ...
    if (!umkaAddFunc(umka, "rlGetActiveFramebuffer", &umkarlGetActiveFramebuffer)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlGetActiveFramebuffer()");
        return false;
    }
    // rlActiveDrawBuffers()
    ...
    // rlBlitFramebuffer()
    if (!umkaAddFunc(umka, "rlBlitFramebuffer", &umkarlBlitFramebuffer)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlBlitFramebuffer()");
        return false;
    }
    // rlBindFramebuffer()
    if (!umkaAddFunc(umka, "rlBindFramebuffer", &umkarlBindFramebuffer)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlBindFramebuffer()");
        return false;
    }
    // rlEnableColorBlend()
    ...
    // rlColorMask()
    if (!umkaAddFunc(umka, "rlColorMask", &umkarlColorMask)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlColorMask()");
        return false;
    }
    // rlSetCullFace()
    ...
    // rlEnablePointMode()
    if (!umkaAddFunc(umka, "rlEnablePointMode", &umkarlEnablePointMode)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlEnablePointMode()");
        return false;
    }
    // rlDisablePointMode()
    if (!umkaAddFunc(umka, "rlDisablePointMode", &umkarlDisablePointMode)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlDisablePointMode()");
        return false;
    }
    // rlSetPointSize()
    if (!umkaAddFunc(umka, "rlSetPointSize", &umkarlSetPointSize)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlSetPointSize()");
        return false;
    }
    // rlGetPointSize()
    if (!umkaAddFunc(umka, "rlGetPointSize", &umkarlGetPointSize)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlGetPointSize()");
        return false;
    }
    // rlEnableWireMode()
    ...
    if (!umkaAddFunc(umka, "rlGetProcAddress", &umkarlGetProcAddress)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlGetProcAddress()");
        return false;
    }
    // rlGetVersion()
    ...
    // rlCopyFramebuffer()
    if (!umkaAddFunc(umka, "rlCopyFramebuffer", &umkarlCopyFramebuffer)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlCopyFramebuffer()");
        return false;
    }
    // rlResizeFramebuffer()
    if (!umkaAddFunc(umka, "rlResizeFramebuffer", &umkarlResizeFramebuffer)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlResizeFramebuffer()");
        return false;
    }
    // rlLoadShader()
    if (!umkaAddFunc(umka, "rlLoadShader", &umkarlLoadShader)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlLoadShader()");
        return false;
    }
    // rlLoadShaderProgram()
    ...
    if (!umkaAddFunc(umka, "rlLoadShaderProgramEx", &umkarlLoadShaderProgramEx)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlLoadShaderProgramEx()");
        return false;
    }
    // rlLoadShaderProgramCompute()
    if (!umkaAddFunc(umka, "rlLoadShaderProgramCompute", &umkarlLoadShaderProgramCompute)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlLoadShaderProgramCompute()");
        return false;
    }
    // rlUnloadShader()
    if (!umkaAddFunc(umka, "rlUnloadShader", &umkarlUnloadShader)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlUnloadShader()");
        return false;
    }
    ...
    if (!umkaAddFunc(umka, "rlSetUniformMatrices", &umkarlSetUniformMatrices)) {
        TraceLog(LOG_ERROR, "UMKA: Failed to add function rlSetUniformMatrices()");
        return false;
    }
    // rlSetUniformSampler()
    ...
    const char* moduleCode =
        ...
        /* 0253 */ "    LoadFileDataCallback = fn(fileName: str, dataSize: ^int32): ^uint8\n"
        /* 0254 */ "    SaveFileDataCallback = fn(fileName: str, data: ^void, dataSize: int32): bool\n"
        /* 0255 */ "    LoadFileTextCallback = fn(fileName: str): str\n"
        /* 0256 */ "    SaveFileTextCallback = fn(fileName: str, text: str): bool\n"
        /* 0257 */ "    AudioCallback = fn(bufferData: ^void, frames: uint32)\n"
        /* 0258 */ ")\n"

        // Function Declarations
        /* 0259 */ "fn InitWindow*(width: int32, height: int32, title: str)\n"
        /* 0260 */ "fn CloseWindow*()\n"
        /* 0261 */ "fn WindowShouldClose*(): bool\n"
        /* 0262 */ "fn IsWindowReady*(): bool\n"
        /* 0263 */ "fn IsWindowFullscreen*(): bool\n"
        /* 0264 */ "fn IsWindowHidden*(): bool\n"
        /* 0265 */ "fn IsWindowMinimized*(): bool\n"
        /* 0266 */ "fn IsWindowMaximized*(): bool\n"
        /* 0267 */ "fn IsWindowFocused*(): bool\n"
        /* 0268 */ "fn IsWindowResized*(): bool\n"
        /* 0269 */ "fn IsWindowState*(flag: uint32): bool\n"
        /* 0270 */ "fn SetWindowState*(flags: uint32)\n"
        /* 0271 */ "fn ClearWindowState*(flags: uint32)\n"
        /* 0272 */ "fn ToggleFullscreen*()\n"
        /* 0273 */ "fn ToggleBorderlessWindowed*()\n"
        /* 0274 */ "fn MaximizeWindow*()\n"
        /* 0275 */ "fn MinimizeWindow*()\n"
        /* 0276 */ "fn RestoreWindow*()\n"
        /* 0277 */ "fn SetWindowIcon*(image: Image)\n"
        /* 0278 */ "fn SetWindowIcons*(images: ^Image, count: int32)\n"
        /* 0279 */ "fn SetWindowTitle*(title: str)\n"
        /* 0280 */ "fn SetWindowPosition*(x: int32, y: int32)\n"
        /* 0281 */ "fn SetWindowMonitor*(monitor: int32)\n"
        /* 0282 */ "fn SetWindowMinSize*(width: int32, height: int32)\n"
        /* 0283 */ "fn SetWindowMaxSize*(width: int32, height: int32)\n"
        /* 0284 */ "fn SetWindowSize*(width: int32, height: int32)\n"
        /* 0285 */ "fn SetWindowOpacity*(opacity: real32)\n"
        /* 0286 */ "fn SetWindowFocused*()\n"
        /* 0287 */ "fn GetWindowHandle*(): ^void\n"
        /* 0288 */ "fn GetScreenWidth*(): int32\n"
        /* 0289 */ "fn GetScreenHeight*(): int32\n"
        /* 0290 */ "fn GetRenderWidth*(): int32\n"
        /* 0291 */ "fn GetRenderHeight*(): int32\n"
        /* 0292 */ "fn GetMonitorCount*(): int32\n"
        /* 0293 */ "fn GetCurrentMonitor*(): int32\n"
        /* 0294 */ "fn GetMonitorPosition*(monitor: int32): Vector2\n"
        /* 0295 */ "fn GetMonitorWidth*(monitor: int32): int32\n"
        /* 0296 */ "fn GetMonitorHeight*(monitor: int32): int32\n"
        /* 0297 */ "fn GetMonitorPhysicalWidth*(monitor: int32): int32\n"
        /* 0298 */ "fn GetMonitorPhysicalHeight*(monitor: int32): int32\n"
        /* 0299 */ "fn GetMonitorRefreshRate*(monitor: int32): int32\n"
        /* 0300 */ "fn GetWindowPosition*(): Vector2\n"
        /* 0301 */ "fn GetWindowScaleDPI*(): Vector2\n"
        /* 0302 */ "fn GetMonitorName*(monitor: int32): str\n"
        /* 0303 */ "fn SetClipboardText*(text: str)\n"
        /* 0304 */ "fn GetClipboardText*(): str\n"
        /* 0305 */ "fn GetClipboardImage*(): Image\n"
        /* 0306 */ "fn EnableEventWaiting*()\n"
        /* 0307 */ "fn DisableEventWaiting*()\n"
        /* 0308 */ "fn ShowCursor*()\n"
        /* 0309 */ "fn HideCursor*()\n"
        /* 0310 */ "fn IsCursorHidden*(): bool\n"
        /* 0311 */ "fn EnableCursor*()\n"
        /* 0312 */ "fn DisableCursor*()\n"
        /* 0313 */ "fn IsCursorOnScreen*(): bool\n"
        /* 0314 */ "fn ClearBackground*(color: Color)\n"
        /* 0315 */ "fn BeginDrawing*()\n"
        /* 0316 */ "fn EndDrawing*()\n"
        /* 0317 */ "fn BeginMode2D*(camera: Camera2D)\n"
        /* 0318 */ "fn EndMode2D*()\n"
        /* 0319 */ "fn BeginMode3D*(camera: Camera3D)\n"
        /* 0320 */ "fn EndMode3D*()\n"
        /* 0321 */ "fn BeginTextureMode*(target: RenderTexture)\n"
        /* 0322 */ "fn EndTextureMode*()\n"
        /* 0323 */ "fn BeginShaderMode*(shader: Shader)\n"
        /* 0324 */ "fn EndShaderMode*()\n"
        /* 0325 */ "fn BeginBlendMode*(mode: int32)\n"
        /* 0326 */ "fn EndBlendMode*()\n"
        /* 0327 */ "fn BeginScissorMode*(x: int32, y: int32, width: int32, height: int32)\n"
        /* 0328 */ "fn EndScissorMode*()\n"
        /* 0329 */ "fn BeginVrStereoMode*(config: VrStereoConfig)\n"
        /* 0330 */ "fn EndVrStereoMode*()\n"
        /* 0331 */ "fn LoadVrStereoConfig*(device: VrDeviceInfo): VrStereoConfig\n"
        /* 0332 */ "fn UnloadVrStereoConfig*(config: VrStereoConfig)\n"
        /* 0333 */ "fn LoadShader*(vsFileName: str, fsFileName: str): Shader\n"
        /* 0334 */ "fn LoadShaderFromMemory*(vsCode: str, fsCode: str): Shader\n"
        /* 0335 */ "fn IsShaderValid*(shader: Shader): bool\n"
        /* 0336 */ "fn GetShaderLocation*(shader: Shader, uniformName: str): int32\n"
        /* 0337 */ "fn GetShaderLocationAttrib*(shader: Shader, attribName: str): int32\n"
        /* 0338 */ "fn SetShaderValue*(shader: Shader, locIndex: int32, value: ^void, uniformType: int32)\n"
        /* 0339 */ "fn SetShaderValueV*(shader: Shader, locIndex: int32, value: ^void, uniformType: int32, count: int32)\n"
        /* 0340 */ "fn SetShaderValueMatrix*(shader: Shader, locIndex: int32, mat: Matrix)\n"
        /* 0341 */ "fn SetShaderValueTexture*(shader: Shader, locIndex: int32, texture: Texture)\n"
        /* 0342 */ "fn UnloadShader*(shader: Shader)\n"
        /* 0343 */ "fn GetScreenToWorldRay*(position: Vector2, camera: Camera3D): Ray\n"
        /* 0344 */ "fn GetScreenToWorldRayEx*(position: Vector2, camera: Camera3D, width: int32, height: int32): Ray\n"
        /* 0345 */ "fn GetWorldToScreen*(position: Vector3, camera: Camera3D): Vector2\n"
        /* 0346 */ "fn GetWorldToScreenEx*(position: Vector3, camera: Camera3D, width: int32, height: int32): Vector2\n"
        /* 0347 */ "fn GetWorldToScreen2D*(position: Vector2, camera: Camera2D): Vector2\n"
        /* 0348 */ "fn GetScreenToWorld2D*(position: Vector2, camera: Camera2D): Vector2\n"
        /* 0349 */ "fn GetCameraMatrix*(camera: Camera3D): Matrix\n"
        /* 0350 */ "fn GetCameraMatrix2D*(camera: Camera2D): Matrix\n"
        /* 0351 */ "fn SetTargetFPS*(fps: int32)\n"
        /* 0352 */ "fn GetFrameTime*(): real32\n"
        /* 0353 */ "fn GetTime*(): real\n"
        /* 0354 */ "fn GetFPS*(): int32\n"
        /* 0355 */ "fn SwapScreenBuffer*()\n"
        /* 0356 */ "fn PollInputEvents*()\n"
        /* 0357 */ "fn WaitTime*(seconds: real)\n"
        /* 0358 */ "fn SetRandomSeed*(seed: uint32)\n"
        /* 0359 */ "fn GetRandomValue*(min: int32, max: int32): int32\n"
        /* 0360 */ "fn LoadRandomSequence*(count: uint32, min: int32, max: int32): ^int32\n"
        /* 0361 */ "fn UnloadRandomSequence*(sequence: ^int32)\n"
        /* 0362 */ "fn TakeScreenshot*(fileName: str)\n"
        /* 0363 */ "fn SetConfigFlags*(flags: uint32)\n"
        /* 0364 */ "fn OpenURL*(url: str)\n"
        /* 0365 */ "fn SetTraceLogLevel*(logLevel: int32)\n"
        // Skipping TraceLog
        // Skipping SetTraceLogCallback
        /* 0366 */ "fn MemAlloc*(size: uint32): ^void\n"
        /* 0367 */ "fn MemRealloc*(ptr: ^void, size: uint32): ^void\n"
        /* 0368 */ "fn MemFree*(ptr: ^void)\n"
        /* 0369 */ "fn LoadFileData*(fileName: str, dataSize: ^int32): ^uint8\n"
        /* 0370 */ "fn UnloadFileData*(data: ^uint8)\n"
        /* 0371 */ "fn SaveFileData*(fileName: str, data: ^void, dataSize: int32): bool\n"
        /* 0372 */ "fn ExportDataAsCode*(data: ^uint8, dataSize: int32, fileName: str): bool\n"
        /* 0373 */ "fn LoadFileText*(fileName: str): str\n"
        /* 0374 */ "fn UnloadFileText*(text: str)\n"
        /* 0375 */ "fn SaveFileText*(fileName: str, text: str): bool\n"
        // Skipping SetLoadFileDataCallback
        // Skipping SetSaveFileDataCallback
        // Skipping SetLoadFileTextCallback
        // Skipping SetSaveFileTextCallback
        /* 0376 */ "fn FileRename*(fileName: str, fileRename: str): int32\n"
        /* 0377 */ "fn FileRemove*(fileName: str): int32\n"
        /* 0378 */ "fn FileCopy*(srcPath: str, dstPath: str): int32\n"
        /* 0379 */ "fn FileMove*(srcPath: str, dstPath: str): int32\n"
        /* 0380 */ "fn FileTextReplace*(fileName: str, search: str, replacement: str): int32\n"
        /* 0381 */ "fn FileTextFindIndex*(fileName: str, search: str): int32\n"
        /* 0382 */ "fn FileExists*(fileName: str): bool\n"
        /* 0383 */ "fn DirectoryExists*(dirPath: str): bool\n"
        /* 0384 */ "fn IsFileExtension*(fileName: str, ext: str): bool\n"
        /* 0385 */ "fn GetFileLength*(fileName: str): int32\n"
        /* 0386 */ "fn GetFileModTime*(fileName: str): int\n"
        /* 0387 */ "fn GetFileExtension*(fileName: str): str\n"
        /* 0388 */ "fn GetFileName*(filePath: str): str\n"
        /* 0389 */ "fn GetFileNameWithoutExt*(filePath: str): str\n"
        /* 0390 */ "fn GetDirectoryPath*(filePath: str): str\n"
        /* 0391 */ "fn GetPrevDirectoryPath*(dirPath: str): str\n"
        /* 0392 */ "fn GetWorkingDirectory*(): str\n"
        /* 0393 */ "fn GetApplicationDirectory*(): str\n"
        /* 0394 */ "fn MakeDirectory*(dirPath: str): int32\n"
        /* 0395 */ "fn ChangeDirectory*(dirPath: str): bool\n"
        /* 0396 */ "fn IsPathFile*(path: str): bool\n"
        /* 0397 */ "fn IsFileNameValid*(fileName: str): bool\n"
        /* 0398 */ "fn LoadDirectoryFiles*(dirPath: str): FilePathList\n"
        /* 0399 */ "fn LoadDirectoryFilesEx*(basePath: str, filter: str, scanSubdirs: bool): FilePathList\n"
        /* 0400 */ "fn UnloadDirectoryFiles*(files: FilePathList)\n"
        /* 0401 */ "fn IsFileDropped*(): bool\n"
        /* 0402 */ "fn LoadDroppedFiles*(): FilePathList\n"
        /* 0403 */ "fn UnloadDroppedFiles*(files: FilePathList)\n"
        /* 0404 */ "fn GetDirectoryFileCount*(dirPath: str): uint32\n"
        /* 0405 */ "fn GetDirectoryFileCountEx*(basePath: str, filter: str, scanSubdirs: bool): uint32\n"
        /* 0406 */ "fn CompressData*(data: ^uint8, dataSize: int32, compDataSize: ^int32): ^uint8\n"
        /* 0407 */ "fn DecompressData*(compData: ^uint8, compDataSize: int32, dataSize: ^int32): ^uint8\n"
        /* 0408 */ "fn EncodeDataBase64*(data: ^uint8, dataSize: int32, outputSize: ^int32): str\n"
        /* 0409 */ "fn DecodeDataBase64*(text: str, outputSize: ^int32): ^uint8\n"
        /* 0410 */ "fn ComputeCRC32*(data: ^uint8, dataSize: int32): uint32\n"
        /* 0411 */ "fn ComputeMD5*(data: ^uint8, dataSize: int32): ^uint32\n"
        /* 0412 */ "fn ComputeSHA1*(data: ^uint8, dataSize: int32): ^uint32\n"
        /* 0413 */ "fn ComputeSHA256*(data: ^uint8, dataSize: int32): ^uint32\n"
        /* 0414 */ "fn LoadAutomationEventList*(fileName: str): AutomationEventList\n"
        /* 0415 */ "fn UnloadAutomationEventList*(list: AutomationEventList)\n"
        /* 0416 */ "fn ExportAutomationEventList*(list: AutomationEventList, fileName: str): bool\n"
        /* 0417 */ "fn SetAutomationEventList*(list: ^AutomationEventList)\n"
        /* 0418 */ "fn SetAutomationEventBaseFrame*(frame: int32)\n"
        /* 0419 */ "fn StartAutomationEventRecording*()\n"
        /* 0420 */ "fn StopAutomationEventRecording*()\n"
        /* 0421 */ "fn PlayAutomationEvent*(event: AutomationEvent)\n"
        /* 0422 */ "fn IsKeyPressed*(key: int32): bool\n"
        /* 0423 */ "fn IsKeyPressedRepeat*(key: int32): bool\n"
        /* 0424 */ "fn IsKeyDown*(key: int32): bool\n"
        /* 0425 */ "fn IsKeyReleased*(key: int32): bool\n"
        /* 0426 */ "fn IsKeyUp*(key: int32): bool\n"
        /* 0427 */ "fn GetKeyPressed*(): int32\n"
        /* 0428 */ "fn GetCharPressed*(): int32\n"
        /* 0429 */ "fn GetKeyName*(key: int32): str\n"
        /* 0430 */ "fn SetExitKey*(key: int32)\n"
        /* 0431 */ "fn IsGamepadAvailable*(gamepad: int32): bool\n"
        /* 0432 */ "fn GetGamepadName*(gamepad: int32): str\n"
        /* 0433 */ "fn IsGamepadButtonPressed*(gamepad: int32, button: int32): bool\n"
        /* 0434 */ "fn IsGamepadButtonDown*(gamepad: int32, button: int32): bool\n"
        /* 0435 */ "fn IsGamepadButtonReleased*(gamepad: int32, button: int32): bool\n"
        /* 0436 */ "fn IsGamepadButtonUp*(gamepad: int32, button: int32): bool\n"
        /* 0437 */ "fn GetGamepadButtonPressed*(): int32\n"
        /* 0438 */ "fn GetGamepadAxisCount*(gamepad: int32): int32\n"
        /* 0439 */ "fn GetGamepadAxisMovement*(gamepad: int32, axis: int32): real32\n"
        /* 0440 */ "fn SetGamepadMappings*(mappings: str): int32\n"
        /* 0441 */ "fn SetGamepadVibration*(gamepad: int32, leftMotor: real32, rightMotor: real32, duration: real32)\n"
        /* 0442 */ "fn IsMouseButtonPressed*(button: int32): bool\n"
        /* 0443 */ "fn IsMouseButtonDown*(button: int32): bool\n"
        /* 0444 */ "fn IsMouseButtonReleased*(button: int32): bool\n"
        /* 0445 */ "fn IsMouseButtonUp*(button: int32): bool\n"
        /* 0446 */ "fn GetMouseX*(): int32\n"
        /* 0447 */ "fn GetMouseY*(): int32\n"
        /* 0448 */ "fn GetMousePosition*(): Vector2\n"
        /* 0449 */ "fn GetMouseDelta*(): Vector2\n"
        /* 0450 */ "fn SetMousePosition*(x: int32, y: int32)\n"
        /* 0451 */ "fn SetMouseOffset*(offsetX: int32, offsetY: int32)\n"
        /* 0452 */ "fn SetMouseScale*(scaleX: real32, scaleY: real32)\n"
        /* 0453 */ "fn GetMouseWheelMove*(): real32\n"
        /* 0454 */ "fn GetMouseWheelMoveV*(): Vector2\n"
        /* 0455 */ "fn SetMouseCursor*(cursor: int32)\n"
        /* 0456 */ "fn GetTouchX*(): int32\n"
        /* 0457 */ "fn GetTouchY*(): int32\n"
        /* 0458 */ "fn GetTouchPosition*(index: int32): Vector2\n"
        /* 0459 */ "fn GetTouchPointId*(index: int32): int32\n"
        /* 0460 */ "fn GetTouchPointCount*(): int32\n"
        /* 0461 */ "fn SetGesturesEnabled*(flags: uint32)\n"
        /* 0462 */ "fn IsGestureDetected*(gesture: uint32): bool\n"
        /* 0463 */ "fn GetGestureDetected*(): int32\n"
        /* 0464 */ "fn GetGestureHoldDuration*(): real32\n"
        /* 0465 */ "fn GetGestureDragVector*(): Vector2\n"
        /* 0466 */ "fn GetGestureDragAngle*(): real32\n"
        /* 0467 */ "fn GetGesturePinchVector*(): Vector2\n"
        /* 0468 */ "fn GetGesturePinchAngle*(): real32\n"
        /* 0469 */ "fn UpdateCamera*(camera: ^Camera3D, mode: int32)\n"
        /* 0470 */ "fn UpdateCameraPro*(camera: ^Camera3D, movement: Vector3, rotation: Vector3, zoom: real32)\n"
        /* 0471 */ "fn SetShapesTexture*(texture: Texture, source: Rectangle)\n"
        /* 0472 */ "fn GetShapesTexture*(): Texture\n"
        /* 0473 */ "fn GetShapesTextureRectangle*(): Rectangle\n"
        /* 0474 */ "fn DrawPixel*(posX: int32, posY: int32, color: Color)\n"
        /* 0475 */ "fn DrawPixelV*(position: Vector2, color: Color)\n"
        /* 0476 */ "fn DrawLine*(startPosX: int32, startPosY: int32, endPosX: int32, endPosY: int32, color: Color)\n"
        /* 0477 */ "fn DrawLineV*(startPos: Vector2, endPos: Vector2, color: Color)\n"
        /* 0478 */ "fn DrawLineEx*(startPos: Vector2, endPos: Vector2, thick: real32, color: Color)\n"
        /* 0479 */ "fn DrawLineStrip*(points: const ^Vector2, pointCount: int32, color: Color)\n"
        /* 0480 */ "fn DrawLineBezier*(startPos: Vector2, endPos: Vector2, thick: real32, color: Color)\n"
        /* 0481 */ "fn DrawLineDashed*(startPos: Vector2, endPos: Vector2, dashSize: int32, spaceSize: int32, color: Color)\n"
        /* 0482 */ "fn DrawCircle*(centerX: int32, centerY: int32, radius: real32, color: Color)\n"
        /* 0483 */ "fn DrawCircleSector*(center: Vector2, radius: real32, startAngle: real32, endAngle: real32, segments: int32, color: Color)\n"
        /* 0484 */ "fn DrawCircleSectorLines*(center: Vector2, radius: real32, startAngle: real32, endAngle: real32, segments: int32, color: Color)\n"
        /* 0485 */ "fn DrawCircleGradient*(centerX: int32, centerY: int32, radius: real32, inner: Color, outer: Color)\n"
        /* 0486 */ "fn DrawCircleV*(center: Vector2, radius: real32, color: Color)\n"
        /* 0487 */ "fn DrawCircleLines*(centerX: int32, centerY: int32, radius: real32, color: Color)\n"
        /* 0488 */ "fn DrawCircleLinesV*(center: Vector2, radius: real32, color: Color)\n"
        /* 0489 */ "fn DrawEllipse*(centerX: int32, centerY: int32, radiusH: real32, radiusV: real32, color: Color)\n"
        /* 0490 */ "fn DrawEllipseV*(center: Vector2, radiusH: real32, radiusV: real32, color: Color)\n"
        /* 0491 */ "fn DrawEllipseLines*(centerX: int32, centerY: int32, radiusH: real32, radiusV: real32, color: Color)\n"
        /* 0492 */ "fn DrawEllipseLinesV*(center: Vector2, radiusH: real32, radiusV: real32, color: Color)\n"
        /* 0493 */ "fn DrawRing*(center: Vector2, innerRadius: real32, outerRadius: real32, startAngle: real32, endAngle: real32, segments: int32, color: Color)\n"
        /* 0494 */ "fn DrawRingLines*(center: Vector2, innerRadius: real32, outerRadius: real32, startAngle: real32, endAngle: real32, segments: int32, color: Color)\n"
        /* 0495 */ "fn DrawRectangle*(posX: int32, posY: int32, width: int32, height: int32, color: Color)\n"
        /* 0496 */ "fn DrawRectangleV*(position: Vector2, size: Vector2, color: Color)\n"
        /* 0497 */ "fn DrawRectangleRec*(rec: Rectangle, color: Color)\n"
        /* 0498 */ "fn DrawRectanglePro*(rec: Rectangle, origin: Vector2, rotation: real32, color: Color)\n"
        /* 0499 */ "fn DrawRectangleGradientV*(posX: int32, posY: int32, width: int32, height: int32, top: Color, bottom: Color)\n"
        /* 0500 */ "fn DrawRectangleGradientH*(posX: int32, posY: int32, width: int32, height: int32, left: Color, right: Color)\n"
        /* 0501 */ "fn DrawRectangleGradientEx*(rec: Rectangle, topLeft: Color, bottomLeft: Color, bottomRight: Color, topRight: Color)\n"
        /* 0502 */ "fn DrawRectangleLines*(posX: int32, posY: int32, width: int32, height: int32, color: Color)\n"
        /* 0503 */ "fn DrawRectangleLinesEx*(rec: Rectangle, lineThick: real32, color: Color)\n"
        /* 0504 */ "fn DrawRectangleRounded*(rec: Rectangle, roundness: real32, segments: int32, color: Color)\n"
        /* 0505 */ "fn DrawRectangleRoundedLines*(rec: Rectangle, roundness: real32, segments: int32, color: Color)\n"
        /* 0506 */ "fn DrawRectangleRoundedLinesEx*(rec: Rectangle, roundness: real32, segments: int32, lineThick: real32, color: Color)\n"
        /* 0507 */ "fn DrawTriangle*(v1: Vector2, v2: Vector2, v3: Vector2, color: Color)\n"
        /* 0508 */ "fn DrawTriangleLines*(v1: Vector2, v2: Vector2, v3: Vector2, color: Color)\n"
        /* 0509 */ "fn DrawTriangleFan*(points: const ^Vector2, pointCount: int32, color: Color)\n"
        /* 0510 */ "fn DrawTriangleStrip*(points: const ^Vector2, pointCount: int32, color: Color)\n"
        /* 0511 */ "fn DrawPoly*(center: Vector2, sides: int32, radius: real32, rotation: real32, color: Color)\n"
        /* 0512 */ "fn DrawPolyLines*(center: Vector2, sides: int32, radius: real32, rotation: real32, color: Color)\n"
        /* 0513 */ "fn DrawPolyLinesEx*(center: Vector2, sides: int32, radius: real32, rotation: real32, lineThick: real32, color: Color)\n"
        /* 0514 */ "fn DrawSplineLinear*(points: const ^Vector2, pointCount: int32, thick: real32, color: Color)\n"
        /* 0515 */ "fn DrawSplineBasis*(points: const ^Vector2, pointCount: int32, thick: real32, color: Color)\n"
        /* 0516 */ "fn DrawSplineCatmullRom*(points: const ^Vector2, pointCount: int32, thick: real32, color: Color)\n"
        /* 0517 */ "fn DrawSplineBezierQuadratic*(points: const ^Vector2, pointCount: int32, thick: real32, color: Color)\n"
        /* 0518 */ "fn DrawSplineBezierCubic*(points: const ^Vector2, pointCount: int32, thick: real32, color: Color)\n"
        /* 0519 */ "fn DrawSplineSegmentLinear*(p1: Vector2, p2: Vector2, thick: real32, color: Color)\n"
        /* 0520 */ "fn DrawSplineSegmentBasis*(p1: Vector2, p2: Vector2, p3: Vector2, p4: Vector2, thick: real32, color: Color)\n"
        /* 0521 */ "fn DrawSplineSegmentCatmullRom*(p1: Vector2, p2: Vector2, p3: Vector2, p4: Vector2, thick: real32, color: Color)\n"
        /* 0522 */ "fn DrawSplineSegmentBezierQuadratic*(p1: Vector2, c2: Vector2, p3: Vector2, thick: real32, color: Color)\n"
        /* 0523 */ "fn DrawSplineSegmentBezierCubic*(p1: Vector2, c2: Vector2, c3: Vector2, p4: Vector2, thick: real32, color: Color)\n"
        /* 0524 */ "fn GetSplinePointLinear*(startPos: Vector2, endPos: Vector2, t: real32): Vector2\n"
        /* 0525 */ "fn GetSplinePointBasis*(p1: Vector2, p2: Vector2, p3: Vector2, p4: Vector2, t: real32): Vector2\n"
        /* 0526 */ "fn GetSplinePointCatmullRom*(p1: Vector2, p2: Vector2, p3: Vector2, p4: Vector2, t: real32): Vector2\n"
        /* 0527 */ "fn GetSplinePointBezierQuad*(p1: Vector2, c2: Vector2, p3: Vector2, t: real32): Vector2\n"
        /* 0528 */ "fn GetSplinePointBezierCubic*(p1: Vector2, c2: Vector2, c3: Vector2, p4: Vector2, t: real32): Vector2\n"
        /* 0529 */ "fn CheckCollisionRecs*(rec1: Rectangle, rec2: Rectangle): bool\n"
        /* 0530 */ "fn CheckCollisionCircles*(center1: Vector2, radius1: real32, center2: Vector2, radius2: real32): bool\n"
        /* 0531 */ "fn CheckCollisionCircleRec*(center: Vector2, radius: real32, rec: Rectangle): bool\n"
        /* 0532 */ "fn CheckCollisionCircleLine*(center: Vector2, radius: real32, p1: Vector2, p2: Vector2): bool\n"
        /* 0533 */ "fn CheckCollisionPointRec*(point: Vector2, rec: Rectangle): bool\n"
        /* 0534 */ "fn CheckCollisionPointCircle*(point: Vector2, center: Vector2, radius: real32): bool\n"
        /* 0535 */ "fn CheckCollisionPointTriangle*(point: Vector2, p1: Vector2, p2: Vector2, p3: Vector2): bool\n"
        /* 0536 */ "fn CheckCollisionPointLine*(point: Vector2, p1: Vector2, p2: Vector2, threshold: int32): bool\n"
        /* 0537 */ "fn CheckCollisionPointPoly*(point: Vector2, points: const ^Vector2, pointCount: int32): bool\n"
        /* 0538 */ "fn CheckCollisionLines*(startPos1: Vector2, endPos1: Vector2, startPos2: Vector2, endPos2: Vector2, collisionPoint: ^Vector2): bool\n"
        /* 0539 */ "fn GetCollisionRec*(rec1: Rectangle, rec2: Rectangle): Rectangle\n"
        /* 0540 */ "fn LoadImage*(fileName: str): Image\n"
        /* 0541 */ "fn LoadImageRaw*(fileName: str, width: int32, height: int32, format: int32, headerSize: int32): Image\n"
        /* 0542 */ "fn LoadImageAnim*(fileName: str, frames: ^int32): Image\n"
        /* 0543 */ "fn LoadImageAnimFromMemory*(fileType: str, fileData: ^uint8, dataSize: int32, frames: ^int32): Image\n"
        /* 0544 */ "fn LoadImageFromMemory*(fileType: str, fileData: ^uint8, dataSize: int32): Image\n"
        /* 0545 */ "fn LoadImageFromTexture*(texture: Texture): Image\n"
        /* 0546 */ "fn LoadImageFromScreen*(): Image\n"
        /* 0547 */ "fn IsImageValid*(image: Image): bool\n"
        /* 0548 */ "fn UnloadImage*(image: Image)\n"
        /* 0549 */ "fn ExportImage*(image: Image, fileName: str): bool\n"
        /* 0550 */ "fn ExportImageToMemory*(image: Image, fileType: str, fileSize: ^int32): ^uint8\n"
        /* 0551 */ "fn ExportImageAsCode*(image: Image, fileName: str): bool\n"
        /* 0552 */ "fn GenImageColor*(width: int32, height: int32, color: Color): Image\n"
        /* 0553 */ "fn GenImageGradientLinear*(width: int32, height: int32, direction: int32, start: Color, end: Color): Image\n"
        /* 0554 */ "fn GenImageGradientRadial*(width: int32, height: int32, density: real32, inner: Color, outer: Color): Image\n"
        /* 0555 */ "fn GenImageGradientSquare*(width: int32, height: int32, density: real32, inner: Color, outer: Color): Image\n"
        /* 0556 */ "fn GenImageChecked*(width: int32, height: int32, checksX: int32, checksY: int32, col1: Color, col2: Color): Image\n"
        /* 0557 */ "fn GenImageWhiteNoise*(width: int32, height: int32, factor: real32): Image\n"
        /* 0558 */ "fn GenImagePerlinNoise*(width: int32, height: int32, offsetX: int32, offsetY: int32, scale: real32): Image\n"
        /* 0559 */ "fn GenImageCellular*(width: int32, height: int32, tileSize: int32): Image\n"
        /* 0560 */ "fn GenImageText*(width: int32, height: int32, text: str): Image\n"
        /* 0561 */ "fn ImageCopy*(image: Image): Image\n"
        /* 0562 */ "fn ImageFromImage*(image: Image, rec: Rectangle): Image\n"
        /* 0563 */ "fn ImageFromChannel*(image: Image, selectedChannel: int32): Image\n"
        /* 0564 */ "fn ImageText*(text: str, fontSize: int32, color: Color): Image\n"
        /* 0565 */ "fn ImageTextEx*(font: Font, text: str, fontSize: real32, spacing: real32, tint: Color): Image\n"
        /* 0566 */ "fn ImageFormat*(image: ^Image, newFormat: int32)\n"
        /* 0567 */ "fn ImageToPOT*(image: ^Image, fill: Color)\n"
        /* 0568 */ "fn ImageCrop*(image: ^Image, crop: Rectangle)\n"
        /* 0569 */ "fn ImageAlphaCrop*(image: ^Image, threshold: real32)\n"
        /* 0570 */ "fn ImageAlphaClear*(image: ^Image, color: Color, threshold: real32)\n"
        /* 0571 */ "fn ImageAlphaMask*(image: ^Image, alphaMask: Image)\n"
        /* 0572 */ "fn ImageAlphaPremultiply*(image: ^Image)\n"
        /* 0573 */ "fn ImageBlurGaussian*(image: ^Image, blurSize: int32)\n"
        /* 0574 */ "fn ImageKernelConvolution*(image: ^Image, kernel: ^real32, kernelSize: int32)\n"
        /* 0575 */ "fn ImageResize*(image: ^Image, newWidth: int32, newHeight: int32)\n"
        /* 0576 */ "fn ImageResizeNN*(image: ^Image, newWidth: int32, newHeight: int32)\n"
        /* 0577 */ "fn ImageResizeCanvas*(image: ^Image, newWidth: int32, newHeight: int32, offsetX: int32, offsetY: int32, fill: Color)\n"
        /* 0578 */ "fn ImageMipmaps*(image: ^Image)\n"
        /* 0579 */ "fn ImageDither*(image: ^Image, rBpp: int32, gBpp: int32, bBpp: int32, aBpp: int32)\n"
        /* 0580 */ "fn ImageFlipVertical*(image: ^Image)\n"
        /* 0581 */ "fn ImageFlipHorizontal*(image: ^Image)\n"
        /* 0582 */ "fn ImageRotate*(image: ^Image, degrees: int32)\n"
        /* 0583 */ "fn ImageRotateCW*(image: ^Image)\n"
        /* 0584 */ "fn ImageRotateCCW*(image: ^Image)\n"
        /* 0585 */ "fn ImageColorTint*(image: ^Image, color: Color)\n"
        /* 0586 */ "fn ImageColorInvert*(image: ^Image)\n"
        /* 0587 */ "fn ImageColorGrayscale*(image: ^Image)\n"
        /* 0588 */ "fn ImageColorContrast*(image: ^Image, contrast: real32)\n"
        /* 0589 */ "fn ImageColorBrightness*(image: ^Image, brightness: int32)\n"
        /* 0590 */ "fn ImageColorReplace*(image: ^Image, color: Color, replace: Color)\n"
        /* 0591 */ "fn LoadImageColors*(image: Image): ^Color\n"
        /* 0592 */ "fn LoadImagePalette*(image: Image, maxPaletteSize: int32, colorCount: ^int32): ^Color\n"
        /* 0593 */ "fn UnloadImageColors*(colors: ^Color)\n"
        /* 0594 */ "fn UnloadImagePalette*(colors: ^Color)\n"
        /* 0595 */ "fn GetImageAlphaBorder*(image: Image, threshold: real32): Rectangle\n"
        /* 0596 */ "fn GetImageColor*(image: Image, x: int32, y: int32): Color\n"
        /* 0597 */ "fn ImageClearBackground*(dst: ^Image, color: Color)\n"
        /* 0598 */ "fn ImageDrawPixel*(dst: ^Image, posX: int32, posY: int32, color: Color)\n"
        /* 0599 */ "fn ImageDrawPixelV*(dst: ^Image, position: Vector2, color: Color)\n"
        /* 0600 */ "fn ImageDrawLine*(dst: ^Image, startPosX: int32, startPosY: int32, endPosX: int32, endPosY: int32, color: Color)\n"
        /* 0601 */ "fn ImageDrawLineV*(dst: ^Image, start: Vector2, end: Vector2, color: Color)\n"
        /* 0602 */ "fn ImageDrawLineEx*(dst: ^Image, start: Vector2, end: Vector2, thick: int32, color: Color)\n"
        /* 0603 */ "fn ImageDrawCircle*(dst: ^Image, centerX: int32, centerY: int32, radius: int32, color: Color)\n"
        /* 0604 */ "fn ImageDrawCircleV*(dst: ^Image, center: Vector2, radius: int32, color: Color)\n"
        /* 0605 */ "fn ImageDrawCircleLines*(dst: ^Image, centerX: int32, centerY: int32, radius: int32, color: Color)\n"
        /* 0606 */ "fn ImageDrawCircleLinesV*(dst: ^Image, center: Vector2, radius: int32, color: Color)\n"
        /* 0607 */ "fn ImageDrawRectangle*(dst: ^Image, posX: int32, posY: int32, width: int32, height: int32, color: Color)\n"
        /* 0608 */ "fn ImageDrawRectangleV*(dst: ^Image, position: Vector2, size: Vector2, color: Color)\n"
        /* 0609 */ "fn ImageDrawRectangleRec*(dst: ^Image, rec: Rectangle, color: Color)\n"
        /* 0610 */ "fn ImageDrawRectangleLines*(dst: ^Image, rec: Rectangle, thick: int32, color: Color)\n"
        /* 0611 */ "fn ImageDrawTriangle*(dst: ^Image, v1: Vector2, v2: Vector2, v3: Vector2, color: Color)\n"
        /* 0612 */ "fn ImageDrawTriangleEx*(dst: ^Image, v1: Vector2, v2: Vector2, v3: Vector2, c1: Color, c2: Color, c3: Color)\n"
        /* 0613 */ "fn ImageDrawTriangleLines*(dst: ^Image, v1: Vector2, v2: Vector2, v3: Vector2, color: Color)\n"
        /* 0614 */ "fn ImageDrawTriangleFan*(dst: ^Image, points: const ^Vector2, pointCount: int32, color: Color)\n"
        /* 0615 */ "fn ImageDrawTriangleStrip*(dst: ^Image, points: const ^Vector2, pointCount: int32, color: Color)\n"
        /* 0616 */ "fn ImageDraw*(dst: ^Image, src: Image, srcRec: Rectangle, dstRec: Rectangle, tint: Color)\n"
        /* 0617 */ "fn ImageDrawText*(dst: ^Image, text: str, posX: int32, posY: int32, fontSize: int32, color: Color)\n"
        /* 0618 */ "fn ImageDrawTextEx*(dst: ^Image, font: Font, text: str, position: Vector2, fontSize: real32, spacing: real32, tint: Color)\n"
        /* 0619 */ "fn LoadTexture*(fileName: str): Texture\n"
        /* 0620 */ "fn LoadTextureFromImage*(image: Image): Texture\n"
        /* 0621 */ "fn LoadTextureCubemap*(image: Image, layout: int32): Texture\n"
        /* 0622 */ "fn LoadRenderTexture*(width: int32, height: int32): RenderTexture\n"
        /* 0623 */ "fn IsTextureValid*(texture: Texture): bool\n"
        /* 0624 */ "fn UnloadTexture*(texture: Texture)\n"
        /* 0625 */ "fn IsRenderTextureValid*(target: RenderTexture): bool\n"
        /* 0626 */ "fn UnloadRenderTexture*(target: RenderTexture)\n"
        /* 0627 */ "fn UpdateTexture*(texture: Texture, pixels: ^void)\n"
        /* 0628 */ "fn UpdateTextureRec*(texture: Texture, rec: Rectangle, pixels: ^void)\n"
        /* 0629 */ "fn GenTextureMipmaps*(texture: ^Texture)\n"
        /* 0630 */ "fn SetTextureFilter*(texture: Texture, filter: int32)\n"
        /* 0631 */ "fn SetTextureWrap*(texture: Texture, wrap: int32)\n"
        /* 0632 */ "fn DrawTexture*(texture: Texture, posX: int32, posY: int32, tint: Color)\n"
        /* 0633 */ "fn DrawTextureV*(texture: Texture, position: Vector2, tint: Color)\n"
        /* 0634 */ "fn DrawTextureEx*(texture: Texture, position: Vector2, rotation: real32, scale: real32, tint: Color)\n"
        /* 0635 */ "fn DrawTextureRec*(texture: Texture, source: Rectangle, position: Vector2, tint: Color)\n"
        /* 0636 */ "fn DrawTexturePro*(texture: Texture, source: Rectangle, dest: Rectangle, origin: Vector2, rotation: real32, tint: Color)\n"
        /* 0637 */ "fn DrawTextureNPatch*(texture: Texture, nPatchInfo: NPatchInfo, dest: Rectangle, origin: Vector2, rotation: real32, tint: Color)\n"
        /* 0638 */ "fn ColorIsEqual*(col1: Color, col2: Color): bool\n"
        /* 0639 */ "fn Fade*(color: Color, alpha: real32): Color\n"
        /* 0640 */ "fn ColorToInt*(color: Color): int32\n"
        /* 0641 */ "fn ColorNormalize*(color: Color): Vector4\n"
        /* 0642 */ "fn ColorFromNormalized*(normalized: Vector4): Color\n"
        /* 0643 */ "fn ColorToHSV*(color: Color): Vector3\n"
        /* 0644 */ "fn ColorFromHSV*(hue: real32, saturation: real32, value: real32): Color\n"
        /* 0645 */ "fn ColorTint*(color: Color, tint: Color): Color\n"
        /* 0646 */ "fn ColorBrightness*(color: Color, factor: real32): Color\n"
        /* 0647 */ "fn ColorContrast*(color: Color, contrast: real32): Color\n"
        /* 0648 */ "fn ColorAlpha*(color: Color, alpha: real32): Color\n"
        /* 0649 */ "fn ColorAlphaBlend*(dst: Color, src: Color, tint: Color): Color\n"
        /* 0650 */ "fn ColorLerp*(color1: Color, color2: Color, factor: real32): Color\n"
        /* 0651 */ "fn GetColor*(hexValue: uint32): Color\n"
        /* 0652 */ "fn GetPixelColor*(srcPtr: ^void, format: int32): Color\n"
        /* 0653 */ "fn SetPixelColor*(dstPtr: ^void, color: Color, format: int32)\n"
        /* 0654 */ "fn GetPixelDataSize*(width: int32, height: int32, format: int32): int32\n"
        /* 0655 */ "fn GetFontDefault*(): Font\n"
        /* 0656 */ "fn LoadFont*(fileName: str): Font\n"
        /* 0657 */ "fn LoadFontEx*(fileName: str, fontSize: int32, codepoints: ^int32, codepointCount: int32): Font\n"
        /* 0658 */ "fn LoadFontFromImage*(image: Image, key: Color, firstChar: int32): Font\n"
        /* 0659 */ "fn LoadFontFromMemory*(fileType: str, fileData: ^uint8, dataSize: int32, fontSize: int32, codepoints: ^int32, codepointCount: int32): Font\n"
        /* 0660 */ "fn IsFontValid*(font: Font): bool\n"
        // Skipping LoadFontData
        /* 0661 */ "fn GenImageFontAtlas*(glyphs: ^void, glyphRecs: ^void, glyphCount: int32, fontSize: int32, padding: int32, packMethod: int32): Image\n"
        /* 0662 */ "fn UnloadFontData*(glyphs: ^GlyphInfo, glyphCount: int32)\n"
        /* 0663 */ "fn UnloadFont*(font: Font)\n"
        /* 0664 */ "fn ExportFontAsCode*(font: Font, fileName: str): bool\n"
        /* 0665 */ "fn DrawFPS*(posX: int32, posY: int32)\n"
        /* 0666 */ "fn DrawText*(text: str, posX: int32, posY: int32, fontSize: int32, color: Color)\n"
        /* 0667 */ "fn DrawTextEx*(font: Font, text: str, position: Vector2, fontSize: real32, spacing: real32, tint: Color)\n"
        /* 0668 */ "fn DrawTextPro*(font: Font, text: str, position: Vector2, origin: Vector2, rotation: real32, fontSize: real32, spacing: real32, tint: Color)\n"
        /* 0669 */ "fn DrawTextCodepoint*(font: Font, codepoint: int32, position: Vector2, fontSize: real32, tint: Color)\n"
        /* 0670 */ "fn DrawTextCodepoints*(font: Font, codepoints: ^int32, codepointCount: int32, position: Vector2, fontSize: real32, spacing: real32, tint: Color)\n"
        /* 0671 */ "fn SetTextLineSpacing*(spacing: int32)\n"
        /* 0672 */ "fn MeasureText*(text: str, fontSize: int32): int32\n"
        /* 0673 */ "fn MeasureTextEx*(font: Font, text: str, fontSize: real32, spacing: real32): Vector2\n"
        /* 0674 */ "fn MeasureTextCodepoints*(font: Font, codepoints: ^int32, length: int32, fontSize: real32, spacing: real32): Vector2\n"
        /* 0675 */ "fn GetGlyphIndex*(font: Font, codepoint: int32): int32\n"
        /* 0676 */ "fn GetGlyphInfo*(font: Font, codepoint: int32): GlyphInfo\n"
        /* 0677 */ "fn GetGlyphAtlasRec*(font: Font, codepoint: int32): Rectangle\n"
        /* 0678 */ "fn LoadUTF8*(codepoints: ^int32, length: int32): str\n"
        /* 0679 */ "fn UnloadUTF8*(text: str)\n"
        /* 0680 */ "fn LoadCodepoints*(text: str, count: ^int32): ^int32\n"
        /* 0681 */ "fn UnloadCodepoints*(codepoints: ^int32)\n"
        /* 0682 */ "fn GetCodepointCount*(text: str): int32\n"
        /* 0683 */ "fn GetCodepoint*(text: str, codepointSize: ^int32): int32\n"
        /* 0684 */ "fn GetCodepointNext*(text: str, codepointSize: ^int32): int32\n"
        /* 0685 */ "fn GetCodepointPrevious*(text: str, codepointSize: ^int32): int32\n"
        /* 0686 */ "fn CodepointToUTF8*(codepoint: int32, utf8Size: ^int32): str\n"
        /* 0687 */ "fn LoadTextLines*(text: str, count: ^int32): ^str\n"
        /* 0688 */ "fn UnloadTextLines*(text: ^str, lineCount: int32)\n"
        /* 0689 */ "fn TextCopy*(dst: str, src: str): int32\n"
        /* 0690 */ "fn TextIsEqual*(text1: str, text2: str): bool\n"
        /* 0691 */ "fn TextLength*(text: str): uint32\n"
        // Skipping TextFormat
        /* 0692 */ "fn TextSubtext*(text: str, position: int32, length: int32): str\n"
        /* 0693 */ "fn TextRemoveSpaces*(text: str): str\n"
        /* 0694 */ "fn GetTextBetween*(text: str, begin: str, end: str): str\n"
        /* 0695 */ "fn TextReplace*(text: str, search: str, replacement: str): str\n"
        /* 0696 */ "fn TextReplaceBetween*(text: str, begin: str, end: str, replacement: str): str\n"
        /* 0697 */ "fn TextInsert*(text: str, insert: str, position: int32): str\n"
        /* 0698 */ "fn TextJoin*(textList: ^str, count: int32, delimiter: str): str\n"
        /* 0699 */ "fn TextSplit*(text: str, delimiter: char, count: ^int32): ^str\n"
        /* 0700 */ "fn TextAppend*(text: str, append: str, position: ^int32)\n"
        /* 0701 */ "fn TextFindIndex*(text: str, search: str): int32\n"
        /* 0702 */ "fn TextToUpper*(text: str): str\n"
        /* 0703 */ "fn TextToLower*(text: str): str\n"
        /* 0704 */ "fn TextToPascal*(text: str): str\n"
        /* 0705 */ "fn TextToSnake*(text: str): str\n"
        /* 0706 */ "fn TextToCamel*(text: str): str\n"
        /* 0707 */ "fn TextToInteger*(text: str): int32\n"
        /* 0708 */ "fn TextToFloat*(text: str): real32\n"
        /* 0709 */ "fn DrawLine3D*(startPos: Vector3, endPos: Vector3, color: Color)\n"
        /* 0710 */ "fn DrawPoint3D*(position: Vector3, color: Color)\n"
        /* 0711 */ "fn DrawCircle3D*(center: Vector3, radius: real32, rotationAxis: Vector3, rotationAngle: real32, color: Color)\n"
        /* 0712 */ "fn DrawTriangle3D*(v1: Vector3, v2: Vector3, v3: Vector3, color: Color)\n"
        /* 0713 */ "fn DrawTriangleStrip3D*(points: ^const Vector3, pointCount: int32, color: Color)\n"
        /* 0714 */ "fn DrawCube*(position: Vector3, width: real32, height: real32, length: real32, color: Color)\n"
        /* 0715 */ "fn DrawCubeV*(position: Vector3, size: Vector3, color: Color)\n"
        /* 0716 */ "fn DrawCubeWires*(position: Vector3, width: real32, height: real32, length: real32, color: Color)\n"
        /* 0717 */ "fn DrawCubeWiresV*(position: Vector3, size: Vector3, color: Color)\n"
        /* 0718 */ "fn DrawSphere*(centerPos: Vector3, radius: real32, color: Color)\n"
        /* 0719 */ "fn DrawSphereEx*(centerPos: Vector3, radius: real32, rings: int32, slices: int32, color: Color)\n"
        /* 0720 */ "fn DrawSphereWires*(centerPos: Vector3, radius: real32, rings: int32, slices: int32, color: Color)\n"
        /* 0721 */ "fn DrawCylinder*(position: Vector3, radiusTop: real32, radiusBottom: real32, height: real32, slices: int32, color: Color)\n"
        /* 0722 */ "fn DrawCylinderEx*(startPos: Vector3, endPos: Vector3, startRadius: real32, endRadius: real32, sides: int32, color: Color)\n"
        /* 0723 */ "fn DrawCylinderWires*(position: Vector3, radiusTop: real32, radiusBottom: real32, height: real32, slices: int32, color: Color)\n"
        /* 0724 */ "fn DrawCylinderWiresEx*(startPos: Vector3, endPos: Vector3, startRadius: real32, endRadius: real32, sides: int32, color: Color)\n"
        /* 0725 */ "fn DrawCapsule*(startPos: Vector3, endPos: Vector3, radius: real32, slices: int32, rings: int32, color: Color)\n"
        /* 0726 */ "fn DrawCapsuleWires*(startPos: Vector3, endPos: Vector3, radius: real32, slices: int32, rings: int32, color: Color)\n"
        /* 0727 */ "fn DrawPlane*(centerPos: Vector3, size: Vector2, color: Color)\n"
        /* 0728 */ "fn DrawRay*(ray: Ray, color: Color)\n"
        /* 0729 */ "fn DrawGrid*(slices: int32, spacing: real32)\n"
        /* 0730 */ "fn LoadModel*(fileName: str): Model\n"
        /* 0731 */ "fn LoadModelFromMesh*(mesh: Mesh): Model\n"
        /* 0732 */ "fn IsModelValid*(model: Model): bool\n"
        /* 0733 */ "fn UnloadModel*(model: Model)\n"
        /* 0734 */ "fn GetModelBoundingBox*(model: Model): BoundingBox\n"
        /* 0735 */ "fn DrawModel*(model: Model, position: Vector3, scale: real32, tint: Color)\n"
        /* 0736 */ "fn DrawModelEx*(model: Model, position: Vector3, rotationAxis: Vector3, rotationAngle: real32, scale: Vector3, tint: Color)\n"
        /* 0737 */ "fn DrawModelWires*(model: Model, position: Vector3, scale: real32, tint: Color)\n"
        /* 0738 */ "fn DrawModelWiresEx*(model: Model, position: Vector3, rotationAxis: Vector3, rotationAngle: real32, scale: Vector3, tint: Color)\n"
        /* 0739 */ "fn DrawModelPoints*(model: Model, position: Vector3, scale: real32, tint: Color)\n"
        /* 0740 */ "fn DrawModelPointsEx*(model: Model, position: Vector3, rotationAxis: Vector3, rotationAngle: real32, scale: Vector3, tint: Color)\n"
        /* 0741 */ "fn DrawBoundingBox*(box: BoundingBox, color: Color)\n"
        /* 0742 */ "fn DrawBillboard*(camera: Camera3D, texture: Texture, position: Vector3, scale: real32, tint: Color)\n"
        /* 0743 */ "fn DrawBillboardRec*(camera: Camera3D, texture: Texture, source: Rectangle, position: Vector3, size: Vector2, tint: Color)\n"
        /* 0744 */ "fn DrawBillboardPro*(camera: Camera3D, texture: Texture, source: Rectangle, position: Vector3, up: Vector3, size: Vector2, origin: Vector2, rotation: real32, tint: Color)\n"
        /* 0745 */ "fn UploadMesh*(mesh: ^Mesh, dynamic: bool)\n"
        /* 0746 */ "fn UpdateMeshBuffer*(mesh: Mesh, index: int32, data: ^void, dataSize: int32, offset: int32)\n"
        /* 0747 */ "fn UnloadMesh*(mesh: Mesh)\n"
        /* 0748 */ "fn DrawMesh*(mesh: Mesh, material: Material, transform: Matrix)\n"
        /* 0749 */ "fn DrawMeshInstanced*(mesh: Mesh, material: Material, transforms: ^Matrix, instances: int32)\n"
        /* 0750 */ "fn GetMeshBoundingBox*(mesh: Mesh): BoundingBox\n"
        /* 0751 */ "fn GenMeshTangents*(mesh: ^Mesh)\n"
        /* 0752 */ "fn ExportMesh*(mesh: Mesh, fileName: str): bool\n"
        /* 0753 */ "fn ExportMeshAsCode*(mesh: Mesh, fileName: str): bool\n"
        /* 0754 */ "fn GenMeshPoly*(sides: int32, radius: real32): Mesh\n"
        /* 0755 */ "fn GenMeshPlane*(width: real32, length: real32, resX: int32, resZ: int32): Mesh\n"
        /* 0756 */ "fn GenMeshCube*(width: real32, height: real32, length: real32): Mesh\n"
        /* 0757 */ "fn GenMeshSphere*(radius: real32, rings: int32, slices: int32): Mesh\n"
        /* 0758 */ "fn GenMeshHemiSphere*(radius: real32, rings: int32, slices: int32): Mesh\n"
        /* 0759 */ "fn GenMeshCylinder*(radius: real32, height: real32, slices: int32): Mesh\n"
        /* 0760 */ "fn GenMeshCone*(radius: real32, height: real32, slices: int32): Mesh\n"
        /* 0761 */ "fn GenMeshTorus*(radius: real32, size: real32, radSeg: int32, sides: int32): Mesh\n"
        /* 0762 */ "fn GenMeshKnot*(radius: real32, size: real32, radSeg: int32, sides: int32): Mesh\n"
        /* 0763 */ "fn GenMeshHeightmap*(heightmap: Image, size: Vector3): Mesh\n"
        /* 0764 */ "fn GenMeshCubicmap*(cubicmap: Image, cubeSize: Vector3): Mesh\n"
        /* 0765 */ "fn LoadMaterials*(fileName: str, materialCount: ^int32): ^Material\n"
        /* 0766 */ "fn LoadMaterialDefault*(): Material\n"
        /* 0767 */ "fn IsMaterialValid*(material: Material): bool\n"
        /* 0768 */ "fn UnloadMaterial*(material: Material)\n"
        /* 0769 */ "fn SetMaterialTexture*(material: ^Material, mapType: int32, texture: Texture)\n"
        /* 0770 */ "fn SetModelMeshMaterial*(model: ^Model, meshId: int32, materialId: int32)\n"
        /* 0771 */ "fn LoadModelAnimations*(fileName: str, animCount: ^int32): ^ModelAnimation\n"
        /* 0772 */ "fn UpdateModelAnimation*(model: Model, anim: ModelAnimation, frame: real32)\n"
        /* 0773 */ "fn UpdateModelAnimationEx*(model: Model, animA: ModelAnimation, frameA: real32, animB: ModelAnimation, frameB: real32, blend: real32)\n"
        /* 0774 */ "fn UnloadModelAnimations*(animations: ^ModelAnimation, animCount: int32)\n"
        /* 0775 */ "fn IsModelAnimationValid*(model: Model, anim: ModelAnimation): bool\n"
        /* 0776 */ "fn CheckCollisionSpheres*(center1: Vector3, radius1: real32, center2: Vector3, radius2: real32): bool\n"
        /* 0777 */ "fn CheckCollisionBoxes*(box1: BoundingBox, box2: BoundingBox): bool\n"
        /* 0778 */ "fn CheckCollisionBoxSphere*(box: BoundingBox, center: Vector3, radius: real32): bool\n"
        /* 0779 */ "fn GetRayCollisionSphere*(ray: Ray, center: Vector3, radius: real32): RayCollision\n"
        /* 0780 */ "fn GetRayCollisionBox*(ray: Ray, box: BoundingBox): RayCollision\n"
        /* 0781 */ "fn GetRayCollisionMesh*(ray: Ray, mesh: Mesh, transform: Matrix): RayCollision\n"
        /* 0782 */ "fn GetRayCollisionTriangle*(ray: Ray, p1: Vector3, p2: Vector3, p3: Vector3): RayCollision\n"
        /* 0783 */ "fn GetRayCollisionQuad*(ray: Ray, p1: Vector3, p2: Vector3, p3: Vector3, p4: Vector3): RayCollision\n"
        /* 0784 */ "fn InitAudioDevice*()\n"
        /* 0785 */ "fn CloseAudioDevice*()\n"
        /* 0786 */ "fn IsAudioDeviceReady*(): bool\n"
        /* 0787 */ "fn SetMasterVolume*(volume: real32)\n"
        /* 0788 */ "fn GetMasterVolume*(): real32\n"
        /* 0789 */ "fn LoadWave*(fileName: str): Wave\n"
        /* 0790 */ "fn LoadWaveFromMemory*(fileType: str, fileData: ^uint8, dataSize: int32): Wave\n"
        /* 0791 */ "fn IsWaveValid*(wave: Wave): bool\n"
        /* 0792 */ "fn LoadSound*(fileName: str): Sound\n"
        /* 0793 */ "fn LoadSoundFromWave*(wave: Wave): Sound\n"
        /* 0794 */ "fn LoadSoundAlias*(source: Sound): Sound\n"
        /* 0795 */ "fn IsSoundValid*(sound: Sound): bool\n"
        /* 0796 */ "fn UpdateSound*(sound: Sound, data: ^void, sampleCount: int32)\n"
        /* 0797 */ "fn UnloadWave*(wave: Wave)\n"
        /* 0798 */ "fn UnloadSound*(sound: Sound)\n"
        /* 0799 */ "fn UnloadSoundAlias*(alias: Sound)\n"
        /* 0800 */ "fn ExportWave*(wave: Wave, fileName: str): bool\n"
        /* 0801 */ "fn ExportWaveAsCode*(wave: Wave, fileName: str): bool\n"
        /* 0802 */ "fn PlaySound*(sound: Sound)\n"
        /* 0803 */ "fn StopSound*(sound: Sound)\n"
        /* 0804 */ "fn PauseSound*(sound: Sound)\n"
        /* 0805 */ "fn ResumeSound*(sound: Sound)\n"
        /* 0806 */ "fn IsSoundPlaying*(sound: Sound): bool\n"
        /* 0807 */ "fn SetSoundVolume*(sound: Sound, volume: real32)\n"
        /* 0808 */ "fn SetSoundPitch*(sound: Sound, pitch: real32)\n"
        /* 0809 */ "fn SetSoundPan*(sound: Sound, pan: real32)\n"
        /* 0810 */ "fn WaveCopy*(wave: Wave): Wave\n"
        /* 0811 */ "fn WaveCrop*(wave: ^Wave, initFrame: int32, finalFrame: int32)\n"
        /* 0812 */ "fn WaveFormat*(wave: ^Wave, sampleRate: int32, sampleSize: int32, channels: int32)\n"
        /* 0813 */ "fn LoadWaveSamples*(wave: Wave): ^real32\n"
        /* 0814 */ "fn UnloadWaveSamples*(samples: ^real32)\n"
        /* 0815 */ "fn LoadMusicStream*(fileName: str): Music\n"
        /* 0816 */ "fn LoadMusicStreamFromMemory*(fileType: str, data: ^uint8, dataSize: int32): Music\n"
        /* 0817 */ "fn IsMusicValid*(music: Music): bool\n"
        /* 0818 */ "fn UnloadMusicStream*(music: Music)\n"
        /* 0819 */ "fn PlayMusicStream*(music: Music)\n"
        /* 0820 */ "fn IsMusicStreamPlaying*(music: Music): bool\n"
        /* 0821 */ "fn UpdateMusicStream*(music: Music)\n"
        /* 0822 */ "fn StopMusicStream*(music: Music)\n"
        /* 0823 */ "fn PauseMusicStream*(music: Music)\n"
        /* 0824 */ "fn ResumeMusicStream*(music: Music)\n"
        /* 0825 */ "fn SeekMusicStream*(music: Music, position: real32)\n"
        /* 0826 */ "fn SetMusicVolume*(music: Music, volume: real32)\n"
        /* 0827 */ "fn SetMusicPitch*(music: Music, pitch: real32)\n"
        /* 0828 */ "fn SetMusicPan*(music: Music, pan: real32)\n"
        /* 0829 */ "fn GetMusicTimeLength*(music: Music): real32\n"
        /* 0830 */ "fn GetMusicTimePlayed*(music: Music): real32\n"
        /* 0831 */ "fn LoadAudioStream*(sampleRate: uint32, sampleSize: uint32, channels: uint32): AudioStream\n"
        /* 0832 */ "fn IsAudioStreamValid*(stream: AudioStream): bool\n"
        /* 0833 */ "fn UnloadAudioStream*(stream: AudioStream)\n"
        /* 0834 */ "fn UpdateAudioStream*(stream: AudioStream, data: ^void, frameCount: int32)\n"
        /* 0835 */ "fn IsAudioStreamProcessed*(stream: AudioStream): bool\n"
        /* 0836 */ "fn PlayAudioStream*(stream: AudioStream)\n"
        /* 0837 */ "fn PauseAudioStream*(stream: AudioStream)\n"
        /* 0838 */ "fn ResumeAudioStream*(stream: AudioStream)\n"
        /* 0839 */ "fn IsAudioStreamPlaying*(stream: AudioStream): bool\n"
        /* 0840 */ "fn StopAudioStream*(stream: AudioStream)\n"
        /* 0841 */ "fn SetAudioStreamVolume*(stream: AudioStream, volume: real32)\n"
        /* 0842 */ "fn SetAudioStreamPitch*(stream: AudioStream, pitch: real32)\n"
        /* 0843 */ "fn SetAudioStreamPan*(stream: AudioStream, pan: real32)\n"
        /* 0844 */ "fn SetAudioStreamBufferSizeDefault*(size: int32)\n"
        // Skipping SetAudioStreamCallback
        // Skipping AttachAudioStreamProcessor
        // Skipping DetachAudioStreamProcessor
        /* 0845 */ "fn AttachAudioMixedProcessor*(processor: AudioCallback)\n"
        /* 0846 */ "fn DetachAudioMixedProcessor*(processor: AudioCallback)\n"
        /* 0847 */ "fn Clamp*(value: real32, min: real32, max: real32): real32\n"
        /* 0848 */ "fn Lerp*(start: real32, end: real32, amount: real32): real32\n"
        /* 0849 */ "fn Normalize*(value: real32, start: real32, end: real32): real32\n"
        /* 0850 */ "fn Remap*(value: real32, inputStart: real32, inputEnd: real32, outputStart: real32, outputEnd: real32): real32\n"
        /* 0851 */ "fn Wrap*(value: real32, min: real32, max: real32): real32\n"
        /* 0852 */ "fn FloatEquals*(x: real32, y: real32): int32\n"
        /* 0853 */ "fn Vector2Zero*(): Vector2\n"
        /* 0854 */ "fn Vector2One*(): Vector2\n"
        /* 0855 */ "fn Vector2Add*(v1: Vector2, v2: Vector2): Vector2\n"
        /* 0856 */ "fn Vector2AddValue*(v: Vector2, add: real32): Vector2\n"
        /* 0857 */ "fn Vector2Subtract*(v1: Vector2, v2: Vector2): Vector2\n"
        /* 0858 */ "fn Vector2SubtractValue*(v: Vector2, sub: real32): Vector2\n"
        /* 0859 */ "fn Vector2Length*(v: Vector2): real32\n"
        /* 0860 */ "fn Vector2LengthSqr*(v: Vector2): real32\n"
        /* 0861 */ "fn Vector2DotProduct*(v1: Vector2, v2: Vector2): real32\n"
        /* 0862 */ "fn Vector2CrossProduct*(v1: Vector2, v2: Vector2): real32\n"
        /* 0863 */ "fn Vector2Distance*(v1: Vector2, v2: Vector2): real32\n"
        /* 0864 */ "fn Vector2DistanceSqr*(v1: Vector2, v2: Vector2): real32\n"
        /* 0865 */ "fn Vector2Angle*(v1: Vector2, v2: Vector2): real32\n"
        /* 0866 */ "fn Vector2LineAngle*(start: Vector2, end: Vector2): real32\n"
        /* 0867 */ "fn Vector2Scale*(v: Vector2, scale: real32): Vector2\n"
        /* 0868 */ "fn Vector2Multiply*(v1: Vector2, v2: Vector2): Vector2\n"
        /* 0869 */ "fn Vector2Negate*(v: Vector2): Vector2\n"
        /* 0870 */ "fn Vector2Divide*(v1: Vector2, v2: Vector2): Vector2\n"
        /* 0871 */ "fn Vector2Normalize*(v: Vector2): Vector2\n"
        /* 0872 */ "fn Vector2Transform*(v: Vector2, mat: Matrix): Vector2\n"
        /* 0873 */ "fn Vector2Lerp*(v1: Vector2, v2: Vector2, amount: real32): Vector2\n"
        /* 0874 */ "fn Vector2Reflect*(v: Vector2, normal: Vector2): Vector2\n"
        /* 0875 */ "fn Vector2Min*(v1: Vector2, v2: Vector2): Vector2\n"
        /* 0876 */ "fn Vector2Max*(v1: Vector2, v2: Vector2): Vector2\n"
        /* 0877 */ "fn Vector2Rotate*(v: Vector2, angle: real32): Vector2\n"
        /* 0878 */ "fn Vector2MoveTowards*(v: Vector2, target: Vector2, maxDistance: real32): Vector2\n"
        /* 0879 */ "fn Vector2Invert*(v: Vector2): Vector2\n"
        /* 0880 */ "fn Vector2Clamp*(v: Vector2, min: Vector2, max: Vector2): Vector2\n"
        /* 0881 */ "fn Vector2ClampValue*(v: Vector2, min: real32, max: real32): Vector2\n"
        /* 0882 */ "fn Vector2Equals*(p: Vector2, q: Vector2): int32\n"
        /* 0883 */ "fn Vector2Refract*(v: Vector2, n: Vector2, r: real32): Vector2\n"
        /* 0884 */ "fn Vector3Zero*(): Vector3\n"
        /* 0885 */ "fn Vector3One*(): Vector3\n"
        /* 0886 */ "fn Vector3Add*(v1: Vector3, v2: Vector3): Vector3\n"
        /* 0887 */ "fn Vector3AddValue*(v: Vector3, add: real32): Vector3\n"
        /* 0888 */ "fn Vector3Subtract*(v1: Vector3, v2: Vector3): Vector3\n"
        /* 0889 */ "fn Vector3SubtractValue*(v: Vector3, sub: real32): Vector3\n"
        /* 0890 */ "fn Vector3Scale*(v: Vector3, scalar: real32): Vector3\n"
        /* 0891 */ "fn Vector3Multiply*(v1: Vector3, v2: Vector3): Vector3\n"
        /* 0892 */ "fn Vector3CrossProduct*(v1: Vector3, v2: Vector3): Vector3\n"
        /* 0893 */ "fn Vector3Perpendicular*(v: Vector3): Vector3\n"
        /* 0894 */ "fn Vector3Length*(v: const Vector3): real32\n"
        /* 0895 */ "fn Vector3LengthSqr*(v: const Vector3): real32\n"
        /* 0896 */ "fn Vector3DotProduct*(v1: Vector3, v2: Vector3): real32\n"
        /* 0897 */ "fn Vector3Distance*(v1: Vector3, v2: Vector3): real32\n"
        /* 0898 */ "fn Vector3DistanceSqr*(v1: Vector3, v2: Vector3): real32\n"
        /* 0899 */ "fn Vector3Angle*(v1: Vector3, v2: Vector3): real32\n"
        /* 0900 */ "fn Vector3Negate*(v: Vector3): Vector3\n"
        /* 0901 */ "fn Vector3Divide*(v1: Vector3, v2: Vector3): Vector3\n"
        /* 0902 */ "fn Vector3Normalize*(v: Vector3): Vector3\n"
        /* 0903 */ "fn Vector3Project*(v1: Vector3, v2: Vector3): Vector3\n"
        /* 0904 */ "fn Vector3Reject*(v1: Vector3, v2: Vector3): Vector3\n"
        /* 0905 */ "fn Vector3OrthoNormalize*(v1: ^Vector3, v2: ^Vector3)\n"
        /* 0906 */ "fn Vector3Transform*(v: Vector3, mat: Matrix): Vector3\n"
        /* 0907 */ "fn Vector3RotateByQuaternion*(v: Vector3, q: Vector4): Vector3\n"
        /* 0908 */ "fn Vector3RotateByAxisAngle*(v: Vector3, axis: Vector3, angle: real32): Vector3\n"
        /* 0909 */ "fn Vector3MoveTowards*(v: Vector3, target: Vector3, maxDistance: real32): Vector3\n"
        /* 0910 */ "fn Vector3Lerp*(v1: Vector3, v2: Vector3, amount: real32): Vector3\n"
        /* 0911 */ "fn Vector3CubicHermite*(v1: Vector3, tangent1: Vector3, v2: Vector3, tangent2: Vector3, amount: real32): Vector3\n"
        /* 0912 */ "fn Vector3Reflect*(v: Vector3, normal: Vector3): Vector3\n"
        /* 0913 */ "fn Vector3Min*(v1: Vector3, v2: Vector3): Vector3\n"
        /* 0914 */ "fn Vector3Max*(v1: Vector3, v2: Vector3): Vector3\n"
        /* 0915 */ "fn Vector3Barycenter*(p: Vector3, a: Vector3, b: Vector3, c: Vector3): Vector3\n"
        /* 0916 */ "fn Vector3Unproject*(source: Vector3, projection: Matrix, view: Matrix): Vector3\n"
        /* 0917 */ "fn Vector3ToFloatV*(v: Vector3): float3\n"
        /* 0918 */ "fn Vector3Invert*(v: Vector3): Vector3\n"
        /* 0919 */ "fn Vector3Clamp*(v: Vector3, min: Vector3, max: Vector3): Vector3\n"
        /* 0920 */ "fn Vector3ClampValue*(v: Vector3, min: real32, max: real32): Vector3\n"
        /* 0921 */ "fn Vector3Equals*(p: Vector3, q: Vector3): int32\n"
        /* 0922 */ "fn Vector3Refract*(v: Vector3, n: Vector3, r: real32): Vector3\n"
        /* 0923 */ "fn Vector4Zero*(): Vector4\n"
        /* 0924 */ "fn Vector4One*(): Vector4\n"
        /* 0925 */ "fn Vector4Add*(v1: Vector4, v2: Vector4): Vector4\n"
        /* 0926 */ "fn Vector4AddValue*(v: Vector4, add: real32): Vector4\n"
        /* 0927 */ "fn Vector4Subtract*(v1: Vector4, v2: Vector4): Vector4\n"
        /* 0928 */ "fn Vector4SubtractValue*(v: Vector4, add: real32): Vector4\n"
        /* 0929 */ "fn Vector4Length*(v: Vector4): real32\n"
        /* 0930 */ "fn Vector4LengthSqr*(v: Vector4): real32\n"
        /* 0931 */ "fn Vector4DotProduct*(v1: Vector4, v2: Vector4): real32\n"
        /* 0932 */ "fn Vector4Distance*(v1: Vector4, v2: Vector4): real32\n"
        /* 0933 */ "fn Vector4DistanceSqr*(v1: Vector4, v2: Vector4): real32\n"
        /* 0934 */ "fn Vector4Scale*(v: Vector4, scale: real32): Vector4\n"
        /* 0935 */ "fn Vector4Multiply*(v1: Vector4, v2: Vector4): Vector4\n"
        /* 0936 */ "fn Vector4Negate*(v: Vector4): Vector4\n"
        /* 0937 */ "fn Vector4Divide*(v1: Vector4, v2: Vector4): Vector4\n"
        /* 0938 */ "fn Vector4Normalize*(v: Vector4): Vector4\n"
        /* 0939 */ "fn Vector4Min*(v1: Vector4, v2: Vector4): Vector4\n"
        /* 0940 */ "fn Vector4Max*(v1: Vector4, v2: Vector4): Vector4\n"
        /* 0941 */ "fn Vector4Lerp*(v1: Vector4, v2: Vector4, amount: real32): Vector4\n"
        /* 0942 */ "fn Vector4MoveTowards*(v: Vector4, target: Vector4, maxDistance: real32): Vector4\n"
        /* 0943 */ "fn Vector4Invert*(v: Vector4): Vector4\n"
        /* 0944 */ "fn Vector4Equals*(p: Vector4, q: Vector4): int32\n"
        /* 0945 */ "fn MatrixDeterminant*(mat: Matrix): real32\n"
        /* 0946 */ "fn MatrixTrace*(mat: Matrix): real32\n"
        /* 0947 */ "fn MatrixTranspose*(mat: Matrix): Matrix\n"
        /* 0948 */ "fn MatrixInvert*(mat: Matrix): Matrix\n"
        /* 0949 */ "fn MatrixIdentity*(): Matrix\n"
        /* 0950 */ "fn MatrixAdd*(left: Matrix, right: Matrix): Matrix\n"
        /* 0951 */ "fn MatrixSubtract*(left: Matrix, right: Matrix): Matrix\n"
        /* 0952 */ "fn MatrixMultiply*(left: Matrix, right: Matrix): Matrix\n"
        /* 0953 */ "fn MatrixMultiplyValue*(left: Matrix, value: real32): Matrix\n"
        /* 0954 */ "fn MatrixTranslate*(x: real32, y: real32, z: real32): Matrix\n"
        /* 0955 */ "fn MatrixRotate*(axis: Vector3, angle: real32): Matrix\n"
        /* 0956 */ "fn MatrixRotateX*(angle: real32): Matrix\n"
        /* 0957 */ "fn MatrixRotateY*(angle: real32): Matrix\n"
        /* 0958 */ "fn MatrixRotateZ*(angle: real32): Matrix\n"
        /* 0959 */ "fn MatrixRotateXYZ*(angle: Vector3): Matrix\n"
        /* 0960 */ "fn MatrixRotateZYX*(angle: Vector3): Matrix\n"
        /* 0961 */ "fn MatrixScale*(x: real32, y: real32, z: real32): Matrix\n"
        /* 0962 */ "fn MatrixFrustum*(left: real, right: real, bottom: real, top: real, nearPlane: real, farPlane: real): Matrix\n"
        /* 0963 */ "fn MatrixPerspective*(fovY: real, aspect: real, nearPlane: real, farPlane: real): Matrix\n"
        /* 0964 */ "fn MatrixOrtho*(left: real, right: real, bottom: real, top: real, nearPlane: real, farPlane: real): Matrix\n"
        /* 0965 */ "fn MatrixLookAt*(eye: Vector3, target: Vector3, up: Vector3): Matrix\n"
        /* 0966 */ "fn MatrixToFloatV*(mat: Matrix): float16\n"
        /* 0967 */ "fn QuaternionAdd*(q1: Vector4, q2: Vector4): Vector4\n"
        /* 0968 */ "fn QuaternionAddValue*(q: Vector4, add: real32): Vector4\n"
        /* 0969 */ "fn QuaternionSubtract*(q1: Vector4, q2: Vector4): Vector4\n"
        /* 0970 */ "fn QuaternionSubtractValue*(q: Vector4, sub: real32): Vector4\n"
        /* 0971 */ "fn QuaternionIdentity*(): Vector4\n"
        /* 0972 */ "fn QuaternionLength*(q: Vector4): real32\n"
        /* 0973 */ "fn QuaternionNormalize*(q: Vector4): Vector4\n"
        /* 0974 */ "fn QuaternionInvert*(q: Vector4): Vector4\n"
        /* 0975 */ "fn QuaternionMultiply*(q1: Vector4, q2: Vector4): Vector4\n"
        /* 0976 */ "fn QuaternionScale*(q: Vector4, mul: real32): Vector4\n"
        /* 0977 */ "fn QuaternionDivide*(q1: Vector4, q2: Vector4): Vector4\n"
        /* 0978 */ "fn QuaternionLerp*(q1: Vector4, q2: Vector4, amount: real32): Vector4\n"
        /* 0979 */ "fn QuaternionNlerp*(q1: Vector4, q2: Vector4, amount: real32): Vector4\n"
        /* 0980 */ "fn QuaternionSlerp*(q1: Vector4, q2: Vector4, amount: real32): Vector4\n"
        /* 0981 */ "fn QuaternionCubicHermiteSpline*(q1: Vector4, outTangent1: Vector4, q2: Vector4, inTangent2: Vector4, t: real32): Vector4\n"
        /* 0982 */ "fn QuaternionFromVector3ToVector3*(from: Vector3, to: Vector3): Vector4\n"
        /* 0983 */ "fn QuaternionFromMatrix*(mat: Matrix): Vector4\n"
        /* 0984 */ "fn QuaternionToMatrix*(q: Vector4): Matrix\n"
        /* 0985 */ "fn QuaternionFromAxisAngle*(axis: Vector3, angle: real32): Vector4\n"
        /* 0986 */ "fn QuaternionToAxisAngle*(q: Vector4, outAxis: ^Vector3, outAngle: ^real32)\n"
        /* 0987 */ "fn QuaternionFromEuler*(pitch: real32, yaw: real32, roll: real32): Vector4\n"
        /* 0988 */ "fn QuaternionToEuler*(q: Vector4): Vector3\n"
        /* 0989 */ "fn QuaternionTransform*(q: Vector4, mat: Matrix): Vector4\n"
        /* 0990 */ "fn QuaternionEquals*(p: Vector4, q: Vector4): int32\n"
        /* 0991 */ "fn MatrixCompose*(translation: Vector3, rotation: Vector4, scale: Vector3): Matrix\n"
        /* 0992 */ "fn MatrixDecompose*(mat: Matrix, translation: ^Vector3, rotation: ^Vector4, scale: ^Vector3)\n"
        /* 0993 */ "fn rlMatrixMode*(mode: int32)\n"
        /* 0994 */ "fn rlPushMatrix*()\n"
        /* 0995 */ "fn rlPopMatrix*()\n"
        /* 0996 */ "fn rlLoadIdentity*()\n"
        /* 0997 */ "fn rlTranslatef*(x: real32, y: real32, z: real32)\n"
        /* 0998 */ "fn rlRotatef*(angle: real32, x: real32, y: real32, z: real32)\n"
        /* 0999 */ "fn rlScalef*(x: real32, y: real32, z: real32)\n"
        /* 1000 */ "fn rlMultMatrixf*(matf: ^real32)\n"
        /* 1001 */ "fn rlFrustum*(left: real, right: real, bottom: real, top: real, znear: real, zfar: real)\n"
        /* 1002 */ "fn rlOrtho*(left: real, right: real, bottom: real, top: real, znear: real, zfar: real)\n"
        /* 1003 */ "fn rlViewport*(x: int32, y: int32, width: int32, height: int32)\n"
        /* 1004 */ "fn rlSetClipPlanes*(nearPlane: real, farPlane: real)\n"
        /* 1005 */ "fn rlGetCullDistanceNear*(): real\n"
        /* 1006 */ "fn rlGetCullDistanceFar*(): real\n"
        /* 1007 */ "fn rlBegin*(mode: int32)\n"
        /* 1008 */ "fn rlEnd*()\n"
        /* 1009 */ "fn rlVertex2i*(x: int32, y: int32)\n"
        /* 1010 */ "fn rlVertex2f*(x: real32, y: real32)\n"
        /* 1011 */ "fn rlVertex3f*(x: real32, y: real32, z: real32)\n"
        /* 1012 */ "fn rlTexCoord2f*(x: real32, y: real32)\n"
        /* 1013 */ "fn rlNormal3f*(x: real32, y: real32, z: real32)\n"
        /* 1014 */ "fn rlColor4ub*(r: uint8, g: uint8, b: uint8, a: uint8)\n"
        /* 1015 */ "fn rlColor3f*(x: real32, y: real32, z: real32)\n"
        /* 1016 */ "fn rlColor4f*(x: real32, y: real32, z: real32, w: real32)\n"
        /* 1017 */ "fn rlEnableVertexArray*(vaoId: uint32): bool\n"
        /* 1018 */ "fn rlDisableVertexArray*()\n"
        /* 1019 */ "fn rlEnableVertexBuffer*(id: uint32)\n"
        /* 1020 */ "fn rlDisableVertexBuffer*()\n"
        /* 1021 */ "fn rlEnableVertexBufferElement*(id: uint32)\n"
        /* 1022 */ "fn rlDisableVertexBufferElement*()\n"
        /* 1023 */ "fn rlEnableVertexAttribute*(index: uint32)\n"
        /* 1024 */ "fn rlDisableVertexAttribute*(index: uint32)\n"
        // Skipping rlEnableStatePointer
        // Skipping rlDisableStatePointer
        /* 1025 */ "fn rlActiveTextureSlot*(slot: int32)\n"
        /* 1026 */ "fn rlEnableTexture*(id: uint32)\n"
        /* 1027 */ "fn rlDisableTexture*()\n"
        /* 1028 */ "fn rlEnableTextureCubemap*(id: uint32)\n"
        /* 1029 */ "fn rlDisableTextureCubemap*()\n"
        /* 1030 */ "fn rlTextureParameters*(id: uint32, param: int32, value: int32)\n"
        /* 1031 */ "fn rlCubemapParameters*(id: uint32, param: int32, value: int32)\n"
        /* 1032 */ "fn rlEnableShader*(id: uint32)\n"
        /* 1033 */ "fn rlDisableShader*()\n"
        /* 1034 */ "fn rlEnableFramebuffer*(id: uint32)\n"
        /* 1035 */ "fn rlDisableFramebuffer*()\n"
        /* 1036 */ "fn rlGetActiveFramebuffer*(): uint32\n"
        /* 1037 */ "fn rlActiveDrawBuffers*(count: int32)\n"
        /* 1038 */ "fn rlBlitFramebuffer*(srcX: int32, srcY: int32, srcWidth: int32, srcHeight: int32, dstX: int32, dstY: int32, dstWidth: int32, dstHeight: int32, bufferMask: int32)\n"
        /* 1039 */ "fn rlBindFramebuffer*(target: uint32, framebuffer: uint32)\n"
        /* 1040 */ "fn rlEnableColorBlend*()\n"
        /* 1041 */ "fn rlDisableColorBlend*()\n"
        /* 1042 */ "fn rlEnableDepthTest*()\n"
        /* 1043 */ "fn rlDisableDepthTest*()\n"
        /* 1044 */ "fn rlEnableDepthMask*()\n"
        /* 1045 */ "fn rlDisableDepthMask*()\n"
        /* 1046 */ "fn rlEnableBackfaceCulling*()\n"
        /* 1047 */ "fn rlDisableBackfaceCulling*()\n"
        /* 1048 */ "fn rlColorMask*(r: bool, g: bool, b: bool, a: bool)\n"
        /* 1049 */ "fn rlSetCullFace*(mode: int32)\n"
        /* 1050 */ "fn rlEnableScissorTest*()\n"
        /* 1051 */ "fn rlDisableScissorTest*()\n"
        /* 1052 */ "fn rlScissor*(x: int32, y: int32, width: int32, height: int32)\n"
        /* 1053 */ "fn rlEnablePointMode*()\n"
        /* 1054 */ "fn rlDisablePointMode*()\n"
        /* 1055 */ "fn rlSetPointSize*(size: real32)\n"
        /* 1056 */ "fn rlGetPointSize*(): real32\n"
        /* 1057 */ "fn rlEnableWireMode*()\n"
        /* 1058 */ "fn rlDisableWireMode*()\n"
        /* 1059 */ "fn rlSetLineWidth*(width: real32)\n"
        /* 1060 */ "fn rlGetLineWidth*(): real32\n"
        /* 1061 */ "fn rlEnableSmoothLines*()\n"
        /* 1062 */ "fn rlDisableSmoothLines*()\n"
        /* 1063 */ "fn rlEnableStereoRender*()\n"
        /* 1064 */ "fn rlDisableStereoRender*()\n"
        /* 1065 */ "fn rlIsStereoRenderEnabled*(): bool\n"
        /* 1066 */ "fn rlClearColor*(r: uint8, g: uint8, b: uint8, a: uint8)\n"
        /* 1067 */ "fn rlClearScreenBuffers*()\n"
        /* 1068 */ "fn rlCheckErrors*()\n"
        /* 1069 */ "fn rlSetBlendMode*(mode: int32)\n"
        /* 1070 */ "fn rlSetBlendFactors*(glSrcFactor: int32, glDstFactor: int32, glEquation: int32)\n"
        /* 1071 */ "fn rlSetBlendFactorsSeparate*(glSrcRGB: int32, glDstRGB: int32, glSrcAlpha: int32, glDstAlpha: int32, glEqRGB: int32, glEqAlpha: int32)\n"
        /* 1072 */ "fn rlglInit*(width: int32, height: int32)\n"
        /* 1073 */ "fn rlglClose*()\n"
        /* 1074 */ "fn rlLoadExtensions*(loader: ^void)\n"
        /* 1075 */ "fn rlGetProcAddress*(procName: str): ^void\n"
        /* 1076 */ "fn rlGetVersion*(): int32\n"
        /* 1077 */ "fn rlSetFramebufferWidth*(width: int32)\n"
        /* 1078 */ "fn rlGetFramebufferWidth*(): int32\n"
        /* 1079 */ "fn rlSetFramebufferHeight*(height: int32)\n"
        /* 1080 */ "fn rlGetFramebufferHeight*(): int32\n"
        /* 1081 */ "fn rlGetTextureIdDefault*(): uint32\n"
        /* 1082 */ "fn rlGetShaderIdDefault*(): uint32\n"
        /* 1083 */ "fn rlGetShaderLocsDefault*(): ^int32\n"
        // Skipping rlLoadRenderBatch
        // Skipping rlUnloadRenderBatch
        // Skipping rlDrawRenderBatch
        // Skipping rlSetRenderBatchActive
        /* 1084 */ "fn rlDrawRenderBatchActive*()\n"
        /* 1085 */ "fn rlCheckRenderBatchLimit*(vCount: int32): bool\n"
        /* 1086 */ "fn rlSetTexture*(id: uint32)\n"
        /* 1087 */ "fn rlLoadVertexArray*(): uint32\n"
        /* 1088 */ "fn rlLoadVertexBuffer*(buffer: ^void, size: int32, dynamic: bool): uint32\n"
        /* 1089 */ "fn rlLoadVertexBufferElement*(buffer: ^void, size: int32, dynamic: bool): uint32\n"
        /* 1090 */ "fn rlUpdateVertexBuffer*(bufferId: uint32, data: ^void, dataSize: int32, offset: int32)\n"
        /* 1091 */ "fn rlUpdateVertexBufferElements*(id: uint32, data: ^void, dataSize: int32, offset: int32)\n"
        /* 1092 */ "fn rlUnloadVertexArray*(vaoId: uint32)\n"
        /* 1093 */ "fn rlUnloadVertexBuffer*(vboId: uint32)\n"
        /* 1094 */ "fn rlSetVertexAttribute*(index: uint32, compSize: int32, typeInput: int32, normalized: bool, stride: int32, offset: int32)\n"
        /* 1095 */ "fn rlSetVertexAttributeDivisor*(index: uint32, divisor: int32)\n"
        /* 1096 */ "fn rlSetVertexAttributeDefault*(locIndex: int32, value: ^void, attribType: int32, count: int32)\n"
        /* 1097 */ "fn rlDrawVertexArray*(offset: int32, count: int32)\n"
        /* 1098 */ "fn rlDrawVertexArrayElements*(offset: int32, count: int32, buffer: ^void)\n"
        /* 1099 */ "fn rlDrawVertexArrayInstanced*(offset: int32, count: int32, instances: int32)\n"
        /* 1100 */ "fn rlDrawVertexArrayElementsInstanced*(offset: int32, count: int32, buffer: ^void, instances: int32)\n"
        /* 1101 */ "fn rlLoadTexture*(data: ^void, width: int32, height: int32, format: int32, mipmapCount: int32): uint32\n"
        /* 1102 */ "fn rlLoadTextureDepth*(width: int32, height: int32, useRenderBuffer: bool): uint32\n"
        /* 1103 */ "fn rlLoadTextureCubemap*(data: ^void, size: int32, format: int32, mipmapCount: int32): uint32\n"
        /* 1104 */ "fn rlUpdateTexture*(id: uint32, offsetX: int32, offsetY: int32, width: int32, height: int32, format: int32, data: ^void)\n"
        /* 1105 */ "fn rlGetGlTextureFormats*(format: int32, glInternalFormat: ^uint32, glFormat: ^uint32, glType: ^uint32)\n"
        /* 1106 */ "fn rlGetPixelFormatName*(format: uint32): str\n"
        /* 1107 */ "fn rlUnloadTexture*(id: uint32)\n"
        /* 1108 */ "fn rlGenTextureMipmaps*(id: uint32, width: int32, height: int32, format: int32, mipmaps: ^int32)\n"
        /* 1109 */ "fn rlReadTexturePixels*(id: uint32, width: int32, height: int32, format: int32): ^void\n"
        /* 1110 */ "fn rlReadScreenPixels*(width: int32, height: int32): ^uint8\n"
        /* 1111 */ "fn rlLoadFramebuffer*(): uint32\n"
        /* 1112 */ "fn rlFramebufferAttach*(id: uint32, texId: uint32, attachType: int32, texType: int32, mipLevel: int32)\n"
        /* 1113 */ "fn rlFramebufferComplete*(id: uint32): bool\n"
        /* 1114 */ "fn rlUnloadFramebuffer*(id: uint32)\n"
        /* 1115 */ "fn rlCopyFramebuffer*(x: int32, y: int32, width: int32, height: int32, format: int32, pixels: ^void)\n"
        /* 1116 */ "fn rlResizeFramebuffer*(width: int32, height: int32)\n"
        /* 1117 */ "fn rlLoadShader*(code: str, typeInput: int32): uint32\n"
        /* 1118 */ "fn rlLoadShaderProgram*(vsCode: str, fsCode: str): uint32\n"
        /* 1119 */ "fn rlLoadShaderProgramEx*(vsId: uint32, fsId: uint32): uint32\n"
        /* 1120 */ "fn rlLoadShaderProgramCompute*(csId: uint32): uint32\n"
        /* 1121 */ "fn rlUnloadShader*(id: uint32)\n"
        /* 1122 */ "fn rlUnloadShaderProgram*(id: uint32)\n"
        /* 1123 */ "fn rlGetLocationUniform*(id: uint32, uniformName: str): int32\n"
        /* 1124 */ "fn rlGetLocationAttrib*(id: uint32, attribName: str): int32\n"
        /* 1125 */ "fn rlSetUniform*(locIndex: int32, value: ^void, uniformType: int32, count: int32)\n"
        /* 1126 */ "fn rlSetUniformMatrix*(locIndex: int32, mat: Matrix)\n"
        /* 1127 */ "fn rlSetUniformMatrices*(locIndex: int32, mat: ^Matrix, count: int32)\n"
        /* 1128 */ "fn rlSetUniformSampler*(locIndex: int32, textureId: uint32)\n"
        /* 1129 */ "fn rlSetShader*(id: uint32, locs: ^int32)\n"
        /* 1130 */ "fn rlComputeShaderDispatch*(groupX: uint32, groupY: uint32, groupZ: uint32)\n"
        /* 1131 */ "fn rlLoadShaderBuffer*(size: uint32, data: ^void, usageHint: int32): uint32\n"
        /* 1132 */ "fn rlUnloadShaderBuffer*(ssboId: uint32)\n"
        /* 1133 */ "fn rlUpdateShaderBuffer*(id: uint32, data: ^void, dataSize: uint32, offset: uint32)\n"
        /* 1134 */ "fn rlBindShaderBuffer*(id: uint32, index: uint32)\n"
        /* 1135 */ "fn rlReadShaderBuffer*(id: uint32, dest: ^void, count: uint32, offset: uint32)\n"
        /* 1136 */ "fn rlCopyShaderBuffer*(destId: uint32, srcId: uint32, destOffset: uint32, srcOffset: uint32, count: uint32)\n"
        /* 1137 */ "fn rlGetShaderBufferSize*(id: uint32): uint32\n"
        /* 1138 */ "fn rlBindImageTexture*(id: uint32, index: uint32, format: int32, readonly: bool)\n"
        /* 1139 */ "fn rlGetMatrixModelview*(): Matrix\n"
        /* 1140 */ "fn rlGetMatrixProjection*(): Matrix\n"
        /* 1141 */ "fn rlGetMatrixTransform*(): Matrix\n"
        /* 1142 */ "fn rlGetMatrixProjectionStereo*(eye: int32): Matrix\n"
        /* 1143 */ "fn rlGetMatrixViewOffsetStereo*(eye: int32): Matrix\n"
        /* 1144 */ "fn rlSetMatrixProjection*(proj: Matrix)\n"
        /* 1145 */ "fn rlSetMatrixModelview*(view: Matrix)\n"
        /* 1146 */ "fn rlSetMatrixProjectionStereo*(right: Matrix, left: Matrix)\n"
        /* 1147 */ "fn rlSetMatrixViewOffsetStereo*(right: Matrix, left: Matrix)\n"
        /* 1148 */ "fn rlLoadDrawCube*()\n"
        /* 1149 */ "fn rlLoadDrawQuad*()\n"

        // Enums
        /* 1150 */ "const FLAG_VSYNC_HINT* = 64\n"
        /* 1151 */ "const FLAG_FULLSCREEN_MODE* = 2\n"
        /* 1152 */ "const FLAG_WINDOW_RESIZABLE* = 4\n"
        /* 1153 */ "const FLAG_WINDOW_UNDECORATED* = 8\n"
        /* 1154 */ "const FLAG_WINDOW_HIDDEN* = 128\n"
        /* 1155 */ "const FLAG_WINDOW_MINIMIZED* = 512\n"
        /* 1156 */ "const FLAG_WINDOW_MAXIMIZED* = 1024\n"
        /* 1157 */ "const FLAG_WINDOW_UNFOCUSED* = 2048\n"
        /* 1158 */ "const FLAG_WINDOW_TOPMOST* = 4096\n"
        /* 1159 */ "const FLAG_WINDOW_ALWAYS_RUN* = 256\n"
        /* 1160 */ "const FLAG_WINDOW_TRANSPARENT* = 16\n"
        /* 1161 */ "const FLAG_WINDOW_HIGHDPI* = 8192\n"
        /* 1162 */ "const FLAG_WINDOW_MOUSE_PASSTHROUGH* = 16384\n"
        /* 1163 */ "const FLAG_BORDERLESS_WINDOWED_MODE* = 32768\n"
        /* 1164 */ "const FLAG_MSAA_4X_HINT* = 32\n"
        /* 1165 */ "const FLAG_INTERLACED_HINT* = 65536\n"
        /* 1166 */ "const LOG_ALL* = 0\n"
        /* 1167 */ "const LOG_TRACE* = 1\n"
        /* 1168 */ "const LOG_DEBUG* = 2\n"
        /* 1169 */ "const LOG_INFO* = 3\n"
        /* 1170 */ "const LOG_WARNING* = 4\n"
        /* 1171 */ "const LOG_ERROR* = 5\n"
        /* 1172 */ "const LOG_FATAL* = 6\n"
        /* 1173 */ "const LOG_NONE* = 7\n"
        /* 1174 */ "const KEY_NULL* = 0\n"
        /* 1175 */ "const KEY_APOSTROPHE* = 39\n"
        /* 1176 */ "const KEY_COMMA* = 44\n"
        /* 1177 */ "const KEY_MINUS* = 45\n"
        /* 1178 */ "const KEY_PERIOD* = 46\n"
        /* 1179 */ "const KEY_SLASH* = 47\n"
        /* 1180 */ "const KEY_ZERO* = 48\n"
        /* 1181 */ "const KEY_ONE* = 49\n"
        /* 1182 */ "const KEY_TWO* = 50\n"
        /* 1183 */ "const KEY_THREE* = 51\n"
        /* 1184 */ "const KEY_FOUR* = 52\n"
        /* 1185 */ "const KEY_FIVE* = 53\n"
        /* 1186 */ "const KEY_SIX* = 54\n"
        /* 1187 */ "const KEY_SEVEN* = 55\n"
        /* 1188 */ "const KEY_EIGHT* = 56\n"
        /* 1189 */ "const KEY_NINE* = 57\n"
        /* 1190 */ "const KEY_SEMICOLON* = 59\n"
        /* 1191 */ "const KEY_EQUAL* = 61\n"
        /* 1192 */ "const KEY_A* = 65\n"
        /* 1193 */ "const KEY_B* = 66\n"
        /* 1194 */ "const KEY_C* = 67\n"
        /* 1195 */ "const KEY_D* = 68\n"
        ...
        /* 1216 */ "const KEY_Y* = 89\n"
        /* 1217 */ "const KEY_Z* = 90\n"
        /* 1218 */ "const KEY_LEFT_BRACKET* = 91\n"
        /* 1219 */ "const KEY_BACKSLASH* = 92\n"
        /* 1220 */ "const KEY_RIGHT_BRACKET* = 93\n"
        /* 1221 */ "const KEY_GRAVE* = 96\n"
        /* 1222 */ "const KEY_SPACE* = 32\n"
        /* 1223 */ "const KEY_ESCAPE* = 256\n"
        /* 1224 */ "const KEY_ENTER* = 257\n"
        /* 1225 */ "const KEY_TAB* = 258\n"
        /* 1226 */ "const KEY_BACKSPACE* = 259\n"
        /* 1227 */ "const KEY_INSERT* = 260\n"
        /* 1228 */ "const KEY_DELETE* = 261\n"
        /* 1229 */ "const KEY_RIGHT* = 262\n"
        /* 1230 */ "const KEY_LEFT* = 263\n"
        /* 1231 */ "const KEY_DOWN* = 264\n"
        /* 1232 */ "const KEY_UP* = 265\n"
        /* 1233 */ "const KEY_PAGE_UP* = 266\n"
        /* 1234 */ "const KEY_PAGE_DOWN* = 267\n"
        /* 1235 */ "const KEY_HOME* = 268\n"
        /* 1236 */ "const KEY_END* = 269\n"
        /* 1237 */ "const KEY_CAPS_LOCK* = 280\n"
        /* 1238 */ "const KEY_SCROLL_LOCK* = 281\n"
        /* 1239 */ "const KEY_NUM_LOCK* = 282\n"
        /* 1240 */ "const KEY_PRINT_SCREEN* = 283\n"
        /* 1241 */ "const KEY_PAUSE* = 284\n"
        /* 1242 */ "const KEY_F1* = 290\n"
        /* 1243 */ "const KEY_F2* = 291\n"
        /* 1244 */ "const KEY_F3* = 292\n"
        /* 1245 */ "const KEY_F4* = 293\n"
        /* 1246 */ "const KEY_F5* = 294\n"
        /* 1247 */ "const KEY_F6* = 295\n"
        /* 1248 */ "const KEY_F7* = 296\n"
        /* 1249 */ "const KEY_F8* = 297\n"
        /* 1250 */ "const KEY_F9* = 298\n"
        /* 1251 */ "const KEY_F10* = 299\n"
        /* 1252 */ "const KEY_F11* = 300\n"
        /* 1253 */ "const KEY_F12* = 301\n"
        /* 1254 */ "const KEY_LEFT_SHIFT* = 340\n"
        /* 1255 */ "const KEY_LEFT_CONTROL* = 341\n"
        /* 1256 */ "const KEY_LEFT_ALT* = 342\n"
        /* 1257 */ "const KEY_LEFT_SUPER* = 343\n"
        /* 1258 */ "const KEY_RIGHT_SHIFT* = 344\n"
        /* 1259 */ "const KEY_RIGHT_CONTROL* = 345\n"
        /* 1260 */ "const KEY_RIGHT_ALT* = 346\n"
        /* 1261 */ "const KEY_RIGHT_SUPER* = 347\n"
        /* 1262 */ "const KEY_KB_MENU* = 348\n"
        /* 1263 */ "const KEY_KP_0* = 320\n"
        /* 1264 */ "const KEY_KP_1* = 321\n"
        /* 1265 */ "const KEY_KP_2* = 322\n"
        /* 1266 */ "const KEY_KP_3* = 323\n"
        /* 1267 */ "const KEY_KP_4* = 324\n"
        /* 1268 */ "const KEY_KP_5* = 325\n"
        /* 1269 */ "const KEY_KP_6* = 326\n"
        /* 1270 */ "const KEY_KP_7* = 327\n"
        /* 1271 */ "const KEY_KP_8* = 328\n"
        /* 1272 */ "const KEY_KP_9* = 329\n"
        /* 1273 */ "const KEY_KP_DECIMAL* = 330\n"
        /* 1274 */ "const KEY_KP_DIVIDE* = 331\n"
        /* 1275 */ "const KEY_KP_MULTIPLY* = 332\n"
        /* 1276 */ "const KEY_KP_SUBTRACT* = 333\n"
        /* 1277 */ "const KEY_KP_ADD* = 334\n"
        /* 1278 */ "const KEY_KP_ENTER* = 335\n"
        /* 1279 */ "const KEY_KP_EQUAL* = 336\n"
        /* 1280 */ "const KEY_BACK* = 4\n"
        /* 1281 */ "const KEY_MENU* = 5\n"
        /* 1282 */ "const KEY_VOLUME_UP* = 24\n"
        /* 1283 */ "const KEY_VOLUME_DOWN* = 25\n"
        /* 1284 */ "const MOUSE_BUTTON_LEFT* = 0\n"
        /* 1285 */ "const MOUSE_BUTTON_RIGHT* = 1\n"
        /* 1286 */ "const MOUSE_BUTTON_MIDDLE* = 2\n"
        /* 1287 */ "const MOUSE_BUTTON_SIDE* = 3\n"
        /* 1288 */ "const MOUSE_BUTTON_EXTRA* = 4\n"
        /* 1289 */ "const MOUSE_BUTTON_FORWARD* = 5\n"
        /* 1290 */ "const MOUSE_BUTTON_BACK* = 6\n"
        /* 1291 */ "const MOUSE_CURSOR_DEFAULT* = 0\n"
        /* 1292 */ "const MOUSE_CURSOR_ARROW* = 1\n"
        /* 1293 */ "const MOUSE_CURSOR_IBEAM* = 2\n"
        /* 1294 */ "const MOUSE_CURSOR_CROSSHAIR* = 3\n"
        /* 1295 */ "const MOUSE_CURSOR_POINTING_HAND* = 4\n"
        /* 1296 */ "const MOUSE_CURSOR_RESIZE_EW* = 5\n"
        /* 1297 */ "const MOUSE_CURSOR_RESIZE_NS* = 6\n"
        /* 1298 */ "const MOUSE_CURSOR_RESIZE_NWSE* = 7\n"
        /* 1299 */ "const MOUSE_CURSOR_RESIZE_NESW* = 8\n"
        /* 1300 */ "const MOUSE_CURSOR_RESIZE_ALL* = 9\n"
        /* 1301 */ "const MOUSE_CURSOR_NOT_ALLOWED* = 10\n"
        /* 1302 */ "const GAMEPAD_BUTTON_UNKNOWN* = 0\n"
        /* 1303 */ "const GAMEPAD_BUTTON_LEFT_FACE_UP* = 1\n"
        /* 1304 */ "const GAMEPAD_BUTTON_LEFT_FACE_RIGHT* = 2\n"
        /* 1305 */ "const GAMEPAD_BUTTON_LEFT_FACE_DOWN* = 3\n"
        /* 1306 */ "const GAMEPAD_BUTTON_LEFT_FACE_LEFT* = 4\n"
        /* 1307 */ "const GAMEPAD_BUTTON_RIGHT_FACE_UP* = 5\n"
        /* 1308 */ "const GAMEPAD_BUTTON_RIGHT_FACE_RIGHT* = 6\n"
        /* 1309 */ "const GAMEPAD_BUTTON_RIGHT_FACE_DOWN* = 7\n"
        /* 1310 */ "const GAMEPAD_BUTTON_RIGHT_FACE_LEFT* = 8\n"
        /* 1311 */ "const GAMEPAD_BUTTON_LEFT_TRIGGER_1* = 9\n"
        /* 1312 */ "const GAMEPAD_BUTTON_LEFT_TRIGGER_2* = 10\n"
        /* 1313 */ "const GAMEPAD_BUTTON_RIGHT_TRIGGER_1* = 11\n"
        /* 1314 */ "const GAMEPAD_BUTTON_RIGHT_TRIGGER_2* = 12\n"
        /* 1315 */ "const GAMEPAD_BUTTON_MIDDLE_LEFT* = 13\n"
        /* 1316 */ "const GAMEPAD_BUTTON_MIDDLE* = 14\n"
        /* 1317 */ "const GAMEPAD_BUTTON_MIDDLE_RIGHT* = 15\n"
        /* 1318 */ "const GAMEPAD_BUTTON_LEFT_THUMB* = 16\n"
        /* 1319 */ "const GAMEPAD_BUTTON_RIGHT_THUMB* = 17\n"
        /* 1320 */ "const GAMEPAD_AXIS_LEFT_X* = 0\n"
        /* 1321 */ "const GAMEPAD_AXIS_LEFT_Y* = 1\n"
        /* 1322 */ "const GAMEPAD_AXIS_RIGHT_X* = 2\n"
        /* 1323 */ "const GAMEPAD_AXIS_RIGHT_Y* = 3\n"
        /* 1324 */ "const GAMEPAD_AXIS_LEFT_TRIGGER* = 4\n"
        /* 1325 */ "const GAMEPAD_AXIS_RIGHT_TRIGGER* = 5\n"
        /* 1326 */ "const MATERIAL_MAP_ALBEDO* = 0\n"
        /* 1327 */ "const MATERIAL_MAP_METALNESS* = 1\n"
        /* 1328 */ "const MATERIAL_MAP_NORMAL* = 2\n"
        /* 1329 */ "const MATERIAL_MAP_ROUGHNESS* = 3\n"
        /* 1330 */ "const MATERIAL_MAP_OCCLUSION* = 4\n"
        /* 1331 */ "const MATERIAL_MAP_EMISSION* = 5\n"
        /* 1332 */ "const MATERIAL_MAP_HEIGHT* = 6\n"
        /* 1333 */ "const MATERIAL_MAP_CUBEMAP* = 7\n"
        /* 1334 */ "const MATERIAL_MAP_IRRADIANCE* = 8\n"
        /* 1335 */ "const MATERIAL_MAP_PREFILTER* = 9\n"
        /* 1336 */ "const MATERIAL_MAP_BRDF* = 10\n"
        /* 1337 */ "const SHADER_LOC_VERTEX_POSITION* = 0\n"
        /* 1338 */ "const SHADER_LOC_VERTEX_TEXCOORD01* = 1\n"
        /* 1339 */ "const SHADER_LOC_VERTEX_TEXCOORD02* = 2\n"
        /* 1340 */ "const SHADER_LOC_VERTEX_NORMAL* = 3\n"
        /* 1341 */ "const SHADER_LOC_VERTEX_TANGENT* = 4\n"
        /* 1342 */ "const SHADER_LOC_VERTEX_COLOR* = 5\n"
        /* 1343 */ "const SHADER_LOC_MATRIX_MVP* = 6\n"
        /* 1344 */ "const SHADER_LOC_MATRIX_VIEW* = 7\n"
        /* 1345 */ "const SHADER_LOC_MATRIX_PROJECTION* = 8\n"
        /* 1346 */ "const SHADER_LOC_MATRIX_MODEL* = 9\n"
        /* 1347 */ "const SHADER_LOC_MATRIX_NORMAL* = 10\n"
        /* 1348 */ "const SHADER_LOC_VECTOR_VIEW* = 11\n"
        /* 1349 */ "const SHADER_LOC_COLOR_DIFFUSE* = 12\n"
        /* 1350 */ "const SHADER_LOC_COLOR_SPECULAR* = 13\n"
        /* 1351 */ "const SHADER_LOC_COLOR_AMBIENT* = 14\n"
        /* 1352 */ "const SHADER_LOC_MAP_ALBEDO* = 15\n"
        /* 1353 */ "const SHADER_LOC_MAP_METALNESS* = 16\n"
        /* 1354 */ "const SHADER_LOC_MAP_NORMAL* = 17\n"
        /* 1355 */ "const SHADER_LOC_MAP_ROUGHNESS* = 18\n"
        /* 1356 */ "const SHADER_LOC_MAP_OCCLUSION* = 19\n"
        /* 1357 */ "const SHADER_LOC_MAP_EMISSION* = 20\n"
        /* 1358 */ "const SHADER_LOC_MAP_HEIGHT* = 21\n"
        /* 1359 */ "const SHADER_LOC_MAP_CUBEMAP* = 22\n"
        /* 1360 */ "const SHADER_LOC_MAP_IRRADIANCE* = 23\n"
        /* 1361 */ "const SHADER_LOC_MAP_PREFILTER* = 24\n"
        /* 1362 */ "const SHADER_LOC_MAP_BRDF* = 25\n"
        /* 1363 */ "const SHADER_LOC_VERTEX_BONEIDS* = 26\n"
        /* 1364 */ "const SHADER_LOC_VERTEX_BONEWEIGHTS* = 27\n"
        /* 1365 */ "const SHADER_LOC_MATRIX_BONETRANSFORMS* = 28\n"
        /* 1366 */ "const SHADER_LOC_VERTEX_INSTANCETRANSFORM* = 29\n"
        /* 1367 */ "const SHADER_UNIFORM_FLOAT* = 0\n"
        /* 1368 */ "const SHADER_UNIFORM_VEC2* = 1\n"
        /* 1369 */ "const SHADER_UNIFORM_VEC3* = 2\n"
        /* 1370 */ "const SHADER_UNIFORM_VEC4* = 3\n"
        /* 1371 */ "const SHADER_UNIFORM_INT* = 4\n"
        /* 1372 */ "const SHADER_UNIFORM_IVEC2* = 5\n"
        /* 1373 */ "const SHADER_UNIFORM_IVEC3* = 6\n"
        /* 1374 */ "const SHADER_UNIFORM_IVEC4* = 7\n"
        /* 1375 */ "const SHADER_UNIFORM_UINT* = 8\n"
        /* 1376 */ "const SHADER_UNIFORM_UIVEC2* = 9\n"
        /* 1377 */ "const SHADER_UNIFORM_UIVEC3* = 10\n"
        /* 1378 */ "const SHADER_UNIFORM_UIVEC4* = 11\n"
        /* 1379 */ "const SHADER_UNIFORM_SAMPLER2D* = 12\n"
        /* 1380 */ "const SHADER_ATTRIB_FLOAT* = 0\n"
        /* 1381 */ "const SHADER_ATTRIB_VEC2* = 1\n"
        /* 1382 */ "const SHADER_ATTRIB_VEC3* = 2\n"
        /* 1383 */ "const SHADER_ATTRIB_VEC4* = 3\n"
        /* 1384 */ "const PIXELFORMAT_UNCOMPRESSED_GRAYSCALE* = 1\n"
        /* 1385 */ "const PIXELFORMAT_UNCOMPRESSED_GRAY_ALPHA* = 2\n"
        /* 1386 */ "const PIXELFORMAT_UNCOMPRESSED_R5G6B5* = 3\n"
        /* 1387 */ "const PIXELFORMAT_UNCOMPRESSED_R8G8B8* = 4\n"
        /* 1388 */ "const PIXELFORMAT_UNCOMPRESSED_R5G5B5A1* = 5\n"
        /* 1389 */ "const PIXELFORMAT_UNCOMPRESSED_R4G4B4A4* = 6\n"
        /* 1390 */ "const PIXELFORMAT_UNCOMPRESSED_R8G8B8A8* = 7\n"
        /* 1391 */ "const PIXELFORMAT_UNCOMPRESSED_R32* = 8\n"
        /* 1392 */ "const PIXELFORMAT_UNCOMPRESSED_R32G32B32* = 9\n"
        /* 1393 */ "const PIXELFORMAT_UNCOMPRESSED_R32G32B32A32* = 10\n"
        /* 1394 */ "const PIXELFORMAT_UNCOMPRESSED_R16* = 11\n"
        /* 1395 */ "const PIXELFORMAT_UNCOMPRESSED_R16G16B16* = 12\n"
        /* 1396 */ "const PIXELFORMAT_UNCOMPRESSED_R16G16B16A16* = 13\n"
        /* 1397 */ "const PIXELFORMAT_COMPRESSED_DXT1_RGB* = 14\n"
        /* 1398 */ "const PIXELFORMAT_COMPRESSED_DXT1_RGBA* = 15\n"
        /* 1399 */ "const PIXELFORMAT_COMPRESSED_DXT3_RGBA* = 16\n"
        /* 1400 */ "const PIXELFORMAT_COMPRESSED_DXT5_RGBA* = 17\n"
        /* 1401 */ "const PIXELFORMAT_COMPRESSED_ETC1_RGB* = 18\n"
        /* 1402 */ "const PIXELFORMAT_COMPRESSED_ETC2_RGB* = 19\n"
        /* 1403 */ "const PIXELFORMAT_COMPRESSED_ETC2_EAC_RGBA* = 20\n"
        /* 1404 */ "const PIXELFORMAT_COMPRESSED_PVRT_RGB* = 21\n"
        /* 1405 */ "const PIXELFORMAT_COMPRESSED_PVRT_RGBA* = 22\n"
        /* 1406 */ "const PIXELFORMAT_COMPRESSED_ASTC_4x4_RGBA* = 23\n"
        /* 1407 */ "const PIXELFORMAT_COMPRESSED_ASTC_8x8_RGBA* = 24\n"
        /* 1408 */ "const TEXTURE_FILTER_POINT* = 0\n"
        /* 1409 */ "const TEXTURE_FILTER_BILINEAR* = 1\n"
        /* 1410 */ "const TEXTURE_FILTER_TRILINEAR* = 2\n"
        /* 1411 */ "const TEXTURE_FILTER_ANISOTROPIC_4X* = 3\n"
        /* 1412 */ "const TEXTURE_FILTER_ANISOTROPIC_8X* = 4\n"
        /* 1413 */ "const TEXTURE_FILTER_ANISOTROPIC_16X* = 5\n"
        /* 1414 */ "const TEXTURE_WRAP_REPEAT* = 0\n"
        /* 1415 */ "const TEXTURE_WRAP_CLAMP* = 1\n"
        /* 1416 */ "const TEXTURE_WRAP_MIRROR_REPEAT* = 2\n"
        /* 1417 */ "const TEXTURE_WRAP_MIRROR_CLAMP* = 3\n"
        /* 1418 */ "const CUBEMAP_LAYOUT_AUTO_DETECT* = 0\n"
        /* 1419 */ "const CUBEMAP_LAYOUT_LINE_VERTICAL* = 1\n"
        /* 1420 */ "const CUBEMAP_LAYOUT_LINE_HORIZONTAL* = 2\n"
        /* 1421 */ "const CUBEMAP_LAYOUT_CROSS_THREE_BY_FOUR* = 3\n"
        /* 1422 */ "const CUBEMAP_LAYOUT_CROSS_FOUR_BY_THREE* = 4\n"
        /* 1423 */ "const FONT_DEFAULT* = 0\n"
        /* 1424 */ "const FONT_BITMAP* = 1\n"
        /* 1425 */ "const FONT_SDF* = 2\n"
        /* 1426 */ "const BLEND_ALPHA* = 0\n"
        /* 1427 */ "const BLEND_ADDITIVE* = 1\n"
        /* 1428 */ "const BLEND_MULTIPLIED* = 2\n"
        /* 1429 */ "const BLEND_ADD_COLORS* = 3\n"
        /* 1430 */ "const BLEND_SUBTRACT_COLORS* = 4\n"
        /* 1431 */ "const BLEND_ALPHA_PREMULTIPLY* = 5\n"
        /* 1432 */ "const BLEND_CUSTOM* = 6\n"
        /* 1433 */ "const BLEND_CUSTOM_SEPARATE* = 7\n"
        /* 1434 */ "const GESTURE_NONE* = 0\n"
        /* 1435 */ "const GESTURE_TAP* = 1\n"
        /* 1436 */ "const GESTURE_DOUBLETAP* = 2\n"
        /* 1437 */ "const GESTURE_HOLD* = 4\n"
        /* 1438 */ "const GESTURE_DRAG* = 8\n"
        /* 1439 */ "const GESTURE_SWIPE_RIGHT* = 16\n"
        /* 1440 */ "const GESTURE_SWIPE_LEFT* = 32\n"
        /* 1441 */ "const GESTURE_SWIPE_UP* = 64\n"
        /* 1442 */ "const GESTURE_SWIPE_DOWN* = 128\n"
        /* 1443 */ "const GESTURE_PINCH_IN* = 256\n"
        /* 1444 */ "const GESTURE_PINCH_OUT* = 512\n"
        /* 1445 */ "const CAMERA_CUSTOM* = 0\n"
        /* 1446 */ "const CAMERA_FREE* = 1\n"
        /* 1447 */ "const CAMERA_ORBITAL* = 2\n"
        /* 1448 */ "const CAMERA_FIRST_PERSON* = 3\n"
        /* 1449 */ "const CAMERA_THIRD_PERSON* = 4\n"
        /* 1450 */ "const CAMERA_PERSPECTIVE* = 0\n"
        /* 1451 */ "const CAMERA_ORTHOGRAPHIC* = 1\n"
        /* 1452 */ "const NPATCH_NINE_PATCH* = 0\n"
        /* 1453 */ "const NPATCH_THREE_PATCH_VERTICAL* = 1\n"
        /* 1454 */ "const NPATCH_THREE_PATCH_HORIZONTAL* = 2\n"
        /* 1455 */ "const RL_OPENGL_11_SOFTWARE* = 0\n"
        /* 1456 */ "const RL_OPENGL_11* = 1\n"
        /* 1457 */ "const RL_OPENGL_21* = 2\n"
        /* 1458 */ "const RL_OPENGL_33* = 3\n"
        /* 1459 */ "const RL_OPENGL_43* = 4\n"
        /* 1460 */ "const RL_OPENGL_ES_20* = 5\n"
        /* 1461 */ "const RL_OPENGL_ES_30* = 6\n"
        /* 1462 */ "const RL_LOG_ALL* = 0\n"
        /* 1463 */ "const RL_LOG_TRACE* = 1\n"
        /* 1464 */ "const RL_LOG_DEBUG* = 2\n"
        /* 1465 */ "const RL_LOG_INFO* = 3\n"
        /* 1466 */ "const RL_LOG_WARNING* = 4\n"
        /* 1467 */ "const RL_LOG_ERROR* = 5\n"
        /* 1468 */ "const RL_LOG_FATAL* = 6\n"
        /* 1469 */ "const RL_LOG_NONE* = 7\n"
        /* 1470 */ "const RL_PIXELFORMAT_UNCOMPRESSED_GRAYSCALE* = 1\n"
        /* 1471 */ "const RL_PIXELFORMAT_UNCOMPRESSED_GRAY_ALPHA* = 2\n"
        /* 1472 */ "const RL_PIXELFORMAT_UNCOMPRESSED_R5G6B5* = 3\n"
        /* 1473 */ "const RL_PIXELFORMAT_UNCOMPRESSED_R8G8B8* = 4\n"
        /* 1474 */ "const RL_PIXELFORMAT_UNCOMPRESSED_R5G5B5A1* = 5\n"
        /* 1475 */ "const RL_PIXELFORMAT_UNCOMPRESSED_R4G4B4A4* = 6\n"
        /* 1476 */ "const RL_PIXELFORMAT_UNCOMPRESSED_R8G8B8A8* = 7\n"
        /* 1477 */ "const RL_PIXELFORMAT_UNCOMPRESSED_R32* = 8\n"
        /* 1478 */ "const RL_PIXELFORMAT_UNCOMPRESSED_R32G32B32* = 9\n"
        /* 1479 */ "const RL_PIXELFORMAT_UNCOMPRESSED_R32G32B32A32* = 10\n"
        /* 1480 */ "const RL_PIXELFORMAT_UNCOMPRESSED_R16* = 11\n"
        /* 1481 */ "const RL_PIXELFORMAT_UNCOMPRESSED_R16G16B16* = 12\n"
        /* 1482 */ "const RL_PIXELFORMAT_UNCOMPRESSED_R16G16B16A16* = 13\n"
        /* 1483 */ "const RL_PIXELFORMAT_COMPRESSED_DXT1_RGB* = 14\n"
        /* 1484 */ "const RL_PIXELFORMAT_COMPRESSED_DXT1_RGBA* = 15\n"
        /* 1485 */ "const RL_PIXELFORMAT_COMPRESSED_DXT3_RGBA* = 16\n"
        /* 1486 */ "const RL_PIXELFORMAT_COMPRESSED_DXT5_RGBA* = 17\n"
        /* 1487 */ "const RL_PIXELFORMAT_COMPRESSED_ETC1_RGB* = 18\n"
        /* 1488 */ "const RL_PIXELFORMAT_COMPRESSED_ETC2_RGB* = 19\n"
        /* 1489 */ "const RL_PIXELFORMAT_COMPRESSED_ETC2_EAC_RGBA* = 20\n"
        /* 1490 */ "const RL_PIXELFORMAT_COMPRESSED_PVRT_RGB* = 21\n"
        /* 1491 */ "const RL_PIXELFORMAT_COMPRESSED_PVRT_RGBA* = 22\n"
        /* 1492 */ "const RL_PIXELFORMAT_COMPRESSED_ASTC_4x4_RGBA* = 23\n"
        /* 1493 */ "const RL_PIXELFORMAT_COMPRESSED_ASTC_8x8_RGBA* = 24\n"
        /* 1494 */ "const RL_TEXTURE_FILTER_POINT* = 0\n"
        /* 1495 */ "const RL_TEXTURE_FILTER_BILINEAR* = 1\n"
        /* 1496 */ "const RL_TEXTURE_FILTER_TRILINEAR* = 2\n"
        /* 1497 */ "const RL_TEXTURE_FILTER_ANISOTROPIC_4X* = 3\n"
        /* 1498 */ "const RL_TEXTURE_FILTER_ANISOTROPIC_8X* = 4\n"
        /* 1499 */ "const RL_TEXTURE_FILTER_ANISOTROPIC_16X* = 5\n"
        /* 1500 */ "const RL_BLEND_ALPHA* = 0\n"
        /* 1501 */ "const RL_BLEND_ADDITIVE* = 1\n"
        /* 1502 */ "const RL_BLEND_MULTIPLIED* = 2\n"
        /* 1503 */ "const RL_BLEND_ADD_COLORS* = 3\n"
        /* 1504 */ "const RL_BLEND_SUBTRACT_COLORS* = 4\n"
        /* 1505 */ "const RL_BLEND_ALPHA_PREMULTIPLY* = 5\n"
        /* 1506 */ "const RL_BLEND_CUSTOM* = 6\n"
        /* 1507 */ "const RL_BLEND_CUSTOM_SEPARATE* = 7\n"
        /* 1508 */ "const RL_SHADER_LOC_VERTEX_POSITION* = 0\n"
        /* 1509 */ "const RL_SHADER_LOC_VERTEX_TEXCOORD01* = 1\n"
        /* 1510 */ "const RL_SHADER_LOC_VERTEX_TEXCOORD02* = 2\n"
        /* 1511 */ "const RL_SHADER_LOC_VERTEX_NORMAL* = 3\n"
        /* 1512 */ "const RL_SHADER_LOC_VERTEX_TANGENT* = 4\n"
        /* 1513 */ "const RL_SHADER_LOC_VERTEX_COLOR* = 5\n"
        /* 1514 */ "const RL_SHADER_LOC_MATRIX_MVP* = 6\n"
        /* 1515 */ "const RL_SHADER_LOC_MATRIX_VIEW* = 7\n"
        /* 1516 */ "const RL_SHADER_LOC_MATRIX_PROJECTION* = 8\n"
        /* 1517 */ "const RL_SHADER_LOC_MATRIX_MODEL* = 9\n"
        /* 1518 */ "const RL_SHADER_LOC_MATRIX_NORMAL* = 10\n"
        /* 1519 */ "const RL_SHADER_LOC_VECTOR_VIEW* = 11\n"
        /* 1520 */ "const RL_SHADER_LOC_COLOR_DIFFUSE* = 12\n"
        /* 1521 */ "const RL_SHADER_LOC_COLOR_SPECULAR* = 13\n"
        /* 1522 */ "const RL_SHADER_LOC_COLOR_AMBIENT* = 14\n"
        /* 1523 */ "const RL_SHADER_LOC_MAP_ALBEDO* = 15\n"
        /* 1524 */ "const RL_SHADER_LOC_MAP_METALNESS* = 16\n"
        /* 1525 */ "const RL_SHADER_LOC_MAP_NORMAL* = 17\n"
        /* 1526 */ "const RL_SHADER_LOC_MAP_ROUGHNESS* = 18\n"
        /* 1527 */ "const RL_SHADER_LOC_MAP_OCCLUSION* = 19\n"
        /* 1528 */ "const RL_SHADER_LOC_MAP_EMISSION* = 20\n"
        /* 1529 */ "const RL_SHADER_LOC_MAP_HEIGHT* = 21\n"
        /* 1530 */ "const RL_SHADER_LOC_MAP_CUBEMAP* = 22\n"
        /* 1531 */ "const RL_SHADER_LOC_MAP_IRRADIANCE* = 23\n"
        /* 1532 */ "const RL_SHADER_LOC_MAP_PREFILTER* = 24\n"
        /* 1533 */ "const RL_SHADER_LOC_MAP_BRDF* = 25\n"
        /* 1534 */ "const RL_SHADER_UNIFORM_FLOAT* = 0\n"
        /* 1535 */ "const RL_SHADER_UNIFORM_VEC2* = 1\n"
        /* 1536 */ "const RL_SHADER_UNIFORM_VEC3* = 2\n"
        /* 1537 */ "const RL_SHADER_UNIFORM_VEC4* = 3\n"
        /* 1538 */ "const RL_SHADER_UNIFORM_INT* = 4\n"
        /* 1539 */ "const RL_SHADER_UNIFORM_IVEC2* = 5\n"
        /* 1540 */ "const RL_SHADER_UNIFORM_IVEC3* = 6\n"
        /* 1541 */ "const RL_SHADER_UNIFORM_IVEC4* = 7\n"
        /* 1542 */ "const RL_SHADER_UNIFORM_UINT* = 8\n"
        /* 1543 */ "const RL_SHADER_UNIFORM_UIVEC2* = 9\n"
        /* 1544 */ "const RL_SHADER_UNIFORM_UIVEC3* = 10\n"
        /* 1545 */ "const RL_SHADER_UNIFORM_UIVEC4* = 11\n"
        /* 1546 */ "const RL_SHADER_UNIFORM_SAMPLER2D* = 12\n"
        /* 1547 */ "const RL_SHADER_ATTRIB_FLOAT* = 0\n"
        /* 1548 */ "const RL_SHADER_ATTRIB_VEC2* = 1\n"
        /* 1549 */ "const RL_SHADER_ATTRIB_VEC3* = 2\n"
        /* 1550 */ "const RL_SHADER_ATTRIB_VEC4* = 3\n"
        /* 1551 */ "const RL_ATTACHMENT_COLOR_CHANNEL0* = 0\n"
        /* 1552 */ "const RL_ATTACHMENT_COLOR_CHANNEL1* = 1\n"
        /* 1553 */ "const RL_ATTACHMENT_COLOR_CHANNEL2* = 2\n"
        /* 1554 */ "const RL_ATTACHMENT_COLOR_CHANNEL3* = 3\n"
        /* 1555 */ "const RL_ATTACHMENT_COLOR_CHANNEL4* = 4\n"
        /* 1556 */ "const RL_ATTACHMENT_COLOR_CHANNEL5* = 5\n"
        /* 1557 */ "const RL_ATTACHMENT_COLOR_CHANNEL6* = 6\n"
        /* 1558 */ "const RL_ATTACHMENT_COLOR_CHANNEL7* = 7\n"
        /* 1559 */ "const RL_ATTACHMENT_DEPTH* = 100\n"
        /* 1560 */ "const RL_ATTACHMENT_STENCIL* = 200\n"
        /* 1561 */ "const RL_ATTACHMENT_CUBEMAP_POSITIVE_X* = 0\n"
        /* 1562 */ "const RL_ATTACHMENT_CUBEMAP_NEGATIVE_X* = 1\n"
        /* 1563 */ "const RL_ATTACHMENT_CUBEMAP_POSITIVE_Y* = 2\n"
        /* 1564 */ "const RL_ATTACHMENT_CUBEMAP_NEGATIVE_Y* = 3\n"
        /* 1565 */ "const RL_ATTACHMENT_CUBEMAP_POSITIVE_Z* = 4\n"
        /* 1566 */ "const RL_ATTACHMENT_CUBEMAP_NEGATIVE_Z* = 5\n"
        /* 1567 */ "const RL_ATTACHMENT_TEXTURE2D* = 100\n"
        /* 1568 */ "const RL_ATTACHMENT_RENDERBUFFER* = 200\n"
        /* 1569 */ "const RL_CULL_FACE_FRONT* = 0\n"
        /* 1570 */ "const RL_CULL_FACE_BACK* = 1\n"

        // Defines
        // Skipped define: RAYLIB_VERSION_MAJOR
        // Skipped define: RAYLIB_VERSION_MINOR
        // Skipped define: RAYLIB_VERSION_PATCH
        /* 1571 */ "const RAYLIB_VERSION* = \"6.0\"\n"
        // Skipped define: __declspec(x)
        // Skipped define: RLAPI
        /* 1572 */ "const PI* = 3.141592653589793\n"
        ...
        /* 1573 */ "const LIGHTGRAY* = Color{ 200, 200, 200, 255 }\n"
        /* 1574 */ "const GRAY* = Color{ 130, 130, 130, 255 }\n"
        /* 1575 */ "const DARKGRAY* = Color{ 80, 80, 80, 255 }\n"
        /* 1576 */ "const YELLOW* = Color{ 253, 249, 0, 255 }\n"
        /* 1577 */ "const GOLD* = Color{ 255, 203, 0, 255 }\n"
        /* 1578 */ "const ORANGE* = Color{ 255, 161, 0, 255 }\n"
        /* 1579 */ "const PINK* = Color{ 255, 109, 194, 255 }\n"
        /* 1580 */ "const RED* = Color{ 230, 41, 55, 255 }\n"
        /* 1581 */ "const MAROON* = Color{ 190, 33, 55, 255 }\n"
        /* 1582 */ "const GREEN* = Color{ 0, 228, 48, 255 }\n"
        /* 1583 */ "const LIME* = Color{ 0, 158, 47, 255 }\n"
        /* 1584 */ "const DARKGREEN* = Color{ 0, 117, 44, 255 }\n"
        /* 1585 */ "const SKYBLUE* = Color{ 102, 191, 255, 255 }\n"
        /* 1586 */ "const BLUE* = Color{ 0, 121, 241, 255 }\n"
        /* 1587 */ "const DARKBLUE* = Color{ 0, 82, 172, 255 }\n"
        /* 1588 */ "const PURPLE* = Color{ 200, 122, 255, 255 }\n"
        /* 1589 */ "const VIOLET* = Color{ 135, 60, 190, 255 }\n"
        /* 1590 */ "const DARKPURPLE* = Color{ 112, 31, 126, 255 }\n"
        /* 1591 */ "const BEIGE* = Color{ 211, 176, 131, 255 }\n"
        /* 1592 */ "const BROWN* = Color{ 127, 106, 79, 255 }\n"
        /* 1593 */ "const DARKBROWN* = Color{ 76, 63, 47, 255 }\n"
        /* 1594 */ "const WHITE* = Color{ 255, 255, 255, 255 }\n"
        /* 1595 */ "const BLACK* = Color{ 0, 0, 0, 255 }\n"
        /* 1596 */ "const BLANK* = Color{ 0, 0, 0, 0 }\n"
        /* 1597 */ "const MAGENTA* = Color{ 255, 0, 255, 255 }\n"
        /* 1598 */ "const RAYWHITE* = Color{ 245, 245, 245, 255 }\n"
        ...
        // Skipped define: RL_READ_FRAMEBUFFER
        // Skipped define: RL_DRAW_FRAMEBUFFER
        // Skipped define: RL_DEFAULT_SHADER_ATTRIB_LOCATION_POSITION
        // Skipped define: RL_DEFAULT_SHADER_ATTRIB_LOCATION_TEXCOORD
        // Skipped define: RL_DEFAULT_SHADER_ATTRIB_LOCATION_NORMAL
        // Skipped define: RL_DEFAULT_SHADER_ATTRIB_LOCATION_COLOR
        // Skipped define: RL_DEFAULT_SHADER_ATTRIB_LOCATION_TANGENT
        // Skipped define: RL_DEFAULT_SHADER_ATTRIB_LOCATION_TEXCOORD2
        // Skipped define: RL_DEFAULT_SHADER_ATTRIB_LOCATION_INDICES
        // Skipped define: RL_DEFAULT_SHADER_ATTRIB_LOCATION_BONEINDICES
        // Skipped define: RL_DEFAULT_SHADER_ATTRIB_LOCATION_BONEWEIGHTS
        // Skipped define: RL_DEFAULT_SHADER_ATTRIB_LOCATION_INSTANCETRANSFORM
